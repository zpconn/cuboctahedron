...
- [x] Implement Phase 6Z.6K.8AP.16DP sparse coverage core:
  ...
  ```
- [ ] Implement Phase 6Z.6K.8AP.16DQ sparse five-rank root:
  ...
  rank list `[6000745, 6000625, 6000480, 6000720, 6000662]`.  This must be
  built under an explicit memory guard, because importing all five singleton
  leaves may pull in their rank-local candidate-facts dependencies.  Do not
  treat it as a contiguous interval theorem and do not run it through a broad
  package build.
