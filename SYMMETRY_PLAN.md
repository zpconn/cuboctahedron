...
producer-growth projection gate.
...
- [ ] Implement Phase 6Z.6K.8AO production split hierarchy design:
...
step is Phase 6Z.6K.8AO: convert this accepted projection into a production
split hierarchy design, including module layout, expected source size, expected
build time, and the remaining Lean bridge needed to connect the producer
surface to public `Translation.complete`. That step should:
