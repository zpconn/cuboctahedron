...
- [x] Implement Phase 6Z.6K.8AP.16DN compact Walsh classifier facts smoke:
  ...
  the 5 GiB smoke cap.
- [ ] Generalize Phase 6Z.6K.8AP.16DN across the AP16DJ five-rank batch:
  emit or refactor rank-local candidate-facts shards and classifier-facts
  bridges for ranks `6000745`, `6000625`, `6000720`, and `6000662`, then add a
  small root theorem composing the five singleton `AllTranslationGoodCoverage`
  results.  This is still bounded smoke evidence, but it is the next gate for
  proving the AP16DJ compact-Walsh batch can become real semantic coverage
  without loading a global source/row fact bundle.
