...
- [ ] Prove nonempty Phase 6Z.6K.8AP source/row language membership:
  generate or prove a real `SourceRowPredicateGoodLanguageOnRange lo hi` or
  ...
  is to combine `SourcePairPositionSpec.Predicate` with row producers into a
  nonempty language `complete` theorem.  AP.5 catalogs may remain export
