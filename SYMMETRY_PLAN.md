...
6Z.6K.8V source-index/state language profiler, through the Phase 6Z.6K.8AM
larger split pair-sign producer-coverage root smoke.
...
- [x] Implement Phase 6Z.6K.8AM larger split-root/census gate:
  ...
  3.300 GiB RSS.
- [ ] Implement Phase 6Z.6K.8AN producer-growth projection gate:
  use the resumable census/checkpoint workflow to estimate global
  descriptor/source/row growth and chunk counts before emitting any larger
  Lean root.
...
coverage. The immediate next step is Phase 6Z.6K.8AN: use the resumable
census/checkpoint workflow to project global descriptor/source/row/chunk
growth before emitting any larger Lean root. That step should:
