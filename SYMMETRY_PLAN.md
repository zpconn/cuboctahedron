...
primary theorem coordinate. The next active move is a bounded Lean
row-property-family emitter/root whose public theorem surface is one of those
24 row-property families and whose source rows are checked as local parameters.
