...
namespace Cuboctahedron.Generated.PublicEvidence.IntervalShard.Shard000000000_000000008.NonIdentity.Rank000000004
...
def intervalShardNonId000000004Seq : Vector Face 14 :=
  ⟨#[Face.xp, Face.xp, Face.yp, Face.yp, Face.zp, Face.zp, Face.tppp, Face.tppp, Face.tppm, Face.tppm, Face.tmpp, Face.tpmp, Face.tmpp, Face.tpmp], by decide⟩

@[simp] theorem intervalShardNonId000000004Seq_get00_num :
    intervalShardNonId000000004Seq.get (0 : Step14) = Face.xp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get00_mk (h : 0 < 14) :
    intervalShardNonId000000004Seq.get ⟨0, h⟩ = Face.xp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get01_num :
    intervalShardNonId000000004Seq.get (1 : Step14) = Face.xp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get01_mk (h : 1 < 14) :
    intervalShardNonId000000004Seq.get ⟨1, h⟩ = Face.xp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get02_num :
    intervalShardNonId000000004Seq.get (2 : Step14) = Face.yp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get02_mk (h : 2 < 14) :
    intervalShardNonId000000004Seq.get ⟨2, h⟩ = Face.yp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get03_num :
    intervalShardNonId000000004Seq.get (3 : Step14) = Face.yp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get03_mk (h : 3 < 14) :
    intervalShardNonId000000004Seq.get ⟨3, h⟩ = Face.yp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get04_num :
    intervalShardNonId000000004Seq.get (4 : Step14) = Face.zp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get04_mk (h : 4 < 14) :
    intervalShardNonId000000004Seq.get ⟨4, h⟩ = Face.zp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get05_num :
    intervalShardNonId000000004Seq.get (5 : Step14) = Face.zp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get05_mk (h : 5 < 14) :
    intervalShardNonId000000004Seq.get ⟨5, h⟩ = Face.zp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get06_num :
    intervalShardNonId000000004Seq.get (6 : Step14) = Face.tppp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get06_mk (h : 6 < 14) :
    intervalShardNonId000000004Seq.get ⟨6, h⟩ = Face.tppp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get07_num :
    intervalShardNonId000000004Seq.get (7 : Step14) = Face.tppp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get07_mk (h : 7 < 14) :
    intervalShardNonId000000004Seq.get ⟨7, h⟩ = Face.tppp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get08_num :
    intervalShardNonId000000004Seq.get (8 : Step14) = Face.tppm := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get08_mk (h : 8 < 14) :
    intervalShardNonId000000004Seq.get ⟨8, h⟩ = Face.tppm := by
...
@[simp] theorem intervalShardNonId000000004Seq_get09_num :
    intervalShardNonId000000004Seq.get (9 : Step14) = Face.tppm := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get09_mk (h : 9 < 14) :
    intervalShardNonId000000004Seq.get ⟨9, h⟩ = Face.tppm := by
...
@[simp] theorem intervalShardNonId000000004Seq_get10_num :
    intervalShardNonId000000004Seq.get (10 : Step14) = Face.tmpp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get10_mk (h : 10 < 14) :
    intervalShardNonId000000004Seq.get ⟨10, h⟩ = Face.tmpp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get11_num :
    intervalShardNonId000000004Seq.get (11 : Step14) = Face.tpmp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get11_mk (h : 11 < 14) :
    intervalShardNonId000000004Seq.get ⟨11, h⟩ = Face.tpmp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get12_num :
    intervalShardNonId000000004Seq.get (12 : Step14) = Face.tmpp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get12_mk (h : 12 < 14) :
    intervalShardNonId000000004Seq.get ⟨12, h⟩ = Face.tmpp := by
...
@[simp] theorem intervalShardNonId000000004Seq_get13_num :
    intervalShardNonId000000004Seq.get (13 : Step14) = Face.tpmp := by
  decide

@[simp] theorem intervalShardNonId000000004Seq_get13_mk (h : 13 < 14) :
    intervalShardNonId000000004Seq.get ⟨13, h⟩ = Face.tpmp := by
...
def intervalShardNonId000000004 : NonIdCert where
  word := wordRank000000004
  axis := { x := -1, y := 1, z := 0 }
  kernel := { crossFactor := { m00 := (7/8), m01 := 0, m02 := (-1/2), m10 := (7/8), m11 := 0, m12 := (-1/2), m20 := 1, m21 := 0, m22 := (7/8) } }
  forcedSeq := intervalShardNonId000000004Seq
  p0 := { x := 0, y := 0, z := 0 }
  lambda := 0
...
theorem intervalShardNonId000000004_validPairWord :
    ValidPairWord wordRank000000004 := by
  unfold wordRank000000004 ValidPairWord pairCount
  decide

theorem intervalShardNonId000000004_totalLinear :
...
theorem intervalShardNonId000000004_nonIdentity :
    totalLinearOfPairWord wordRank000000004 ≠ (matId : Mat3 Rat) := by
  rw [intervalShardNonId000000004_totalLinear]
  intro h
  have hfield := congrArg Mat3.m00 h
  norm_num [matId] at hfield

theorem intervalShardNonId000000004_kernelCheck :
    checkKernelLineWitness
      (totalLinearOfPairWord wordRank000000004)
      { x := -1, y := 1, z := 0 }
      { crossFactor := { m00 := (7/8), m01 := 0, m02 := (-1/2), m10 := (7/8), m11 := 0, m12 := (-1/2), m20 := 1, m21 := 0, m22 := (7/8) } } = true := by
  rw [intervalShardNonId000000004_totalLinear]
  norm_num [checkKernelLineWitness, checkVec3NonzeroQ, fixedPart,
    crossLeftMatrix, matSub, matId, matMul, matVec]

theorem intervalShardNonId000000004_check :
    checkNonIdCert intervalShardNonId000000004 = true := by
  apply checkNonIdCert_badDirectionSign intervalShardNonId000000004 ⟨3, by decide⟩
  · rfl
  · simpa [intervalShardNonId000000004] using intervalShardNonId000000004_validPairWord
  · simpa [intervalShardNonId000000004] using intervalShardNonId000000004_nonIdentity
  · simpa [intervalShardNonId000000004] using intervalShardNonId000000004_kernelCheck
  · intro f hf
    cases f <;> simp [intervalShardNonId000000004, pairOfFace, pairPrefixLinearNat,
...
theorem rank_certified :
    Cuboctahedron.Generated.NonIdentity.Coverage.ResidualRankCertifiedBy
      nonIdentityClassifier 4 := by
  intro hlt _hclass _hM
  have hrank : (⟨4, hlt⟩ : Fin numPairWords) =
      (⟨4, by decide⟩ : Fin numPairWords) := by
    ext
    rfl
  exact ⟨intervalShardNonId000000004, by rw [hrank]; decide, intervalShardNonId000000004_check⟩

theorem interval :
    Cuboctahedron.Generated.Coverage.CoversInterval
      (Cuboctahedron.Generated.NonIdentity.Coverage.ResidualRankCertifiedBy
        nonIdentityClassifier) 4 5 :=
...
theorem translation_rank_certified :
    Cuboctahedron.Generated.Translation.Coverage.FarkasRankCertifiedBy
      nonIdentityClassifierTranslation 4 := by
  intro hlt _mask _hclass hM
  have hrank : (⟨4, hlt⟩ : Fin numPairWords) =
      (⟨4, by decide⟩ : Fin numPairWords) := by
    ext
    rfl
  have hword : wordRank000000004 = unrankPairWord ⟨4, hlt⟩ := by
    rw [hrank]
    decide
  exact False.elim (intervalShardNonId000000004_nonIdentity (by simpa [← hword] using hM))

theorem translation_interval :
    Cuboctahedron.Generated.Coverage.CoversInterval
      (Cuboctahedron.Generated.Translation.Coverage.FarkasRankCertifiedBy
        nonIdentityClassifierTranslation) 4 5 :=
  Cuboctahedron.Generated.Coverage.CoversInterval.single
    translation_rank_certified

end Cuboctahedron.Generated.PublicEvidence.IntervalShard.Shard000000000_000000008.NonIdentity.Rank000000004
