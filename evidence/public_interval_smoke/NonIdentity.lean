...
def publicSmokeNonId000000001Seq : Vector Face 14 :=
...
@[simp] theorem publicSmokeNonId000000001Seq_get00_num :
    publicSmokeNonId000000001Seq.get (0 : Step14) = Face.xp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get00_mk (h : 0 < 14) :
    publicSmokeNonId000000001Seq.get ⟨0, h⟩ = Face.xp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get01_num :
    publicSmokeNonId000000001Seq.get (1 : Step14) = Face.xp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get01_mk (h : 1 < 14) :
    publicSmokeNonId000000001Seq.get ⟨1, h⟩ = Face.xp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get02_num :
    publicSmokeNonId000000001Seq.get (2 : Step14) = Face.yp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get02_mk (h : 2 < 14) :
    publicSmokeNonId000000001Seq.get ⟨2, h⟩ = Face.yp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get03_num :
    publicSmokeNonId000000001Seq.get (3 : Step14) = Face.yp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get03_mk (h : 3 < 14) :
    publicSmokeNonId000000001Seq.get ⟨3, h⟩ = Face.yp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get04_num :
    publicSmokeNonId000000001Seq.get (4 : Step14) = Face.zp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get04_mk (h : 4 < 14) :
    publicSmokeNonId000000001Seq.get ⟨4, h⟩ = Face.zp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get05_num :
    publicSmokeNonId000000001Seq.get (5 : Step14) = Face.zp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get05_mk (h : 5 < 14) :
    publicSmokeNonId000000001Seq.get ⟨5, h⟩ = Face.zp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get06_num :
    publicSmokeNonId000000001Seq.get (6 : Step14) = Face.tppp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get06_mk (h : 6 < 14) :
    publicSmokeNonId000000001Seq.get ⟨6, h⟩ = Face.tppp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get07_num :
    publicSmokeNonId000000001Seq.get (7 : Step14) = Face.tppp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get07_mk (h : 7 < 14) :
    publicSmokeNonId000000001Seq.get ⟨7, h⟩ = Face.tppp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get08_num :
    publicSmokeNonId000000001Seq.get (8 : Step14) = Face.tppm := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get08_mk (h : 8 < 14) :
    publicSmokeNonId000000001Seq.get ⟨8, h⟩ = Face.tppm := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get09_num :
    publicSmokeNonId000000001Seq.get (9 : Step14) = Face.tppm := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get09_mk (h : 9 < 14) :
    publicSmokeNonId000000001Seq.get ⟨9, h⟩ = Face.tppm := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get10_num :
    publicSmokeNonId000000001Seq.get (10 : Step14) = Face.tpmp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get10_mk (h : 10 < 14) :
    publicSmokeNonId000000001Seq.get ⟨10, h⟩ = Face.tpmp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get11_num :
    publicSmokeNonId000000001Seq.get (11 : Step14) = Face.tmpp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get11_mk (h : 11 < 14) :
    publicSmokeNonId000000001Seq.get ⟨11, h⟩ = Face.tmpp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get12_num :
    publicSmokeNonId000000001Seq.get (12 : Step14) = Face.tpmp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get12_mk (h : 12 < 14) :
    publicSmokeNonId000000001Seq.get ⟨12, h⟩ = Face.tpmp := by
...
@[simp] theorem publicSmokeNonId000000001Seq_get13_num :
    publicSmokeNonId000000001Seq.get (13 : Step14) = Face.tmpp := by
  decide

@[simp] theorem publicSmokeNonId000000001Seq_get13_mk (h : 13 < 14) :
    publicSmokeNonId000000001Seq.get ⟨13, h⟩ = Face.tmpp := by
...
theorem publicSmokeNonId000000001_validPairWord :
    ValidPairWord wordRank000000001 := by
  unfold wordRank000000001 ValidPairWord pairCount
  decide

theorem publicSmokeNonId000000001_totalLinear :
...
theorem publicSmokeNonId000000001_nonIdentity :
    totalLinearOfPairWord wordRank000000001 ≠ (matId : Mat3 Rat) := by
  rw [publicSmokeNonId000000001_totalLinear]
  intro h
  have hfield := congrArg Mat3.m00 h
  norm_num [matId] at hfield

theorem publicSmokeNonId000000001_kernelCheck :
...
theorem publicSmokeNonId000000001_check :
    checkNonIdCert publicSmokeNonId000000001 = true := by
  apply checkNonIdCert_badDirectionSign publicSmokeNonId000000001 ⟨3, by decide⟩
  · rfl
  · simpa [publicSmokeNonId000000001] using publicSmokeNonId000000001_validPairWord
  · simpa [publicSmokeNonId000000001] using publicSmokeNonId000000001_nonIdentity
  · simpa [publicSmokeNonId000000001] using publicSmokeNonId000000001_kernelCheck
  · intro f hf
    cases f <;> simp [publicSmokeNonId000000001, pairOfFace, pairPrefixLinearNat,
      canonicalNormalQ, normalQ, matId, matMul, reflM, dot, matSub,
      scalarMat, outer, matVec] at hf ⊢ <;> norm_num at hf ⊢

theorem publicSmokeNonId000000001_rank_certified :
    Cuboctahedron.Generated.NonIdentity.Coverage.ResidualRankCertifiedBy
      smokeNonIdentityClassifier 1 := by
  intro hlt _hclass _hM
  have hrank : (⟨1, hlt⟩ : Fin numPairWords) =
      (⟨1, by decide⟩ : Fin numPairWords) := by
    ext
    rfl
  exact ⟨publicSmokeNonId000000001, by rw [hrank]; decide, publicSmokeNonId000000001_check⟩

theorem interval :
    Cuboctahedron.Generated.Coverage.CoversInterval
      (Cuboctahedron.Generated.NonIdentity.Coverage.ResidualRankCertifiedBy
        smokeNonIdentityClassifier) 1 2 :=
  Cuboctahedron.Generated.Coverage.CoversInterval.single publicSmokeNonId000000001_rank_certified
