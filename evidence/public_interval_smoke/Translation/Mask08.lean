...
namespace Cuboctahedron.Generated.PublicEvidence.Smoke.Translation.Mask08
...
def publicSmokeTranslation000000000Mask08Seq : Vector Face 14 :=
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get00_num :
    publicSmokeTranslation000000000Mask08Seq.get (0 : Step14) = Face.xp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get00_mk (h : 0 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨0, h⟩ = Face.xp := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get01_num :
    publicSmokeTranslation000000000Mask08Seq.get (1 : Step14) = Face.xm := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get01_mk (h : 1 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨1, h⟩ = Face.xm := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get02_num :
    publicSmokeTranslation000000000Mask08Seq.get (2 : Step14) = Face.ym := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get02_mk (h : 2 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨2, h⟩ = Face.ym := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get03_num :
    publicSmokeTranslation000000000Mask08Seq.get (3 : Step14) = Face.yp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get03_mk (h : 3 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨3, h⟩ = Face.yp := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get04_num :
    publicSmokeTranslation000000000Mask08Seq.get (4 : Step14) = Face.zm := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get04_mk (h : 4 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨4, h⟩ = Face.zm := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get05_num :
    publicSmokeTranslation000000000Mask08Seq.get (5 : Step14) = Face.zp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get05_mk (h : 5 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨5, h⟩ = Face.zp := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get06_num :
    publicSmokeTranslation000000000Mask08Seq.get (6 : Step14) = Face.tmmm := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get06_mk (h : 6 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨6, h⟩ = Face.tmmm := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get07_num :
    publicSmokeTranslation000000000Mask08Seq.get (7 : Step14) = Face.tppp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get07_mk (h : 7 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨7, h⟩ = Face.tppp := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get08_num :
    publicSmokeTranslation000000000Mask08Seq.get (8 : Step14) = Face.tppm := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get08_mk (h : 8 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨8, h⟩ = Face.tppm := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get09_num :
    publicSmokeTranslation000000000Mask08Seq.get (9 : Step14) = Face.tmmp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get09_mk (h : 9 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨9, h⟩ = Face.tmmp := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get10_num :
    publicSmokeTranslation000000000Mask08Seq.get (10 : Step14) = Face.tmpm := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get10_mk (h : 10 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨10, h⟩ = Face.tmpm := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get11_num :
    publicSmokeTranslation000000000Mask08Seq.get (11 : Step14) = Face.tpmp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get11_mk (h : 11 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨11, h⟩ = Face.tpmp := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get12_num :
    publicSmokeTranslation000000000Mask08Seq.get (12 : Step14) = Face.tpmm := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get12_mk (h : 12 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨12, h⟩ = Face.tpmm := by
...
@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get13_num :
    publicSmokeTranslation000000000Mask08Seq.get (13 : Step14) = Face.tmpp := by
  decide

@[simp] theorem publicSmokeTranslation000000000Mask08Seq_get13_mk (h : 13 < 14) :
    publicSmokeTranslation000000000Mask08Seq.get ⟨13, h⟩ = Face.tmpp := by
...
def publicSmokeTranslation000000000Mask08 : TranslationCert where
  word := wordRank000000000
  signMask := ⟨8, by decide⟩
  seq := publicSmokeTranslation000000000Mask08Seq
  b := { x := -4, y := -4, z := (-44/3) }
...
theorem publicSmokeTranslation000000000Mask08_check : checkTranslationCert publicSmokeTranslation000000000Mask08 = true := by
  apply checkTranslationCert_sourceFarkas publicSmokeTranslation000000000Mask08 { terms := [{ source := TranslationConstraintSource.xpStart ⟨0, by decide⟩, multiplier := 1 }, { source := TranslationConstraintSource.interior ⟨1, by decide⟩ Face.tmmm, multiplier := 1 }] }
  · rfl
  · unfold publicSmokeTranslation000000000Mask08 wordRank000000000 ValidPairWord pairCount
    decide
  · rw [totalLinearOfPairWord_eq_pairLinearProductRight]
    simp [publicSmokeTranslation000000000Mask08, pairLinearProductRight, pairLinearSuffixNat, reflM,
      canonicalNormalQ, matSub, matId, scalarMat, outer, dot, matMul]
    norm_num
  · intro i
    fin_cases i <;> simp [publicSmokeTranslation000000000Mask08, translationChoiceSeq, signedPositiveAt,
      maskBitForPair, countPairBeforeNat, faceVectorSeq, faceOfPairSign]
  · apply Vec3.ext <;> norm_num [
      publicSmokeTranslation000000000Mask08, TranslationCert.seqFun, faceVectorSeq, totalAff,
  ...
  · simp [
      publicSmokeTranslation000000000Mask08, TranslationCert.seqFun, faceVectorSeq, checkSourceFarkas,
...
theorem case_certified
  ...
  have hrank : (⟨0, hlt⟩ : Fin numPairWords) =
    ...
    ext
    rfl
  exact ⟨publicSmokeTranslation000000000Mask08, by rw [hrank]; decide, by decide, publicSmokeTranslation000000000Mask08_check⟩

end Cuboctahedron.Generated.PublicEvidence.Smoke.Translation.Mask08
