...
| --- | ---: |
| `AxisStartViolationCert` | `3,952` |
| `OpenSegmentViolationCert` | `187` |
| `PreImpactPointViolationCert` | `4` |
...
- Exact distinct count stored: `True`
- Stored distinct keys: `37`
- Overflow cases: `0`

| Key | Count |
| --- | ---: |
| `axisMissesStartInterior|badFace=yp` | `3,815` |
| `axisMissesStartInterior|badFace=tpmm` | `137` |
| `firstHitMismatch|step=0|expected=yp|actual=zp|actualBeforeExpected` | `22` |
| `firstHitMismatch|step=0|expected=yp|actual=zm|actualBeforeExpected` | `19` |
| `firstHitMismatch|step=0|expected=ym|actual=xm|actualBeforeExpected` | `19` |
...
| Key | Count |
| --- | ---: |
| `AxisStartViolationCert|axisMissesStartInterior|badFace=yp` | `3,815` |
| `AxisStartViolationCert|axisMissesStartInterior|badFace=tpmm` | `137` |
| `OpenSegmentViolationCert|firstHitMismatch|step=0|expected=yp|actual=zp|actualBeforeExpected` | `22` |
| `OpenSegmentViolationCert|firstHitMismatch|step=0|expected=yp|actual=zm|actualBeforeExpected` | `19` |
| `OpenSegmentViolationCert|firstHitMismatch|step=0|expected=ym|actual=xm|actualBeforeExpected` | `19` |
