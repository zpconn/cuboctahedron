...
- summary `14`: pattern `***001`, support `[1]`, weights `['1']`
  ...
  - exists now: `False`
  - normals: `[0]`
  - emit: `python3 scripts/emit_du9iq_traced_direct_bridge.py --summary-index 14 --stem WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx14 --standalone-reduced --report scripts/generated/weighted_denom_cube_du9iq_direct_bridge_generated_idx14.json`
...
- summary `15`: pattern `1*0*1*`, support `[2, 11]`, weights `['2', '1']`
  ...
  - exists now: `False`
  - normals: `[1, 10]`
  - emit: `python3 scripts/emit_du9iq_traced_direct_bridge.py --summary-index 15 --stem WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx15 --standalone-reduced --report scripts/generated/weighted_denom_cube_du9iq_direct_bridge_generated_idx15.json`
...
- summary `16`: pattern `0**1*1`, support `[2, 8]`, weights `['1', '1']`
  ...
  - exists now: `False`
  - normals: `[1, 7]`
  - emit: `python3 scripts/emit_du9iq_traced_direct_bridge.py --summary-index 16 --stem WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx16 --standalone-reduced --report scripts/generated/weighted_denom_cube_du9iq_direct_bridge_generated_idx16.json`
...
- summary `17`: pattern `***000`, support `[6, 10]`, weights `['1', '1']`
  ...
  - exists now: `False`
  - normals: `[5, 9]`
  - emit: `python3 scripts/emit_du9iq_traced_direct_bridge.py --summary-index 17 --stem WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx17 --standalone-reduced --report scripts/generated/weighted_denom_cube_du9iq_direct_bridge_generated_idx17.json`
...
- summary `18`: pattern `*010**`, support `[4, 6]`, weights `['1', '1']`
  ...
  - exists now: `False`
  - normals: `[3, 5]`
  - emit: `python3 scripts/emit_du9iq_traced_direct_bridge.py --summary-index 18 --stem WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx18 --standalone-reduced --report scripts/generated/weighted_denom_cube_du9iq_direct_bridge_generated_idx18.json`
...
- summary `19`: pattern `1*010*`, support `[11]`, weights `['1']`
  ...
  - exists now: `False`
  - normals: `[10]`
  - emit: `python3 scripts/emit_du9iq_traced_direct_bridge.py --summary-index 19 --stem WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx19 --standalone-reduced --report scripts/generated/weighted_denom_cube_du9iq_direct_bridge_generated_idx19.json`
