...
| `RootTraceMarginProducer` | root accepted-prefix producer plus trace margin | `root_trace_margin_selected_prefix_bridge`, `trace_margin_root_producer_bridge`, `selected_prefix_trace_margin_root_producer_bridge` |
...
| `rootTraceMarginProducer_of_selectedPrefixTraceMarginFamily` | selected prefix trace-margin family -> root trace-margin producer | `selected_prefix_trace_margin_root_producer_bridge` |
