...
| ---: | ---: | --- | --- |
| `1` | `103/88` | `[312761, 312772, 312773, 824407, 914497, 914499, 944197, 944199, 946777, 946779]` | `step=1|rem=1,2,2,2,2,2,2|par=100|stack=<empty>` |
| `2` | `-73/88` | `[312761, 312772, 312773, 824407, 914497, 914499, 944197, 944199, 946777, 946779]` | `step=2|rem=1,1,2,2,2,2,2|par=110|stack=<empty>` |
| `3` | `-31/22` | `[824407, 914497, 914499, 944197, 944199, 946777, 946779, 947437, 947439, 947581]` | `step=3|rem=1,1,2,2,2,1,2|par=110|stack=dm11` |
| `4` | `57/44` | `[824407]` | `step=4|rem=1,1,1,2,2,1,2|par=111|stack=dm11` |
| `5` | `57/44` | `[824407]` | `step=5|rem=1,1,0,2,2,1,2|par=110|stack=dm11` |
| `6` | `12/11` | `[824407, 151567, 151569]` | `step=6|rem=1,1,0,2,1,1,2|par=110|stack=dm11 d111` |
| `7` | `-9/22` | `[824407, 914497, 914499, 151567, 151569]` | `step=7|rem=1,1,0,2,1,1,1|par=110|stack=dm11 d111 d1m1` |
| `8` | `-18/11` | `[824407, 914497, 914499, 944197, 944199, 151567, 151569]` | `step=8|rem=1,1,0,1,1,1,1|par=110|stack=dm11 d111 d1m1 d11m` |
| `9` | `-18/11` | `[824407, 914497, 914499, 944197, 944199, 946777, 946779, 151567, 151569]` | `step=9|rem=1,1,0,0,1,1,1|par=110|stack=dm11 d111 d1m1` |
| `10` | `-9/22` | `[824407, 914497, 914499, 944197, 944199, 946777, 946779, 947437, 947439, 151567]` | `step=10|rem=1,1,0,0,1,0,1|par=110|stack=dm11 d111 d1m1 dm11` |
| `11` | `12/11` | `[914499, 944199, 946779, 947439, 947601, 151569]` | `step=11|rem=1,1,0,0,0,0,1|par=110|stack=dm11 d111 d1m1 dm11 d111` |
| `12` | `-31/22` | `[914499, 944199, 946779, 947439, 947601, 151569]` | `step=12|rem=1,1,0,0,0,0,0|par=110|stack=dm11 d111 d1m1 dm11 d111 d1m1` |
| `13` | `103/88` | `[312773, 914499, 944199, 946779, 947439, 947601, 947627, 151569]` | `step=13|rem=1,0,0,0,0,0,0|par=100|stack=dm11 d111 d1m1 dm11 d111 d1m1` |
| `14` | `-73/88` | `[312761, 312772, 312773, 824407, 914497, 914499, 944197, 944199, 946777, 946779]` | `step=14|rem=0,0,0,0,0,0,0|par=000|stack=dm11 d111 d1m1 dm11 d111 d1m1` |
