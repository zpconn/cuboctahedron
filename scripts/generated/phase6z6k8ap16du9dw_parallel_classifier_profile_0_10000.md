...
Decision: accepted as the parallel scaling smoke.  It reproduces the serial
`[0,10000)` 146-family result while reducing profiler wall time from
`240.27s` to `46.08s`, with tiny memory use.
