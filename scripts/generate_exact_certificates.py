...
def write_canonical_lean(payload: dict) -> None:
    ...
    lines.extend([
        ...
        "  have hraw :",
        f"      checkCanonicalNonIdRawFailure {raw_nonid['name']} = true :=",
        f"    checkCanonicalNonIdRawFailure_of_check {raw_nonid['name']}",
        ...
        "  have hraw :",
        f"      checkCanonicalTranslationRawFailure {raw_translation['name']} = true :=",
        f"    checkCanonicalTranslationRawFailure_of_check {raw_translation['name']}",
