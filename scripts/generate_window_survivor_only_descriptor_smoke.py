...
def module_lines(namespace: str, rank_start: int, limit: int) -> tuple[list[str], dict[str, Any]]:
    ...
    lines.extend([
        ...
        "            GoodDirectionAtRank ⟨rank, hlt⟩ mask ->",
        "              WindowSurvivor rank mask) :",
        f"    SourceIndexStateDescriptorBoolCoverageOnRange {rank_start} {rank_end} :=",
        ...
        "            GoodDirectionAtRank ⟨rank, hlt⟩ mask ->",
        "              WindowSurvivor rank mask) :",
        f"    SourceRowFactsGoodBridgeOnRange {rank_start} {rank_end} :=",
    ...
    payload = {
        ...
        "decision": {
            ...
            "notes": [
                ...
                "emits semantic and Boolean descriptor coverage adapters",
            ],
        },
    }
