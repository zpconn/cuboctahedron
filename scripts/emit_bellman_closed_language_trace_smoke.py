    ...
    *,
    ...
    lines.extend(
        [
            ...
            "    canonicalBadFace",
            "",
            f"theorem {name}ClosedLanguageForSeqOfLabelTrace",
            "    {rank : Fin numPairWords} {badFace : Face}",
            "    {seq : Step14 -> Face}",
            "    (labels_eq :",
            ...
            "    canonicalBadFace",
            "",
            f"theorem {name}ClosedLanguageForSeqOfTransportedLabelTrace",
            "    {rank : Fin numPairWords} {badFace : Face}",
            ...
            "    seq_labels_eq",
            f"    ({name}ClosedLanguageForSeqOfLabelTrace",
            "      forced_labels_eq",
            "      cancellation",
            "      localAxisTrace",
            "      canonicalBadFace)",
            "",
            f"theorem {name}ClosedLanguageForSeqOfPairSignTrace",
            "    {rank : Fin numPairWords} {badFace : Face}",
            "    {seq forcedSeq : Step14 -> Face}",
            "    (forced_labels_eq :",
            "      faceLabelsInContributionOrder (fun f => f) forcedSeq =",
    ...
    if concrete_local_axis:
        lines.extend(
            [
                ...
                "    canonicalBadFace",
                "",
                f"theorem {name}ClosedLanguageForSeqOfLabelTraceConcreteLocalAxis",
                "    {rank : Fin numPairWords} {badFace : Face}",
                "    {seq : Step14 -> Face}",
                "    (labels_eq :",
                "      faceLabelsInContributionOrder (fun f => f) seq =",
                ...
                "    canonicalBadFace",
                "",
                f"theorem {name}ClosedLanguageForSeqOfTransportedLabelTraceConcreteLocalAxis",
                "    {rank : Fin numPairWords} {badFace : Face}",
                "    {seq forcedSeq : Step14 -> Face}",
                "    (forced_labels_eq :",
                "      faceLabelsInContributionOrder (fun f => f) forcedSeq =",
                ...
                "      TopPairingCanonicalBadFaceCompatible badFace) :",
                "    TopPairingClosedLanguageForSeq rank seq badFace :=",
                f"  {name}ClosedLanguageForSeqOfTransportedLabelTrace",
                "    forced_labels_eq",
                "    seq_labels_eq",
                "    cancellation",
                f"    {name}LocalAxisTraceConcrete",
                "    canonicalBadFace",
                "",
                f"theorem {name}ClosedLanguageForSeqOfPairSignTraceConcreteLocalAxis",
                "    {rank : Fin numPairWords} {badFace : Face}",
                "    {seq forcedSeq : Step14 -> Face}",
                "    (forced_labels_eq :",
                "      faceLabelsInContributionOrder (fun f => f) forcedSeq =",
                ...
                "      TopPairingCanonicalBadFaceCompatible badFace) :",
                "    TopPairingClosedLanguageForSeq rank seq badFace :=",
                f"  {name}ClosedLanguageForSeqOfPairSignTrace",
                "    forced_labels_eq",
                "    forced_matches",
                "    pairSign",
                "    cancellation",
