...
/-!
Generated trace-level start-violation provider for graph-accepted trace `t028`.
...
private def trace028Seq : Step14 -> Face
  | ⟨0, _⟩ => Face.xp
  | ⟨1, _⟩ => Face.xm
  | ⟨2, _⟩ => Face.ym
  | ⟨3, _⟩ => Face.yp
...
private def trace028Vector : Vector Face 14 :=
...
@[simp] private theorem trace028Vector_get00_num :
    trace028Vector.get (0 : Step14) = Face.xp := by
  decide

@[simp] private theorem trace028Vector_get00_mk (h : 0 < 14) :
...
@[simp] private theorem trace028Vector_get01_num :
    trace028Vector.get (1 : Step14) = Face.xm := by
  decide

@[simp] private theorem trace028Vector_get01_mk (h : 1 < 14) :
...
@[simp] private theorem trace028Vector_get02_num :
    trace028Vector.get (2 : Step14) = Face.ym := by
  decide

@[simp] private theorem trace028Vector_get02_mk (h : 2 < 14) :
...
@[simp] private theorem trace028Vector_get03_num :
    trace028Vector.get (3 : Step14) = Face.yp := by
  decide

@[simp] private theorem trace028Vector_get03_mk (h : 3 < 14) :
...
@[simp] private theorem trace028Vector_get04_num :
    trace028Vector.get (4 : Step14) = Face.zm := by
  decide

@[simp] private theorem trace028Vector_get04_mk (h : 4 < 14) :
...
@[simp] private theorem trace028Vector_get05_num :
    trace028Vector.get (5 : Step14) = Face.zp := by
  decide

@[simp] private theorem trace028Vector_get05_mk (h : 5 < 14) :
...
@[simp] private theorem trace028Vector_get06_num :
    trace028Vector.get (6 : Step14) = Face.tmmm := by
  decide

@[simp] private theorem trace028Vector_get06_mk (h : 6 < 14) :
...
@[simp] private theorem trace028Vector_get07_num :
    trace028Vector.get (7 : Step14) = Face.tpmm := by
  decide

@[simp] private theorem trace028Vector_get07_mk (h : 7 < 14) :
...
@[simp] private theorem trace028Vector_get08_num :
    trace028Vector.get (8 : Step14) = Face.tppm := by
  decide

@[simp] private theorem trace028Vector_get08_mk (h : 8 < 14) :
...
@[simp] private theorem trace028Vector_get09_num :
    trace028Vector.get (9 : Step14) = Face.tpmp := by
  decide

@[simp] private theorem trace028Vector_get09_mk (h : 9 < 14) :
...
@[simp] private theorem trace028Vector_get10_num :
    trace028Vector.get (10 : Step14) = Face.tmpm := by
  decide

@[simp] private theorem trace028Vector_get10_mk (h : 10 < 14) :
...
@[simp] private theorem trace028Vector_get11_num :
    trace028Vector.get (11 : Step14) = Face.tppp := by
  decide

@[simp] private theorem trace028Vector_get11_mk (h : 11 < 14) :
...
@[simp] private theorem trace028Vector_get12_num :
    trace028Vector.get (12 : Step14) = Face.tmpp := by
  decide

@[simp] private theorem trace028Vector_get12_mk (h : 12 < 14) :
...
@[simp] private theorem trace028Vector_get13_num :
    trace028Vector.get (13 : Step14) = Face.tmmp := by
  decide

@[simp] private theorem trace028Vector_get13_mk (h : 13 < 14) :
...
private def trace028Word : PairWord :=
...
@[simp] private theorem trace028Word_get00_num :
    trace028Word.get (0 : WordIndex) = PairId.x := by
  decide

@[simp] private theorem trace028Word_get00_mk (h : 0 < 13) :
...
@[simp] private theorem trace028Word_get01_num :
    trace028Word.get (1 : WordIndex) = PairId.y := by
  decide

@[simp] private theorem trace028Word_get01_mk (h : 1 < 13) :
...
@[simp] private theorem trace028Word_get02_num :
    trace028Word.get (2 : WordIndex) = PairId.y := by
  decide

@[simp] private theorem trace028Word_get02_mk (h : 2 < 13) :
...
@[simp] private theorem trace028Word_get03_num :
    trace028Word.get (3 : WordIndex) = PairId.z := by
  decide

@[simp] private theorem trace028Word_get03_mk (h : 3 < 13) :
...
@[simp] private theorem trace028Word_get04_num :
    trace028Word.get (4 : WordIndex) = PairId.z := by
  decide

@[simp] private theorem trace028Word_get04_mk (h : 4 < 13) :
...
@[simp] private theorem trace028Word_get05_num :
    trace028Word.get (5 : WordIndex) = PairId.d111 := by
  decide

@[simp] private theorem trace028Word_get05_mk (h : 5 < 13) :
...
@[simp] private theorem trace028Word_get06_num :
    trace028Word.get (6 : WordIndex) = PairId.dm11 := by
  decide

@[simp] private theorem trace028Word_get06_mk (h : 6 < 13) :
...
@[simp] private theorem trace028Word_get07_num :
    trace028Word.get (7 : WordIndex) = PairId.d11m := by
  decide

@[simp] private theorem trace028Word_get07_mk (h : 7 < 13) :
...
@[simp] private theorem trace028Word_get08_num :
    trace028Word.get (8 : WordIndex) = PairId.d1m1 := by
  decide

@[simp] private theorem trace028Word_get08_mk (h : 8 < 13) :
...
@[simp] private theorem trace028Word_get09_num :
    trace028Word.get (9 : WordIndex) = PairId.d1m1 := by
  decide

@[simp] private theorem trace028Word_get09_mk (h : 9 < 13) :
...
@[simp] private theorem trace028Word_get10_num :
    trace028Word.get (10 : WordIndex) = PairId.d111 := by
  decide

@[simp] private theorem trace028Word_get10_mk (h : 10 < 13) :
...
@[simp] private theorem trace028Word_get11_num :
    trace028Word.get (11 : WordIndex) = PairId.dm11 := by
  decide

@[simp] private theorem trace028Word_get11_mk (h : 11 < 13) :
...
@[simp] private theorem trace028Word_get12_num :
    trace028Word.get (12 : WordIndex) = PairId.d11m := by
  decide

@[simp] private theorem trace028Word_get12_mk (h : 12 < 13) :
...
private theorem trace028_contribution_labels :
...
private def trace028Axis : Vec3 Rat :=
  { x := (-1/3), y := (-1/3), z := -1 }

private def trace028Kernel : KernelLineWitness :=
  { crossFactor := { m00 := (7/144), m01 := (-5/9), m02 := 0, m10 := (5/9), m11 := (23/144), m12 := 0, m20 := (-29/144), m21 := (19/144), m22 := 0 } }

private def trace028Cert : NonIdCert where
  word := trace028Word
  axis := trace028Axis
...
private theorem trace028_word_eq :
    trace028Cert.word = pairWordOfSeq trace028Seq := by
  exact trace028Word_eq_pairWordOfSeq

private theorem trace028TotalLinear :
    totalLinearOfPairWord trace028Word = { m00 := (-551/729), m01 := (368/729), m02 := (304/729), m10 := (-112/729), m11 := (-551/729), m12 := (464/729), m20 := (464/729), m21 := (304/729), m22 := (473/729) } := by
...
private theorem trace028_kernel_check :
  ...
  rw [trace028TotalLinear]
  norm_num [
    trace028Axis, trace028Kernel, checkKernelLineWitness,
...
private theorem trace028FinalAxisDot :
  ...
  norm_num [trace028Axis, finalAxisDotQ, pairPrefixLinearNat,
    trace028Word_get00_num, trace028Word_get01_num, trace028Word_get02_num, trace028Word_get03_num, trace028Word_get04_num, trace028Word_get05_num, trace028Word_get06_num, trace028Word_get07_num, trace028Word_get08_num, trace028Word_get09_num, trace028Word_get10_num, trace028Word_get11_num, trace028Word_get12_num,
...
private theorem trace028PrefixLinear13 :
    pairPrefixLinearNat trace028Word 13 =
...
private theorem trace028_axis_forces :
...
private theorem trace028Cert_pathPrefix00 :
...
private theorem trace028Cert_pathPrefix01 :
...
private theorem trace028Cert_pathPrefix02 :
...
private theorem trace028Cert_pathPrefix03 :
...
private theorem trace028Cert_pathPrefix04 :
...
private theorem trace028Cert_pathPrefix05 :
...
private theorem trace028Cert_pathPrefix06 :
...
private theorem trace028Cert_pathPrefix07 :
...
private theorem trace028Cert_pathPrefix08 :
...
private theorem trace028Cert_pathPrefix09 :
...
private theorem trace028Cert_pathPrefix10 :
...
private theorem trace028Cert_pathPrefix11 :
...
private theorem trace028Cert_pathPrefix12 :
...
private theorem trace028Cert_pathPrefix13 :
...
private theorem trace028Cert_totalAff :
...
private theorem trace028Cert_axisSolveCheck :
