...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard065
...
theorem labels_prefix7_shard_065
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.zm, Face.zp, Face.tpmm, Face.tppp] ++ rest) :
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.zm, Face.zp, Face.tpmm, Face.tppp, Face.tmmm] ++ rest) \/
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.zm, Face.zp, Face.tpmm, Face.tppp, Face.tppm] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard065
