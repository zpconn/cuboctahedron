...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard019
...
theorem labels_prefix7_shard_019
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tpmm, Face.tppp] ++ rest) :
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tpmm, Face.tppp, Face.tpmm] ++ rest) \/
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tpmm, Face.tppp, Face.zm] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard019
