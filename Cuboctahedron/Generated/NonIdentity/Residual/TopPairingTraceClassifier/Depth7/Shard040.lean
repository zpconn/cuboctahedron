...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard040
...
theorem labels_prefix7_shard_040
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.yp, Face.zm, Face.tppp, Face.zp] ++ rest) :
    (∃ rest : List Face,
    ...
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.zm, Face.tppp, Face.zp, Face.tpmp] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard040
