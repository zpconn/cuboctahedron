...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard022
...
theorem labels_prefix7_shard_022
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tppp, Face.zm] ++ rest) :
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tppp, Face.zm, Face.tpmp] ++ rest) \/
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tppp, Face.zm, Face.zp] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard022
