...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard049
...
theorem labels_prefix7_shard_049
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.zm, Face.tmpp, Face.zp, Face.tpmp] ++ rest) :
    (∃ rest : List Face,
    ...
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.zm, Face.tmpp, Face.zp, Face.tpmp, Face.tppm] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard049
