...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard027
...
theorem labels_prefix7_shard_027
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.yp, Face.tppm, Face.tmmp, Face.tmmm] ++ rest) :
    (∃ rest : List Face,
    ...
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.tppm, Face.tmmp, Face.tmmm, Face.zm] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard027
