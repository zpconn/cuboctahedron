...
namespace Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard020
...
theorem labels_prefix7_shard_020
    {labels : List Face}
    ...
    (hprefix : ∃ rest : List Face, labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tpmm, Face.zp] ++ rest) :
    (∃ rest : List Face,
    ...
    (∃ rest : List Face,
      labels = [Face.xm, Face.ym, Face.yp, Face.tmmm, Face.tpmm, Face.zp, Face.zm] ++ rest) := by
...
end Cuboctahedron.Generated.NonIdentity.Residual.TopPairingTraceClassifier.Depth7.Shard020
