...
def cls0000FaceSeq : Step14 -> Face
  | ⟨0, _⟩ => Face.xp
  | ⟨1, _⟩ => Face.xm
  | ⟨2, _⟩ => Face.ym
  | ⟨3, _⟩ => Face.yp
...
def cls0000Axis : Vec3 Rat := { x := (-1/3), y := (-1/3), z := -1 }

def cls0000Kernel : KernelLineWitness :=
  { crossFactor := { m00 := (7/144), m01 := (-5/9), m02 := 0, m10 := (5/9), m11 := (23/144), m12 := 0, m20 := (-29/144), m21 := (19/144), m22 := 0 } }

theorem cls0000KernelCheck :
...
def cls0001FaceSeq : Step14 -> Face
  | ⟨0, _⟩ => Face.xp
  | ⟨1, _⟩ => Face.xm
  | ⟨2, _⟩ => Face.ym
  | ⟨3, _⟩ => Face.yp
...
def cls0001Axis : Vec3 Rat := { x := (-1/3), y := (-1/3), z := -1 }

def cls0001Kernel : KernelLineWitness :=
  { crossFactor := { m00 := (7/144), m01 := (-5/9), m02 := 0, m10 := (5/9), m11 := (23/144), m12 := 0, m20 := (-29/144), m21 := (19/144), m22 := 0 } }

theorem cls0001KernelCheck :
...
private noncomputable def sampledAxisRankObjectCover :
    BellmanAxisRankObjectCover
      SampledRankIndex State SmokeLabel graphPotential SmokeStep smokeLabelOfFace
      rootState (176 : Int) sampledRankOf sampledObjectAccepts
      sampledContainsRank sampledScaledMarginAtRank :=
...
private noncomputable def sampledAxisRankObjectCoverEval :
    BellmanAxisRankObjectCover
