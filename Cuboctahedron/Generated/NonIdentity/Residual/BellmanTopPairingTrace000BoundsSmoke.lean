...
theorem terminalTraceMarginIdBoundSequenceBadFace_of_trace000
    {scaledMargin : Fin numPairWords -> Int}
  ...
  · refine ⟨AcceptedTraceId.t000, ?_, ?_⟩
    · simpa [TopPairingBellmanObj.labels, TopPairingBellmanObj.forcedSeq,
        topPairingRankFaceLabels, acceptedTraceOfId] using htrace
    · simpa [acceptedTraceGain] using hmargin

theorem strengthenedTraceMarginIdBound_of_trace000
    {scaledMargin : Fin numPairWords -> Int}
    {rank : Fin numPairWords}
    (h :
  ...
  TopPairingStrengthenedClosedLanguageAtRank.ofComponents
    h.closed
    h.actualFaceOmni
    (terminalTraceMarginIdBoundSequenceBadFace_of_trace000
...
theorem trace000_scaledMargin_nonpos
  ...
  strengthenedTraceMarginIdBound_scaledMargin_nonpos
    (strengthenedTraceMarginIdBound_of_trace000 h)
