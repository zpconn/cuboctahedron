...
namespace Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Shard078

open Cuboctahedron

open Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Base

/-- Validity shard for source states [624, 632). -/
...
theorem transition_ok_s0624 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (624 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (624 : State) := by
  intro h
  change graphSmokeNext_s0624 label = some (t, gain) at h
  by_cases h_l0000 : label = (0 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0625 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (625 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (625 : State) := by
  intro h
  change graphSmokeNext_s0625 label = some (t, gain) at h
  by_cases h_l0001 : label = (1 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0626 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (626 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (626 : State) := by
  intro h
  change graphSmokeNext_s0626 label = some (t, gain) at h
  by_cases h_l0004 : label = (4 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0627 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (627 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (627 : State) := by
  intro h
  change graphSmokeNext_s0627 label = some (t, gain) at h
  by_cases h_l0004 : label = (4 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0628 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (628 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (628 : State) := by
  intro h
  change graphSmokeNext_s0628 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0629 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (629 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (629 : State) := by
  intro h
  change graphSmokeNext_s0629 label = some (t, gain) at h
  by_cases h_l0010 : label = (10 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0630 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (630 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (630 : State) := by
  intro h
  change graphSmokeNext_s0630 label = some (t, gain) at h
  by_cases h_l0007 : label = (7 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0631 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (631 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (631 : State) := by
  intro h
  change graphSmokeNext_s0631 label = some (t, gain) at h
  by_cases h_l0013 : label = (13 : SmokeLabel)
  · subst label
...
theorem transition_ok_range {s : State} {label : SmokeLabel} {t : State} {gain : Int}
  ...
  intro h
  interval_cases s
  · exact transition_ok_s0624 h
  · exact transition_ok_s0625 h
  · exact transition_ok_s0626 h
  · exact transition_ok_s0627 h
  · exact transition_ok_s0628 h
  · exact transition_ok_s0629 h
  · exact transition_ok_s0630 h
  · exact transition_ok_s0631 h

theorem shard_builds : True := by
  exact True.intro

end Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Shard078
