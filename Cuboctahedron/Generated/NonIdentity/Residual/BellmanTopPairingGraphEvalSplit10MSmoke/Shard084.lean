...
namespace Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Shard084

open Cuboctahedron

open Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Base

/-- Validity shard for source states [672, 680). -/
...
theorem transition_ok_s0672 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (672 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (672 : State) := by
  intro h
  change graphSmokeNext_s0672 label = some (t, gain) at h
  by_cases h_l0004 : label = (4 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0673 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (673 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (673 : State) := by
  intro h
  change graphSmokeNext_s0673 label = some (t, gain) at h
  by_cases h_l0011 : label = (11 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0674 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (674 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (674 : State) := by
  intro h
  change graphSmokeNext_s0674 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0675 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (675 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (675 : State) := by
  intro h
  change graphSmokeNext_s0675 label = some (t, gain) at h
  by_cases h_l0000 : label = (0 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0676 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (676 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (676 : State) := by
  intro h
  change graphSmokeNext_s0676 label = some (t, gain) at h
  by_cases h_l0000 : label = (0 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0677 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (677 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (677 : State) := by
  intro h
  change graphSmokeNext_s0677 label = some (t, gain) at h
  by_cases h_l0008 : label = (8 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0678 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (678 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (678 : State) := by
  intro h
  change graphSmokeNext_s0678 label = some (t, gain) at h
  by_cases h_l0003 : label = (3 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0679 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (679 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (679 : State) := by
  intro h
  change graphSmokeNext_s0679 label = some (t, gain) at h
  by_cases h_l0003 : label = (3 : SmokeLabel)
  · subst label
...
theorem transition_ok_range {s : State} {label : SmokeLabel} {t : State} {gain : Int}
  ...
  intro h
  interval_cases s
  · exact transition_ok_s0672 h
  · exact transition_ok_s0673 h
  · exact transition_ok_s0674 h
  · exact transition_ok_s0675 h
  · exact transition_ok_s0676 h
  · exact transition_ok_s0677 h
  · exact transition_ok_s0678 h
  · exact transition_ok_s0679 h

theorem shard_builds : True := by
  exact True.intro

end Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Shard084
