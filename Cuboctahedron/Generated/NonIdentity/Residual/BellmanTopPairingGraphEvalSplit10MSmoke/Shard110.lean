...
namespace Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Shard110

open Cuboctahedron

open Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Base

/-- Validity shard for source states [880, 888). -/
...
theorem transition_ok_s0880 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (880 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (880 : State) := by
  intro h
  change graphSmokeNext_s0880 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0881 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (881 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (881 : State) := by
  intro h
  change graphSmokeNext_s0881 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0882 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (882 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (882 : State) := by
  intro h
  change graphSmokeNext_s0882 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0883 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (883 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (883 : State) := by
  intro h
  change graphSmokeNext_s0883 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0884 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (884 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (884 : State) := by
  intro h
  change graphSmokeNext_s0884 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0885 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (885 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (885 : State) := by
  intro h
  change graphSmokeNext_s0885 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0886 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (886 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (886 : State) := by
  intro h
  change graphSmokeNext_s0886 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_s0887 {label : SmokeLabel} {t : State} {gain : Int} :
    graphSmokeNext (887 : State) label = some (t, gain) ->
      t < stateCount /\ gain + graphPotential t <= graphPotential (887 : State) := by
  intro h
  change graphSmokeNext_s0887 label = some (t, gain) at h
  by_cases h_l0002 : label = (2 : SmokeLabel)
  · subst label
...
theorem transition_ok_range {s : State} {label : SmokeLabel} {t : State} {gain : Int}
  ...
  intro h
  interval_cases s
  · exact transition_ok_s0880 h
  · exact transition_ok_s0881 h
  · exact transition_ok_s0882 h
  · exact transition_ok_s0883 h
  · exact transition_ok_s0884 h
  · exact transition_ok_s0885 h
  · exact transition_ok_s0886 h
  · exact transition_ok_s0887 h

theorem shard_builds : True := by
  exact True.intro

end Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphEvalSplit10MSmoke.Shard110
