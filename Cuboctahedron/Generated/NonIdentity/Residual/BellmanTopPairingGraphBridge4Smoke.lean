...
private def cls0002FaceSeq : Step14 -> Face
  | ⟨0, _⟩ => Face.xp
  | ⟨1, _⟩ => Face.xm
  | ⟨2, _⟩ => Face.ym
  | ⟨3, _⟩ => Face.yp
...
private def cls0002FaceSeqLanguage (seq : Step14 -> Face) : Prop :=
  SameFaceSeq cls0002FaceSeq seq

private theorem cls0002FaceSeqLabels_eq :
    smokeLabelsOfSeq cls0002FaceSeq = trieNode0035Labels := by
  unfold smokeLabelsOfSeq faceLabelsInContributionOrder contributionOrderSteps cls0002FaceSeq smokeLabelOfFace
  unfold trieNode0035Labels trieNode0035StepLabels trieNode0034Labels trieNode0034StepLabels trieNode0033Labels trieNode0033StepLabels trieNode0032Labels trieNode0032StepLabels trieNode0031Labels trieNode0031StepLabels trieNode0030Labels trieNode0030StepLabels trieNode0029Labels trieNode0029StepLabels trieNode0028Labels trieNode0028StepLabels trieNode0027Labels trieNode0027StepLabels trieNode0026Labels trieNode0026StepLabels trieNode0025Labels trieNode0025StepLabels trieNode0003Labels trieNode0003StepLabels trieNode0002Labels trieNode0002StepLabels trieNode0001Labels trieNode0001StepLabels trieNode0000Labels
  rfl

private theorem cls0002FaceSeqLanguage_labels_eq
    (seq : Step14 -> Face)
    (hseq : cls0002FaceSeqLanguage seq) :
    smokeLabelsOfSeq seq = trieNode0035Labels := by
  rw [← cls0002FaceSeqLabels_eq]
  unfold smokeLabelsOfSeq
  exact faceLabelsInContributionOrder_eq_of_same smokeLabelOfFace hseq

private def cls0002Rank : Fin numPairWords := ⟨23197, by decide⟩

private def cls0002Word : PairWord :=
...
@[simp] theorem cls0002Word_get00_num :
    cls0002Word.get (0 : WordIndex) = PairId.x := by
  decide

@[simp] theorem cls0002Word_get00_mk (h : 0 < 13) :
    cls0002Word.get ⟨0, h⟩ = PairId.x := by
  have hi : (⟨0, h⟩ : WordIndex) = (0 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get01_num :
    cls0002Word.get (1 : WordIndex) = PairId.y := by
  decide

@[simp] theorem cls0002Word_get01_mk (h : 1 < 13) :
    cls0002Word.get ⟨1, h⟩ = PairId.y := by
  have hi : (⟨1, h⟩ : WordIndex) = (1 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get02_num :
    cls0002Word.get (2 : WordIndex) = PairId.y := by
  decide

@[simp] theorem cls0002Word_get02_mk (h : 2 < 13) :
    cls0002Word.get ⟨2, h⟩ = PairId.y := by
  have hi : (⟨2, h⟩ : WordIndex) = (2 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get03_num :
    cls0002Word.get (3 : WordIndex) = PairId.d111 := by
  decide

@[simp] theorem cls0002Word_get03_mk (h : 3 < 13) :
    cls0002Word.get ⟨3, h⟩ = PairId.d111 := by
  have hi : (⟨3, h⟩ : WordIndex) = (3 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get04_num :
    cls0002Word.get (4 : WordIndex) = PairId.z := by
  decide

@[simp] theorem cls0002Word_get04_mk (h : 4 < 13) :
    cls0002Word.get ⟨4, h⟩ = PairId.z := by
  have hi : (⟨4, h⟩ : WordIndex) = (4 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get05_num :
    cls0002Word.get (5 : WordIndex) = PairId.z := by
  decide

@[simp] theorem cls0002Word_get05_mk (h : 5 < 13) :
    cls0002Word.get ⟨5, h⟩ = PairId.z := by
  have hi : (⟨5, h⟩ : WordIndex) = (5 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get06_num :
    cls0002Word.get (6 : WordIndex) = PairId.dm11 := by
  decide

@[simp] theorem cls0002Word_get06_mk (h : 6 < 13) :
    cls0002Word.get ⟨6, h⟩ = PairId.dm11 := by
  have hi : (⟨6, h⟩ : WordIndex) = (6 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get07_num :
    cls0002Word.get (7 : WordIndex) = PairId.d11m := by
  decide

@[simp] theorem cls0002Word_get07_mk (h : 7 < 13) :
    cls0002Word.get ⟨7, h⟩ = PairId.d11m := by
  have hi : (⟨7, h⟩ : WordIndex) = (7 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get08_num :
    cls0002Word.get (8 : WordIndex) = PairId.d1m1 := by
  decide

@[simp] theorem cls0002Word_get08_mk (h : 8 < 13) :
    cls0002Word.get ⟨8, h⟩ = PairId.d1m1 := by
  have hi : (⟨8, h⟩ : WordIndex) = (8 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get09_num :
    cls0002Word.get (9 : WordIndex) = PairId.d1m1 := by
  decide

@[simp] theorem cls0002Word_get09_mk (h : 9 < 13) :
    cls0002Word.get ⟨9, h⟩ = PairId.d1m1 := by
  have hi : (⟨9, h⟩ : WordIndex) = (9 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get10_num :
    cls0002Word.get (10 : WordIndex) = PairId.d111 := by
  decide

@[simp] theorem cls0002Word_get10_mk (h : 10 < 13) :
    cls0002Word.get ⟨10, h⟩ = PairId.d111 := by
  have hi : (⟨10, h⟩ : WordIndex) = (10 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get11_num :
    cls0002Word.get (11 : WordIndex) = PairId.dm11 := by
  decide

@[simp] theorem cls0002Word_get11_mk (h : 11 < 13) :
    cls0002Word.get ⟨11, h⟩ = PairId.dm11 := by
  have hi : (⟨11, h⟩ : WordIndex) = (11 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0002Word_get12_num :
    cls0002Word.get (12 : WordIndex) = PairId.d11m := by
  decide

@[simp] theorem cls0002Word_get12_mk (h : 12 < 13) :
    cls0002Word.get ⟨12, h⟩ = PairId.d11m := by
  have hi : (⟨12, h⟩ : WordIndex) = (12 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
private theorem cls0002Word_eq_pairWordOfSeq :
    cls0002Word = pairWordOfSeq cls0002FaceSeq := by
  decide

private theorem cls0002FaceSeq_rank :
    rankPairWord? (pairWordOfSeq cls0002FaceSeq) = some cls0002Rank := by
  decide

private theorem cls0002FaceSeq_unrank_pairword :
    unrankPairWord cls0002Rank = pairWordOfSeq cls0002FaceSeq := by
  exact
    ((rankPairWord?_eq_some_iff_unrank (pairWordOfSeq cls0002FaceSeq)
      cls0002Rank).1 cls0002FaceSeq_rank).symm

private theorem cls0002FaceSeq_matches_unrank :
    PairWordMatchesSeq (unrankPairWord cls0002Rank) cls0002FaceSeq := by
  rw [cls0002FaceSeq_unrank_pairword]
  exact pairWordOfSeq_matches cls0002FaceSeq

private theorem cls0002_unrank_word :
    unrankPairWord cls0002Rank = cls0002Word := by
  rw [cls0002FaceSeq_unrank_pairword]
  exact cls0002Word_eq_pairWordOfSeq.symm

private def cls0002Axis : Vec3 Rat := { x := (-1/3), y := (-1/3), z := -1 }

private def cls0002Kernel : KernelLineWitness :=
  { crossFactor := { m00 := (7/144), m01 := (-5/9), m02 := 0, m10 := (5/9), m11 := (23/144), m12 := 0, m20 := (-29/144), m21 := (19/144), m22 := 0 } }

private theorem cls0002KernelCheck :
    checkKernelLineWitness (totalLinearOfPairWord (unrankPairWord cls0002Rank))
      cls0002Axis cls0002Kernel = true := by
  rw [cls0002_unrank_word]
  norm_num [cls0002Axis, cls0002Kernel, checkKernelLineWitness,
    checkVec3NonzeroQ, totalLinearOfPairWord, pairLinearProductRight,
    pairLinearSuffixNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num, fixedPart, crossLeftMatrix,
    matSub, matId, matMul, matVec, canonicalNormalQ, normalQ,
    reflM, dot, scalarMat, outer]

private theorem cls0002FinalAxisDot :
    finalAxisDotQ (unrankPairWord cls0002Rank) cls0002Axis =
      (1/3) := by
  rw [cls0002_unrank_word]
  norm_num [cls0002Axis, finalAxisDotQ, pairPrefixLinearNat,
    cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num, canonicalNormalQ, normalQ, matId, matMul,
    reflM, dot, matSub, scalarMat, outer, matVec]

private theorem cls0002PrefixLinear00 :
    pairPrefixLinearNat cls0002Word 0 =
      { m00 := 1, m01 := 0, m02 := 0, m10 := 0, m11 := 1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear01 :
    pairPrefixLinearNat cls0002Word 1 =
      { m00 := -1, m01 := 0, m02 := 0, m10 := 0, m11 := 1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear02 :
    pairPrefixLinearNat cls0002Word 2 =
      { m00 := -1, m01 := 0, m02 := 0, m10 := 0, m11 := -1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear03 :
    pairPrefixLinearNat cls0002Word 3 =
      { m00 := -1, m01 := 0, m02 := 0, m10 := 0, m11 := 1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear04 :
    pairPrefixLinearNat cls0002Word 4 =
      { m00 := (-1/3), m01 := (2/3), m02 := (2/3), m10 := (-2/3), m11 := (1/3), m12 := (-2/3), m20 := (-2/3), m21 := (-2/3), m22 := (1/3) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear05 :
    pairPrefixLinearNat cls0002Word 5 =
      { m00 := (-1/3), m01 := (2/3), m02 := (-2/3), m10 := (-2/3), m11 := (1/3), m12 := (2/3), m20 := (-2/3), m21 := (-2/3), m22 := (-1/3) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear06 :
    pairPrefixLinearNat cls0002Word 6 =
      { m00 := (-1/3), m01 := (2/3), m02 := (2/3), m10 := (-2/3), m11 := (1/3), m12 := (-2/3), m20 := (-2/3), m21 := (-2/3), m22 := (1/3) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear07 :
    pairPrefixLinearNat cls0002Word 7 =
      { m00 := (7/9), m01 := (-4/9), m02 := (-4/9), m10 := (-4/9), m11 := (1/9), m12 := (-8/9), m20 := (-4/9), m21 := (-8/9), m22 := (1/9) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear08 :
    pairPrefixLinearNat cls0002Word 8 =
      { m00 := (7/27), m01 := (-26/27), m02 := (2/27), m10 := (-22/27), m11 := (-7/27), m12 := (-14/27), m20 := (14/27), m21 := (2/27), m22 := (-23/27) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear09 :
    pairPrefixLinearNat cls0002Word 9 =
      { m00 := (-49/81), m01 := (-8/81), m02 := (-64/81), m10 := (-8/81), m11 := (-79/81), m12 := (16/81), m20 := (64/81), m21 := (-16/81), m22 := (-47/81) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear10 :
    pairPrefixLinearNat cls0002Word 10 =
      { m00 := (7/27), m01 := (-26/27), m02 := (2/27), m10 := (-22/27), m11 := (-7/27), m12 := (-14/27), m20 := (14/27), m21 := (2/27), m22 := (-23/27) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear11 :
    pairPrefixLinearNat cls0002Word 11 =
      { m00 := (55/81), m01 := (-44/81), m02 := (40/81), m10 := (20/81), m11 := (65/81), m12 := (44/81), m20 := (56/81), m21 := (20/81), m22 := (-55/81) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002PrefixLinear12 :
    pairPrefixLinearNat cls0002Word 12 =
      { m00 := (47/243), m01 := (-14/243), m02 := (238/243), m10 := (238/243), m11 := (17/243), m12 := (-46/243), m20 := (-14/243), m21 := (242/243), m22 := (17/243) } := by
  norm_num [pairPrefixLinearNat, cls0002Word_get00_num, cls0002Word_get01_num, cls0002Word_get02_num, cls0002Word_get03_num, cls0002Word_get04_num, cls0002Word_get05_num, cls0002Word_get06_num, cls0002Word_get07_num, cls0002Word_get08_num, cls0002Word_get09_num, cls0002Word_get10_num, cls0002Word_get11_num, cls0002Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0002AxisForcesAt00 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (0 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 0)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (0 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear00] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get00_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt01 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (1 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 1)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (1 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear01] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get01_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt02 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (2 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 2)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (2 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear02] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get02_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt03 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (3 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 3)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (3 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear03] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get03_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt04 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (4 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 4)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (4 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear04] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get04_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt05 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (5 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 5)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (5 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear05] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get05_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt06 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (6 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 6)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (6 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear06] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get06_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt07 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (7 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 7)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (7 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear07] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get07_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt08 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (8 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 8)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (8 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear08] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get08_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt09 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (9 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 9)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (9 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear09] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get09_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt10 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (10 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 10)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (10 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear10] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get10_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt11 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (11 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 11)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (11 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear11] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get11_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForcesAt12 (f : Face)
    (hf : pairOfFace f = cls0002Word.get (12 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0002Word 12)
        (normalQ f)) cls0002Axis) :
    normalQ (cls0002FaceSeq (afterStart (12 : WordIndex))) =
      normalQ f := by
  rw [cls0002PrefixLinear12] at hpos
  cases f <;>
    simp [cls0002Axis, cls0002FaceSeq, cls0002Word_get12_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0002AxisForces :
    AxisForcesForcedSeq (unrankPairWord cls0002Rank)
      cls0002Axis cls0002FaceSeq := by
  constructor
  · unfold StartsXp cls0002FaceSeq
    decide
  constructor
  · exact cls0002FaceSeq_matches_unrank
  constructor
  · rw [cls0002FinalAxisDot]
    norm_num
  · intro i f hf hpos
    rw [cls0002_unrank_word] at hf hpos
    fin_cases i
    · exact cls0002AxisForcesAt00 f hf hpos
    · exact cls0002AxisForcesAt01 f hf hpos
    · exact cls0002AxisForcesAt02 f hf hpos
    · exact cls0002AxisForcesAt03 f hf hpos
    · exact cls0002AxisForcesAt04 f hf hpos
    · exact cls0002AxisForcesAt05 f hf hpos
    · exact cls0002AxisForcesAt06 f hf hpos
    · exact cls0002AxisForcesAt07 f hf hpos
    · exact cls0002AxisForcesAt08 f hf hpos
    · exact cls0002AxisForcesAt09 f hf hpos
    · exact cls0002AxisForcesAt10 f hf hpos
    · exact cls0002AxisForcesAt11 f hf hpos
    · exact cls0002AxisForcesAt12 f hf hpos

private def cls0002PairSignLanguage (seq : Step14 -> Face) : Prop :=
  PairSignLanguageAtRank cls0002Rank cls0002FaceSeq seq

private theorem cls0002PairSignLanguage_same
    (seq : Step14 -> Face)
    (hseq : cls0002PairSignLanguage seq) :
    cls0002FaceSeqLanguage seq := by
  exact sameFaceSeq_of_pairSignLanguageAtRank
    cls0002FaceSeq_matches_unrank hseq

private def cls0002TraceOfSeq (seq : Step14 -> Face) : SmokeLabelStepTrace where
  finish := trieNode0035State
  labels := smokeLabelsOfSeq seq
  gain := trieNode0035Gain
  margin := smokeScaledMargin SmokeObj.cls0002

private theorem cls0002TraceOfSeq_accepts
    (seq : Step14 -> Face)
    (hlabels : smokeLabelsOfSeq seq = trieNode0035Labels) :
    smokeLabelStepTraceAccepts (cls0002TraceOfSeq seq) := by
  unfold smokeLabelStepTraceAccepts cls0002TraceOfSeq
  refine ⟨?_, ?_, ?_⟩
  · change BellmanLabelStepRun SmokeStep
      rootState trieNode0035State
      (smokeLabelsOfSeq seq) trieNode0035Gain
    rw [hlabels]
    exact trieNode0035Run
  · exact cls0002TrieFinal_nonneg
  · change smokeScaledMargin SmokeObj.cls0002 <=
      (176 : Int) + trieNode0035Gain
    exact cls0002TrieMargin_bound_gain

theorem graphSmoke_cls0002_seq_of_trie_labels_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hlabels : smokeLabelsOfSeq seq = trieNode0035Labels) :
    smokeLabelStepTraceScaledMargin (cls0002TraceOfSeq seq) <= 0 :=
  graphSmoke_label_step_trace_language_scaled_margin_nonpos
    (cls0002TraceOfSeq seq) (cls0002TraceOfSeq_accepts seq hlabels)

theorem graphSmoke_cls0002_seq_language_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hseq : cls0002FaceSeqLanguage seq) :
    smokeLabelStepTraceScaledMargin (cls0002TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0002_seq_of_trie_labels_scaled_margin_nonpos
    seq (cls0002FaceSeqLanguage_labels_eq seq hseq)

theorem graphSmoke_cls0002_pair_sign_language_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hseq : cls0002PairSignLanguage seq) :
    smokeLabelStepTraceScaledMargin (cls0002TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0002_seq_language_scaled_margin_nonpos
    seq (cls0002PairSignLanguage_same seq hseq)

theorem graphSmoke_cls0002_axis_forces_scaled_margin_nonpos
    (seq : Step14 -> Face) (axis : Vec3 Rat)
    (kernel : KernelLineWitness)
    (hRealize : SeqRealizesPairWord (unrankPairWord cls0002Rank) seq)
    (hAxisConstraints : NonIdentityAxisConstraints seq)
    (hKernel :
      checkKernelLineWitness (totalLinearOfPairWord (unrankPairWord cls0002Rank))
        axis kernel = true)
    (hForces :
      AxisForcesForcedSeq (unrankPairWord cls0002Rank)
        axis cls0002FaceSeq) :
    smokeLabelStepTraceScaledMargin (cls0002TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0002_pair_sign_language_scaled_margin_nonpos
    seq
    (pairSignLanguageAtRank_of_axisForces
      hRealize hAxisConstraints hKernel hForces)

theorem graphSmoke_cls0002_generated_axis_forces_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hRealize : SeqRealizesPairWord (unrankPairWord cls0002Rank) seq)
    (hAxisConstraints : NonIdentityAxisConstraints seq) :
    smokeLabelStepTraceScaledMargin (cls0002TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0002_axis_forces_scaled_margin_nonpos
    seq cls0002Axis cls0002Kernel hRealize hAxisConstraints
    cls0002KernelCheck cls0002AxisForces

theorem graphSmoke_cls0002_face_seq_trace_scaled_margin_nonpos :
    smokeLabelStepTraceScaledMargin (cls0002TraceOfSeq cls0002FaceSeq) <= 0 :=
  graphSmoke_cls0002_seq_language_scaled_margin_nonpos
    cls0002FaceSeq (fun _ => rfl)

private def cls0003FaceSeq : Step14 -> Face
  | ⟨0, _⟩ => Face.xp
  | ⟨1, _⟩ => Face.xm
  | ⟨2, _⟩ => Face.ym
  | ⟨3, _⟩ => Face.yp
...
private def cls0003FaceSeqLanguage (seq : Step14 -> Face) : Prop :=
  SameFaceSeq cls0003FaceSeq seq

private theorem cls0003FaceSeqLabels_eq :
    smokeLabelsOfSeq cls0003FaceSeq = trieNode0044Labels := by
  unfold smokeLabelsOfSeq faceLabelsInContributionOrder contributionOrderSteps cls0003FaceSeq smokeLabelOfFace
  unfold trieNode0044Labels trieNode0044StepLabels trieNode0043Labels trieNode0043StepLabels trieNode0042Labels trieNode0042StepLabels trieNode0041Labels trieNode0041StepLabels trieNode0040Labels trieNode0040StepLabels trieNode0039Labels trieNode0039StepLabels trieNode0038Labels trieNode0038StepLabels trieNode0037Labels trieNode0037StepLabels trieNode0036Labels trieNode0036StepLabels trieNode0026Labels trieNode0026StepLabels trieNode0025Labels trieNode0025StepLabels trieNode0003Labels trieNode0003StepLabels trieNode0002Labels trieNode0002StepLabels trieNode0001Labels trieNode0001StepLabels trieNode0000Labels
  rfl

private theorem cls0003FaceSeqLanguage_labels_eq
    (seq : Step14 -> Face)
    (hseq : cls0003FaceSeqLanguage seq) :
    smokeLabelsOfSeq seq = trieNode0044Labels := by
  rw [← cls0003FaceSeqLabels_eq]
  unfold smokeLabelsOfSeq
  exact faceLabelsInContributionOrder_eq_of_same smokeLabelOfFace hseq

private def cls0003Rank : Fin numPairWords := ⟨25555, by decide⟩

private def cls0003Word : PairWord :=
...
@[simp] theorem cls0003Word_get00_num :
    cls0003Word.get (0 : WordIndex) = PairId.x := by
  decide

@[simp] theorem cls0003Word_get00_mk (h : 0 < 13) :
    cls0003Word.get ⟨0, h⟩ = PairId.x := by
  have hi : (⟨0, h⟩ : WordIndex) = (0 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get01_num :
    cls0003Word.get (1 : WordIndex) = PairId.y := by
  decide

@[simp] theorem cls0003Word_get01_mk (h : 1 < 13) :
    cls0003Word.get ⟨1, h⟩ = PairId.y := by
  have hi : (⟨1, h⟩ : WordIndex) = (1 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get02_num :
    cls0003Word.get (2 : WordIndex) = PairId.y := by
  decide

@[simp] theorem cls0003Word_get02_mk (h : 2 < 13) :
    cls0003Word.get ⟨2, h⟩ = PairId.y := by
  have hi : (⟨2, h⟩ : WordIndex) = (2 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get03_num :
    cls0003Word.get (3 : WordIndex) = PairId.d111 := by
  decide

@[simp] theorem cls0003Word_get03_mk (h : 3 < 13) :
    cls0003Word.get ⟨3, h⟩ = PairId.d111 := by
  have hi : (⟨3, h⟩ : WordIndex) = (3 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get04_num :
    cls0003Word.get (4 : WordIndex) = PairId.z := by
  decide

@[simp] theorem cls0003Word_get04_mk (h : 4 < 13) :
    cls0003Word.get ⟨4, h⟩ = PairId.z := by
  have hi : (⟨4, h⟩ : WordIndex) = (4 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get05_num :
    cls0003Word.get (5 : WordIndex) = PairId.d1m1 := by
  decide

@[simp] theorem cls0003Word_get05_mk (h : 5 < 13) :
    cls0003Word.get ⟨5, h⟩ = PairId.d1m1 := by
  have hi : (⟨5, h⟩ : WordIndex) = (5 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get06_num :
    cls0003Word.get (6 : WordIndex) = PairId.d111 := by
  decide

@[simp] theorem cls0003Word_get06_mk (h : 6 < 13) :
    cls0003Word.get ⟨6, h⟩ = PairId.d111 := by
  have hi : (⟨6, h⟩ : WordIndex) = (6 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get07_num :
    cls0003Word.get (7 : WordIndex) = PairId.dm11 := by
  decide

@[simp] theorem cls0003Word_get07_mk (h : 7 < 13) :
    cls0003Word.get ⟨7, h⟩ = PairId.dm11 := by
  have hi : (⟨7, h⟩ : WordIndex) = (7 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get08_num :
    cls0003Word.get (8 : WordIndex) = PairId.dm11 := by
  decide

@[simp] theorem cls0003Word_get08_mk (h : 8 < 13) :
    cls0003Word.get ⟨8, h⟩ = PairId.dm11 := by
  have hi : (⟨8, h⟩ : WordIndex) = (8 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get09_num :
    cls0003Word.get (9 : WordIndex) = PairId.d11m := by
  decide

@[simp] theorem cls0003Word_get09_mk (h : 9 < 13) :
    cls0003Word.get ⟨9, h⟩ = PairId.d11m := by
  have hi : (⟨9, h⟩ : WordIndex) = (9 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get10_num :
    cls0003Word.get (10 : WordIndex) = PairId.d1m1 := by
  decide

@[simp] theorem cls0003Word_get10_mk (h : 10 < 13) :
    cls0003Word.get ⟨10, h⟩ = PairId.d1m1 := by
  have hi : (⟨10, h⟩ : WordIndex) = (10 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get11_num :
    cls0003Word.get (11 : WordIndex) = PairId.z := by
  decide

@[simp] theorem cls0003Word_get11_mk (h : 11 < 13) :
    cls0003Word.get ⟨11, h⟩ = PairId.z := by
  have hi : (⟨11, h⟩ : WordIndex) = (11 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
@[simp] theorem cls0003Word_get12_num :
    cls0003Word.get (12 : WordIndex) = PairId.d11m := by
  decide

@[simp] theorem cls0003Word_get12_mk (h : 12 < 13) :
    cls0003Word.get ⟨12, h⟩ = PairId.d11m := by
  have hi : (⟨12, h⟩ : WordIndex) = (12 : WordIndex) := by
    ext
    rfl
  rw [hi]
...
private theorem cls0003Word_eq_pairWordOfSeq :
    cls0003Word = pairWordOfSeq cls0003FaceSeq := by
  decide

private theorem cls0003FaceSeq_rank :
    rankPairWord? (pairWordOfSeq cls0003FaceSeq) = some cls0003Rank := by
  decide

private theorem cls0003FaceSeq_unrank_pairword :
    unrankPairWord cls0003Rank = pairWordOfSeq cls0003FaceSeq := by
  exact
    ((rankPairWord?_eq_some_iff_unrank (pairWordOfSeq cls0003FaceSeq)
      cls0003Rank).1 cls0003FaceSeq_rank).symm

private theorem cls0003FaceSeq_matches_unrank :
    PairWordMatchesSeq (unrankPairWord cls0003Rank) cls0003FaceSeq := by
  rw [cls0003FaceSeq_unrank_pairword]
  exact pairWordOfSeq_matches cls0003FaceSeq

private theorem cls0003_unrank_word :
    unrankPairWord cls0003Rank = cls0003Word := by
  rw [cls0003FaceSeq_unrank_pairword]
  exact cls0003Word_eq_pairWordOfSeq.symm

private def cls0003Axis : Vec3 Rat := { x := (-1/3), y := (-1/3), z := -1 }

private def cls0003Kernel : KernelLineWitness :=
  { crossFactor := { m00 := (7/144), m01 := (-5/9), m02 := 0, m10 := (5/9), m11 := (23/144), m12 := 0, m20 := (-29/144), m21 := (19/144), m22 := 0 } }

private theorem cls0003KernelCheck :
    checkKernelLineWitness (totalLinearOfPairWord (unrankPairWord cls0003Rank))
      cls0003Axis cls0003Kernel = true := by
  rw [cls0003_unrank_word]
  norm_num [cls0003Axis, cls0003Kernel, checkKernelLineWitness,
    checkVec3NonzeroQ, totalLinearOfPairWord, pairLinearProductRight,
    pairLinearSuffixNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num, fixedPart, crossLeftMatrix,
    matSub, matId, matMul, matVec, canonicalNormalQ, normalQ,
    reflM, dot, scalarMat, outer]

private theorem cls0003FinalAxisDot :
    finalAxisDotQ (unrankPairWord cls0003Rank) cls0003Axis =
      (1/3) := by
  rw [cls0003_unrank_word]
  norm_num [cls0003Axis, finalAxisDotQ, pairPrefixLinearNat,
    cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num, canonicalNormalQ, normalQ, matId, matMul,
    reflM, dot, matSub, scalarMat, outer, matVec]

private theorem cls0003PrefixLinear00 :
    pairPrefixLinearNat cls0003Word 0 =
      { m00 := 1, m01 := 0, m02 := 0, m10 := 0, m11 := 1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear01 :
    pairPrefixLinearNat cls0003Word 1 =
      { m00 := -1, m01 := 0, m02 := 0, m10 := 0, m11 := 1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear02 :
    pairPrefixLinearNat cls0003Word 2 =
      { m00 := -1, m01 := 0, m02 := 0, m10 := 0, m11 := -1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear03 :
    pairPrefixLinearNat cls0003Word 3 =
      { m00 := -1, m01 := 0, m02 := 0, m10 := 0, m11 := 1, m12 := 0, m20 := 0, m21 := 0, m22 := 1 } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear04 :
    pairPrefixLinearNat cls0003Word 4 =
      { m00 := (-1/3), m01 := (2/3), m02 := (2/3), m10 := (-2/3), m11 := (1/3), m12 := (-2/3), m20 := (-2/3), m21 := (-2/3), m22 := (1/3) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear05 :
    pairPrefixLinearNat cls0003Word 5 =
      { m00 := (-1/3), m01 := (2/3), m02 := (-2/3), m10 := (-2/3), m11 := (1/3), m12 := (2/3), m20 := (-2/3), m21 := (-2/3), m22 := (-1/3) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear06 :
    pairPrefixLinearNat cls0003Word 6 =
      { m00 := (7/9), m01 := (-4/9), m02 := (4/9), m10 := (-4/9), m11 := (1/9), m12 := (8/9), m20 := (-4/9), m21 := (-8/9), m22 := (-1/9) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear07 :
    pairPrefixLinearNat cls0003Word 7 =
      { m00 := (7/27), m01 := (-26/27), m02 := (-2/27), m10 := (-22/27), m11 := (-7/27), m12 := (14/27), m20 := (14/27), m21 := (2/27), m22 := (23/27) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear08 :
    pairPrefixLinearNat cls0003Word 8 =
      { m00 := (-49/81), m01 := (-8/81), m02 := (64/81), m10 := (-8/81), m11 := (-79/81), m12 := (-16/81), m20 := (64/81), m21 := (-16/81), m22 := (47/81) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear09 :
    pairPrefixLinearNat cls0003Word 9 =
      { m00 := (7/27), m01 := (-26/27), m02 := (-2/27), m10 := (-22/27), m11 := (-7/27), m12 := (14/27), m20 := (14/27), m21 := (2/27), m22 := (23/27) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear10 :
    pairPrefixLinearNat cls0003Word 10 =
      { m00 := (55/81), m01 := (-44/81), m02 := (-40/81), m10 := (20/81), m11 := (65/81), m12 := (-44/81), m20 := (56/81), m21 := (20/81), m22 := (55/81) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear11 :
    pairPrefixLinearNat cls0003Word 11 =
      { m00 := (47/243), m01 := (-14/243), m02 := (-238/243), m10 := (238/243), m11 := (17/243), m12 := (46/243), m20 := (-14/243), m21 := (242/243), m22 := (-17/243) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003PrefixLinear12 :
    pairPrefixLinearNat cls0003Word 12 =
      { m00 := (47/243), m01 := (-14/243), m02 := (238/243), m10 := (238/243), m11 := (17/243), m12 := (-46/243), m20 := (-14/243), m21 := (242/243), m22 := (17/243) } := by
  norm_num [pairPrefixLinearNat, cls0003Word_get00_num, cls0003Word_get01_num, cls0003Word_get02_num, cls0003Word_get03_num, cls0003Word_get04_num, cls0003Word_get05_num, cls0003Word_get06_num, cls0003Word_get07_num, cls0003Word_get08_num, cls0003Word_get09_num, cls0003Word_get10_num, cls0003Word_get11_num, cls0003Word_get12_num,
    canonicalNormalQ, normalQ, matId, matMul, reflM, dot,
    matSub, scalarMat, outer]

private theorem cls0003AxisForcesAt00 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (0 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 0)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (0 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear00] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get00_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt01 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (1 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 1)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (1 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear01] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get01_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt02 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (2 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 2)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (2 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear02] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get02_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt03 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (3 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 3)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (3 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear03] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get03_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt04 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (4 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 4)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (4 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear04] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get04_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt05 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (5 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 5)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (5 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear05] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get05_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt06 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (6 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 6)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (6 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear06] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get06_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt07 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (7 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 7)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (7 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear07] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get07_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt08 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (8 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 8)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (8 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear08] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get08_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt09 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (9 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 9)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (9 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear09] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get09_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt10 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (10 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 10)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (10 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear10] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get10_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt11 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (11 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 11)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (11 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear11] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get11_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForcesAt12 (f : Face)
    (hf : pairOfFace f = cls0003Word.get (12 : WordIndex))
    (hpos : 0 <
      dot (matVec (pairPrefixLinearNat cls0003Word 12)
        (normalQ f)) cls0003Axis) :
    normalQ (cls0003FaceSeq (afterStart (12 : WordIndex))) =
      normalQ f := by
  rw [cls0003PrefixLinear12] at hpos
  cases f <;>
    simp [cls0003Axis, cls0003FaceSeq, cls0003Word_get12_num,
      afterStart, pairOfFace, normalQ, dot, matVec]
      at hf hpos ⊢ <;>
    first | contradiction | linarith | rfl

private theorem cls0003AxisForces :
    AxisForcesForcedSeq (unrankPairWord cls0003Rank)
      cls0003Axis cls0003FaceSeq := by
  constructor
  · unfold StartsXp cls0003FaceSeq
    decide
  constructor
  · exact cls0003FaceSeq_matches_unrank
  constructor
  · rw [cls0003FinalAxisDot]
    norm_num
  · intro i f hf hpos
    rw [cls0003_unrank_word] at hf hpos
    fin_cases i
    · exact cls0003AxisForcesAt00 f hf hpos
    · exact cls0003AxisForcesAt01 f hf hpos
    · exact cls0003AxisForcesAt02 f hf hpos
    · exact cls0003AxisForcesAt03 f hf hpos
    · exact cls0003AxisForcesAt04 f hf hpos
    · exact cls0003AxisForcesAt05 f hf hpos
    · exact cls0003AxisForcesAt06 f hf hpos
    · exact cls0003AxisForcesAt07 f hf hpos
    · exact cls0003AxisForcesAt08 f hf hpos
    · exact cls0003AxisForcesAt09 f hf hpos
    · exact cls0003AxisForcesAt10 f hf hpos
    · exact cls0003AxisForcesAt11 f hf hpos
    · exact cls0003AxisForcesAt12 f hf hpos

private def cls0003PairSignLanguage (seq : Step14 -> Face) : Prop :=
  PairSignLanguageAtRank cls0003Rank cls0003FaceSeq seq

private theorem cls0003PairSignLanguage_same
    (seq : Step14 -> Face)
    (hseq : cls0003PairSignLanguage seq) :
    cls0003FaceSeqLanguage seq := by
  exact sameFaceSeq_of_pairSignLanguageAtRank
    cls0003FaceSeq_matches_unrank hseq

private def cls0003TraceOfSeq (seq : Step14 -> Face) : SmokeLabelStepTrace where
  finish := trieNode0044State
  labels := smokeLabelsOfSeq seq
  gain := trieNode0044Gain
  margin := smokeScaledMargin SmokeObj.cls0003

private theorem cls0003TraceOfSeq_accepts
    (seq : Step14 -> Face)
    (hlabels : smokeLabelsOfSeq seq = trieNode0044Labels) :
    smokeLabelStepTraceAccepts (cls0003TraceOfSeq seq) := by
  unfold smokeLabelStepTraceAccepts cls0003TraceOfSeq
  refine ⟨?_, ?_, ?_⟩
  · change BellmanLabelStepRun SmokeStep
      rootState trieNode0044State
      (smokeLabelsOfSeq seq) trieNode0044Gain
    rw [hlabels]
    exact trieNode0044Run
  · exact cls0003TrieFinal_nonneg
  · change smokeScaledMargin SmokeObj.cls0003 <=
      (176 : Int) + trieNode0044Gain
    exact cls0003TrieMargin_bound_gain

theorem graphSmoke_cls0003_seq_of_trie_labels_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hlabels : smokeLabelsOfSeq seq = trieNode0044Labels) :
    smokeLabelStepTraceScaledMargin (cls0003TraceOfSeq seq) <= 0 :=
  graphSmoke_label_step_trace_language_scaled_margin_nonpos
    (cls0003TraceOfSeq seq) (cls0003TraceOfSeq_accepts seq hlabels)

theorem graphSmoke_cls0003_seq_language_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hseq : cls0003FaceSeqLanguage seq) :
    smokeLabelStepTraceScaledMargin (cls0003TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0003_seq_of_trie_labels_scaled_margin_nonpos
    seq (cls0003FaceSeqLanguage_labels_eq seq hseq)

theorem graphSmoke_cls0003_pair_sign_language_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hseq : cls0003PairSignLanguage seq) :
    smokeLabelStepTraceScaledMargin (cls0003TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0003_seq_language_scaled_margin_nonpos
    seq (cls0003PairSignLanguage_same seq hseq)

theorem graphSmoke_cls0003_axis_forces_scaled_margin_nonpos
    (seq : Step14 -> Face) (axis : Vec3 Rat)
    (kernel : KernelLineWitness)
    (hRealize : SeqRealizesPairWord (unrankPairWord cls0003Rank) seq)
    (hAxisConstraints : NonIdentityAxisConstraints seq)
    (hKernel :
      checkKernelLineWitness (totalLinearOfPairWord (unrankPairWord cls0003Rank))
        axis kernel = true)
    (hForces :
      AxisForcesForcedSeq (unrankPairWord cls0003Rank)
        axis cls0003FaceSeq) :
    smokeLabelStepTraceScaledMargin (cls0003TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0003_pair_sign_language_scaled_margin_nonpos
    seq
    (pairSignLanguageAtRank_of_axisForces
      hRealize hAxisConstraints hKernel hForces)

theorem graphSmoke_cls0003_generated_axis_forces_scaled_margin_nonpos
    (seq : Step14 -> Face)
    (hRealize : SeqRealizesPairWord (unrankPairWord cls0003Rank) seq)
    (hAxisConstraints : NonIdentityAxisConstraints seq) :
    smokeLabelStepTraceScaledMargin (cls0003TraceOfSeq seq) <= 0 :=
  graphSmoke_cls0003_axis_forces_scaled_margin_nonpos
    seq cls0003Axis cls0003Kernel hRealize hAxisConstraints
    cls0003KernelCheck cls0003AxisForces

theorem graphSmoke_cls0003_face_seq_trace_scaled_margin_nonpos :
    smokeLabelStepTraceScaledMargin (cls0003TraceOfSeq cls0003FaceSeq) <= 0 :=
  graphSmoke_cls0003_seq_language_scaled_margin_nonpos
    cls0003FaceSeq (fun _ => rfl)
...
end Cuboctahedron.Generated.NonIdentity.Residual.BellmanTopPairingGraphBridge4Smoke
