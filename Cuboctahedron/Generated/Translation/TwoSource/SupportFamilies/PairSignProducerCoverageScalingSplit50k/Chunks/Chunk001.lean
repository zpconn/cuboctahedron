...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PairSignProducerCoverageScalingSplit50k.Chunks.Chunk001
...
theorem fam_064_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_064_key.support r mask) :
    row_001_producer.Applies fam_064_key r mask := by
...
theorem fam_065_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarSecondRows fam_065_key.support r mask) :
    row_005_producer.Applies fam_065_key r mask := by
...
theorem fam_066_sourceApplies_of_sourcePredicate
    ...
    source_068_producer.Applies fam_066_key r mask := by
  unfold source_068_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_066_key, fam_066_support, source_068_support],
    hsource⟩⟩⟩

theorem fam_066_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_066_key.support r mask) :
    row_007_producer.Applies fam_066_key r mask := by
...
theorem fam_067_sourceApplies_of_sourcePredicate
    ...
    source_067_producer.Applies fam_067_key r mask := by
  unfold source_067_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_067_key, fam_067_support, source_067_support],
    hsource⟩⟩⟩

theorem fam_067_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_067_key.support r mask) :
    row_003_producer.Applies fam_067_key r mask := by
...
theorem fam_068_rowApplies_of_rows
    ...
    row_001_producer.Applies fam_068_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_070_sourceApplies_of_sourcePredicate
    ...
    source_074_producer.Applies fam_070_key r mask := by
  unfold source_074_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_070_key, fam_070_support, source_074_support],
    hsource⟩⟩⟩

theorem fam_070_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_070_key.support r mask) :
    row_007_producer.Applies fam_070_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_071_sourceApplies_of_sourcePredicate
  ...
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_071_key, fam_071_support, source_071_support],
    hsource⟩⟩⟩
...
theorem fam_073_sourceApplies_of_sourcePredicate
    ...
    source_075_producer.Applies fam_073_key r mask := by
  unfold source_075_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_073_key, fam_073_support, source_075_support],
    hsource⟩⟩⟩

theorem fam_073_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_073_key.support r mask) :
    row_000_producer.Applies fam_073_key r mask := by
...
theorem fam_074_sourceApplies_of_sourcePredicate
    ...
    source_077_producer.Applies fam_074_key r mask := by
  unfold source_077_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_074_key, fam_074_support, source_077_support],
    hsource⟩⟩⟩
...
theorem fam_075_sourceApplies_of_sourcePredicate
    ...
    source_078_producer.Applies fam_075_key r mask := by
  unfold source_078_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_075_key, fam_075_support, source_078_support],
    hsource⟩⟩⟩

theorem fam_075_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_075_key.support r mask) :
    row_003_producer.Applies fam_075_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_076_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_076_key.support r mask) :
    row_006_producer.Applies fam_076_key r mask := by
...
theorem fam_077_sourceApplies_of_sourcePredicate
    ...
    source_082_producer.Applies fam_077_key r mask := by
  unfold source_082_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_077_key, fam_077_support, source_082_support],
    hsource⟩⟩⟩
...
theorem fam_078_sourceApplies_of_sourcePredicate
    ...
    source_081_producer.Applies fam_078_key r mask := by
  unfold source_081_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_078_key, fam_078_support, source_081_support],
    hsource⟩⟩⟩
...
theorem fam_079_sourceApplies_of_sourcePredicate
    ...
    source_080_producer.Applies fam_079_key r mask := by
  unfold source_080_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_079_key, fam_079_support, source_080_support],
    hsource⟩⟩⟩
...
theorem fam_080_sourceApplies_of_sourcePredicate
    ...
    source_087_producer.Applies fam_080_key r mask := by
  unfold source_087_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_080_key, fam_080_support, source_087_support],
    hsource⟩⟩⟩

theorem fam_080_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_080_key.support r mask) :
    row_007_producer.Applies fam_080_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_081_sourceApplies_of_sourcePredicate
    ...
    source_085_producer.Applies fam_081_key r mask := by
  unfold source_085_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_081_key, fam_081_support, source_085_support],
    hsource⟩⟩⟩

theorem fam_081_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_081_key.support r mask) :
    row_000_producer.Applies fam_081_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_082_sourceApplies_of_sourcePredicate
    ...
    source_086_producer.Applies fam_082_key r mask := by
  unfold source_086_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_082_key, fam_082_support, source_086_support],
    hsource⟩⟩⟩

theorem fam_082_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_082_key.support r mask) :
    row_001_producer.Applies fam_082_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `3c9c012bf9f4b9fb87bae56d2d7784ec4f2b5b01e78ad6c657b729759676c85c`.
Observed representative GoodDirection cases: 12. -/
...
theorem fam_083_sourceApplies_of_sourcePredicate
    ...
    source_083_producer.Applies fam_083_key r mask := by
  unfold source_083_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_083_key, fam_083_support, source_083_support],
    hsource⟩⟩⟩

theorem fam_083_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_083_key.support r mask) :
    row_001_producer.Applies fam_083_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_084_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_084_key.support r mask) :
    row_003_producer.Applies fam_084_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_085_sourceApplies_of_sourcePredicate
    ...
    source_089_producer.Applies fam_085_key r mask := by
  unfold source_089_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_085_key, fam_085_support, source_089_support],
    hsource⟩⟩⟩

theorem fam_085_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_085_key.support r mask) :
    row_007_producer.Applies fam_085_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_086_sourceApplies_of_sourcePredicate
    ...
    source_088_producer.Applies fam_086_key r mask := by
  unfold source_088_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_086_key, fam_086_support, source_088_support],
    hsource⟩⟩⟩

theorem fam_086_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_086_key.support r mask) :
    row_000_producer.Applies fam_086_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_087_sourceApplies_of_sourcePredicate
    ...
    source_076_producer.Applies fam_087_key r mask := by
  unfold source_076_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_087_key, fam_087_support, source_076_support],
    hsource⟩⟩⟩

theorem fam_087_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_087_key.support r mask) :
    row_009_producer.Applies fam_087_key r mask := by
...
theorem fam_088_sourceApplies_of_sourcePredicate
    ...
    source_090_producer.Applies fam_088_key r mask := by
  unfold source_090_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_088_key, fam_088_support, source_090_support],
    hsource⟩⟩⟩

theorem fam_088_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_088_key.support r mask) :
    row_003_producer.Applies fam_088_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_089_sourceApplies_of_sourcePredicate
    ...
    source_097_producer.Applies fam_089_key r mask := by
  unfold source_097_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_089_key, fam_089_support, source_097_support],
    hsource⟩⟩⟩

theorem fam_089_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_089_key.support r mask) :
    row_006_producer.Applies fam_089_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_090_sourceApplies_of_sourcePredicate
    ...
    source_093_producer.Applies fam_090_key r mask := by
  unfold source_093_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_090_key, fam_090_support, source_093_support],
    hsource⟩⟩⟩

theorem fam_090_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_090_key.support r mask) :
    row_006_producer.Applies fam_090_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_091_sourceApplies_of_sourcePredicate
    ...
    source_095_producer.Applies fam_091_key r mask := by
  unfold source_095_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_091_key, fam_091_support, source_095_support],
    hsource⟩⟩⟩

theorem fam_091_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_091_key.support r mask) :
    row_007_producer.Applies fam_091_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_092_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_092_key.support r mask) :
    row_000_producer.Applies fam_092_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_093_sourceApplies_of_sourcePredicate
    ...
    source_096_producer.Applies fam_093_key r mask := by
  unfold source_096_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_093_key, fam_093_support, source_096_support],
    hsource⟩⟩⟩

theorem fam_093_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_093_key.support r mask) :
    row_003_producer.Applies fam_093_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_094_sourceApplies_of_sourcePredicate
    ...
    source_094_producer.Applies fam_094_key r mask := by
  unfold source_094_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_094_key, fam_094_support, source_094_support],
    hsource⟩⟩⟩
...
theorem fam_095_sourceApplies_of_sourcePredicate
    ...
    source_098_producer.Applies fam_095_key r mask := by
  unfold source_098_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_095_key, fam_095_support, source_098_support],
    hsource⟩⟩⟩

theorem fam_095_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_095_key.support r mask) :
    row_000_producer.Applies fam_095_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_096_sourceApplies_of_sourcePredicate
    ...
    source_100_producer.Applies fam_096_key r mask := by
  unfold source_100_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_096_key, fam_096_support, source_100_support],
    hsource⟩⟩⟩

theorem fam_096_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_096_key.support r mask) :
    row_001_producer.Applies fam_096_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_097_sourceApplies_of_sourcePredicate
    ...
    source_099_producer.Applies fam_097_key r mask := by
  unfold source_099_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_097_key, fam_097_support, source_099_support],
    hsource⟩⟩⟩

theorem fam_097_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_097_key.support r mask) :
    row_001_producer.Applies fam_097_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_098_sourceApplies_of_sourcePredicate
    ...
    source_056_producer.Applies fam_098_key r mask := by
  unfold source_056_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_098_key, fam_098_support, source_056_support],
    hsource⟩⟩⟩

theorem fam_098_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_098_key.support r mask) :
    row_011_producer.Applies fam_098_key r mask := by
...
theorem fam_099_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        44 5 source_056_support r mask) :
    source_056_producer.Applies fam_099_key r mask := by
  unfold source_056_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_099_key, fam_099_support, source_056_support],
    hsource⟩⟩⟩

theorem fam_099_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_099_key.support r mask) :
...
/-- Pair-sign producer coverage key `1c655bf19e830130ca871e263b46428c0ed69ae6e3fd595799d794d861e72f4d`.
Observed representative GoodDirection cases: 8. -/
...
theorem fam_100_sourceApplies_of_sourcePredicate
    ...
    source_106_producer.Applies fam_100_key r mask := by
  unfold source_106_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_100_key, fam_100_support, source_106_support],
    hsource⟩⟩⟩

theorem fam_100_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_100_key.support r mask) :
    row_000_producer.Applies fam_100_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_101_sourceApplies_of_sourcePredicate
    ...
    source_101_producer.Applies fam_101_key r mask := by
  unfold source_101_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_101_key, fam_101_support, source_101_support],
    hsource⟩⟩⟩

theorem fam_101_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_101_key.support r mask) :
    row_000_producer.Applies fam_101_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_102_sourceApplies_of_sourcePredicate
    ...
    source_103_producer.Applies fam_102_key r mask := by
  unfold source_103_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_102_key, fam_102_support, source_103_support],
    hsource⟩⟩⟩

theorem fam_102_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_102_key.support r mask) :
    row_000_producer.Applies fam_102_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_103_sourceApplies_of_sourcePredicate
    ...
    source_104_producer.Applies fam_103_key r mask := by
  unfold source_104_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_103_key, fam_103_support, source_104_support],
    hsource⟩⟩⟩

theorem fam_103_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_103_key.support r mask) :
    row_001_producer.Applies fam_103_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_104_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_104_key.support r mask) :
    row_003_producer.Applies fam_104_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_106_sourceApplies_of_sourcePredicate
    ...
    source_113_producer.Applies fam_106_key r mask := by
  unfold source_113_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_106_key, fam_106_support, source_113_support],
    hsource⟩⟩⟩

theorem fam_106_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_106_key.support r mask) :
    row_011_producer.Applies fam_106_key r mask := by
  unfold row_011_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_107_sourceApplies_of_sourcePredicate
    ...
    source_110_producer.Applies fam_107_key r mask := by
  unfold source_110_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_107_key, fam_107_support, source_110_support],
    hsource⟩⟩⟩

theorem fam_107_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_107_key.support r mask) :
    row_007_producer.Applies fam_107_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_108_sourceApplies_of_sourcePredicate
    ...
    source_112_producer.Applies fam_108_key r mask := by
  unfold source_112_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_108_key, fam_108_support, source_112_support],
    hsource⟩⟩⟩
...
theorem fam_109_sourceApplies_of_sourcePredicate
    ...
    source_111_producer.Applies fam_109_key r mask := by
  unfold source_111_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_109_key, fam_109_support, source_111_support],
    hsource⟩⟩⟩

theorem fam_109_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_109_key.support r mask) :
    row_009_producer.Applies fam_109_key r mask := by
  unfold row_009_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_110_sourceApplies_of_sourcePredicate
    ...
    source_073_producer.Applies fam_110_key r mask := by
  unfold source_073_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_110_key, fam_110_support, source_073_support],
    hsource⟩⟩⟩

theorem fam_110_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_110_key.support r mask) :
    row_010_producer.Applies fam_110_key r mask := by
...
theorem fam_111_sourceApplies_of_sourcePredicate
    ...
    source_114_producer.Applies fam_111_key r mask := by
  unfold source_114_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_111_key, fam_111_support, source_114_support],
    hsource⟩⟩⟩
...
/-- Pair-sign producer coverage key `fe3c268598b057eb676ffb3a55ef0fb798c39c622b6cb25c30edd0c01535b5b1`.
Observed representative GoodDirection cases: 7. -/
...
theorem fam_112_sourceApplies_of_sourcePredicate
    ...
    source_109_producer.Applies fam_112_key r mask := by
  unfold source_109_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_112_key, fam_112_support, source_109_support],
    hsource⟩⟩⟩

theorem fam_112_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_112_key.support r mask) :
    row_001_producer.Applies fam_112_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_113_sourceApplies_of_sourcePredicate
    ...
    source_108_producer.Applies fam_113_key r mask := by
  unfold source_108_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_113_key, fam_113_support, source_108_support],
    hsource⟩⟩⟩

theorem fam_113_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_113_key.support r mask) :
    row_003_producer.Applies fam_113_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_115_sourceApplies_of_sourcePredicate
    ...
    source_116_producer.Applies fam_115_key r mask := by
  unfold source_116_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_115_key, fam_115_support, source_116_support],
    hsource⟩⟩⟩

theorem fam_115_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_115_key.support r mask) :
    row_000_producer.Applies fam_115_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `0c757deb98e87f8e57f76ee52ce966d28b23771e6f5ca6e372ea728ca0e56afb`.
Observed representative GoodDirection cases: 6. -/
...
theorem fam_116_sourceApplies_of_sourcePredicate
    ...
    source_107_producer.Applies fam_116_key r mask := by
  unfold source_107_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_116_key, fam_116_support, source_107_support],
    hsource⟩⟩⟩

theorem fam_116_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_116_key.support r mask) :
    row_008_producer.Applies fam_116_key r mask := by
...
/-- Pair-sign producer coverage key `1abf2f95695c8b6289612bec3aa623689d19a4f51bf360c73bba3438f9422681`.
Observed representative GoodDirection cases: 6. -/
...
theorem fam_117_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        16 5 source_073_support r mask) :
    source_073_producer.Applies fam_117_key r mask := by
  unfold source_073_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_117_key, fam_117_support, source_073_support],
    hsource⟩⟩⟩

theorem fam_117_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_117_key.support r mask) :
    row_013_producer.Applies fam_117_key r mask := by
...
/-- Pair-sign producer coverage key `8c1709d6da72013530df4d73b400b681d66c6afe01489a9be7e6cd087046b40a`.
Observed representative GoodDirection cases: 6. -/
...
theorem fam_118_sourceApplies_of_sourcePredicate
    ...
    source_119_producer.Applies fam_118_key r mask := by
  unfold source_119_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_118_key, fam_118_support, source_119_support],
    hsource⟩⟩⟩
...
/-- Pair-sign producer coverage key `e1d7cc4f96f0fdebe59a6f411d6ad096eb186ace6bfe80280ac4902f2fa9edb3`.
Observed representative GoodDirection cases: 6. -/
...
theorem fam_119_rowApplies_of_rows
    ...
    row_008_producer.Applies fam_119_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_120_sourceApplies_of_sourcePredicate
    ...
    source_115_producer.Applies fam_120_key r mask := by
  unfold source_115_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_120_key, fam_120_support, source_115_support],
    hsource⟩⟩⟩

theorem fam_120_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_120_key.support r mask) :
    row_003_producer.Applies fam_120_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_121_sourceApplies_of_sourcePredicate
    ...
    source_123_producer.Applies fam_121_key r mask := by
  unfold source_123_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_121_key, fam_121_support, source_123_support],
    hsource⟩⟩⟩

theorem fam_121_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_121_key.support r mask) :
    row_006_producer.Applies fam_121_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_122_sourceApplies_of_sourcePredicate
    ...
    source_121_producer.Applies fam_122_key r mask := by
  unfold source_121_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_122_key, fam_122_support, source_121_support],
    hsource⟩⟩⟩

theorem fam_122_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_122_key.support r mask) :
    row_006_producer.Applies fam_122_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_123_sourceApplies_of_sourcePredicate
    ...
    source_124_producer.Applies fam_123_key r mask := by
  unfold source_124_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_123_key, fam_123_support, source_124_support],
    hsource⟩⟩⟩

theorem fam_123_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_123_key.support r mask) :
    row_000_producer.Applies fam_123_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `c9dfa1ae8a047adfb7bdf31a4cd56cc08d173c38a84e9e8c6986f6d2472bc572`.
Observed representative GoodDirection cases: 5. -/
...
theorem fam_124_sourceApplies_of_sourcePredicate
    ...
    source_128_producer.Applies fam_124_key r mask := by
  unfold source_128_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_124_key, fam_124_support, source_128_support],
    hsource⟩⟩⟩

theorem fam_124_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_124_key.support r mask) :
    row_000_producer.Applies fam_124_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `ee9d963f988c28c20e4878e753c547806b35225c62d93b430a2790bc2caa07cf`.
Observed representative GoodDirection cases: 5. -/
...
theorem fam_125_sourceApplies_of_sourcePredicate
    ...
    source_129_producer.Applies fam_125_key r mask := by
  unfold source_129_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_125_key, fam_125_support, source_129_support],
    hsource⟩⟩⟩

theorem fam_125_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_125_key.support r mask) :
    row_000_producer.Applies fam_125_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `e884bf642381857c9e821cc0e79abe41abb914e71de395805aba5530a294da08`.
Observed representative GoodDirection cases: 5. -/
...
theorem fam_126_sourceApplies_of_sourcePredicate
    ...
    source_091_producer.Applies fam_126_key r mask := by
  unfold source_091_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_126_key, fam_126_support, source_091_support],
    hsource⟩⟩⟩

theorem fam_126_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_126_key.support r mask) :
    row_008_producer.Applies fam_126_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `2e009d4c88d526487967fcad5169c3f26880df23b60efd2c079f1cea17d0525c`.
Observed representative GoodDirection cases: 5. -/
...
theorem fam_127_sourceApplies_of_sourcePredicate
    ...
    source_125_producer.Applies fam_127_key r mask := by
  unfold source_125_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_127_key, fam_127_support, source_125_support],
    hsource⟩⟩⟩
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PairSignProducerCoverageScalingSplit50k.Chunks.Chunk001
