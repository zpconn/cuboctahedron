...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx31Smoke
...
def poly899_1_8 : WalshQuadratic where
  c := 12
  y := 0
  z := 0
  d111 := 8/3
...
private def reduced899_1_8 : WalshQuadratic where
  c := -4
  y := 0
  z := 4
  d111 := 0
...
private theorem poly899_1_8_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube0x0xx1.Member mask) :
    poly899_1_8.coeffEval mask = reduced899_1_8.coeffEval mask := by
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly899_1_8, reduced899_1_8, WalshQuadratic.coeffEval, SignBit.value, hy, hd111, hdm11, hz, hd11m, hd1m1]
        norm_num

private def reducedBound899_1_8 :
    WalshQuadraticReducedAbsBound cube0x0xx1 poly899_1_8 where
  reduced := reduced899_1_8
  eq_on_cube := by
    intro mask hmask
    exact poly899_1_8_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced899_1_8, WalshQuadratic.absBoundSum]

private def cubeBound899_1_8 :
    WalshQuadraticCubeBound cube0x0xx1 poly899_1_8 :=
  WalshQuadraticCubeBound.leaf reducedBound899_1_8

private theorem poly899_1_8_nonpos
    {mask : SignMask} (hmask : cube0x0xx1.Member mask) :
    poly899_1_8.coeffEval mask <= 0 :=
  cubeBound899_1_8.coeffEval_nonpos hmask

def reducedObstruction899_1_8
    (direct_eq :
      forall {mask : SignMask} (hlt : rank899 < numPairWords),
        cube0x0xx1.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank899, hlt⟩ : Fin numPairWords) mask weights1_8 =
            poly899_1_8.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank899 cube0x0xx1.Member where
  weights := weights1_8
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly899_1_8_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    weightedDenomAtRank
      (⟨rank899, hlt⟩ : Fin numPairWords) mask weights1_8 <= 0 :=
  (reducedObstruction899_1_8 direct_eq).nonpos hlt hmember
...
private theorem dot_sum_eval
    ...
    dot00.coeffEval mask + dot07.coeffEval mask =
      poly899_1_8.coeffEval mask := by
  simp [dot00, dot07, poly899_1_8,
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx31Smoke
