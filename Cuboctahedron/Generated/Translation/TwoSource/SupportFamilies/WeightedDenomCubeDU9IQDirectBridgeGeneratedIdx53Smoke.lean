...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx53Smoke
...
private theorem poly905_2_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      simp [poly905_2, reduced905_2, WalshQuadratic.coeffEval, SignBit.value, hy, hd111, hd1m1, hdm11, hz, hd11m]
      norm_num

private def reducedBound905_2 :
    WalshQuadraticReducedAbsBound cube1x0x10 poly905_2 where
...
private def cubeBound905_2 :
    WalshQuadraticCubeBound cube1x0x10 poly905_2 :=
...
def reducedObstruction905_2
    ...
    WeightedWalshQuadraticNonposObstruction rank905 cube1x0x10.Member where
  weights := weights2
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx53Smoke
