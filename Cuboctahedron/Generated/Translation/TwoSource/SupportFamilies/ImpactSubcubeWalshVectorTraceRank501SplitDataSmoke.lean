...
/-!
Generated AP16DK split Walsh-vector trace data for rank `501`.
-/
...
def generatedRank : Fin numPairWords := ⟨501, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.dm11, PairId.d111, PairId.d1m1, PairId.d1m1], by decide⟩
