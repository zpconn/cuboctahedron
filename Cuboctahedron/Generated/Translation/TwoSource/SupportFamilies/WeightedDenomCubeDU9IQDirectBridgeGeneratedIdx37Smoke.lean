...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx37Smoke
...
def poly899_2_6 : WalshQuadratic where
  c := 12
  y := 0
  z := 0
  d111 := 0
...
private def reduced899_2_6 : WalshQuadratic where
  c := -4
  y := 0
  z := 4
  d111 := 0
...
private theorem poly899_2_6_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube1xx0x0.Member mask) :
    poly899_2_6.coeffEval mask = reduced899_2_6.coeffEval mask := by
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly899_2_6, reduced899_2_6, WalshQuadratic.coeffEval, SignBit.value, hy, hd11m, hdm11, hz, hd111, hd1m1]
        norm_num

private def reducedBound899_2_6 :
    WalshQuadraticReducedAbsBound cube1xx0x0 poly899_2_6 where
  reduced := reduced899_2_6
  eq_on_cube := by
    intro mask hmask
    exact poly899_2_6_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced899_2_6, WalshQuadratic.absBoundSum]

private def cubeBound899_2_6 :
    WalshQuadraticCubeBound cube1xx0x0 poly899_2_6 :=
  WalshQuadraticCubeBound.leaf reducedBound899_2_6

private theorem poly899_2_6_nonpos
    {mask : SignMask} (hmask : cube1xx0x0.Member mask) :
    poly899_2_6.coeffEval mask <= 0 :=
  cubeBound899_2_6.coeffEval_nonpos hmask

def reducedObstruction899_2_6
    (direct_eq :
      forall {mask : SignMask} (hlt : rank899 < numPairWords),
        cube1xx0x0.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank899, hlt⟩ : Fin numPairWords) mask weights2_6 =
            poly899_2_6.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank899 cube1xx0x0.Member where
  weights := weights2_6
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly899_2_6_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    weightedDenomAtRank
      (⟨rank899, hlt⟩ : Fin numPairWords) mask weights2_6 <= 0 :=
  (reducedObstruction899_2_6 direct_eq).nonpos hlt hmember
...
private theorem dot_sum_eval
    ...
    dot01.coeffEval mask + dot05.coeffEval mask =
      poly899_2_6.coeffEval mask := by
  simp [dot01, dot05, poly899_2_6,
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx37Smoke
