...
/-!
Generated AP16DK split Walsh-vector trace data for rank `209`.
-/
...
def generatedRank : Fin numPairWords := ⟨209, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d11m, PairId.d1m1, PairId.dm11, PairId.dm11, PairId.d1m1, PairId.d11m, PairId.d111], by decide⟩
