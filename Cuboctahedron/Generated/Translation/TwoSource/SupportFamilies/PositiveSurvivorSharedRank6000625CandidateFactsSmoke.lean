...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedRank6000625CandidateFactsSmoke
...
private theorem case_000000_sourcePredicate :
    (generatedSpec .c005).Predicate case_000000_rank.val case_000000_mask := by
  intro hlt
  have hrank : (⟨case_000000_rank.val, hlt⟩ : Fin numPairWords) = case_000000_rank := by
    ext
    rfl
  ...
  have hsourceChecks :
      SourceChecks (generatedSpec .c005).support case_000000_rank.val hlt case_000000_mask := by
...
private theorem case_000000_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c005).support case_000000_rank.val case_000000_mask
  rw [show (generatedKey .c005).support = case_000000_support by rfl]
  intro hlt
...
theorem case_000000_candidateFacts :
    CandidateFacts .c005 6000625 ⟨8, by decide⟩ := by
...
private theorem case_000001_sourcePredicate :
    (generatedSpec .c004).Predicate case_000001_rank.val case_000001_mask := by
  intro hlt
  have hrank : (⟨case_000001_rank.val, hlt⟩ : Fin numPairWords) = case_000001_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c004).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c004).support case_000001_rank.val hlt case_000001_mask := by
...
private theorem case_000001_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000001_rank.val case_000001_mask
  rw [show (generatedKey .c004).support = case_000001_support by rfl]
  intro hlt
...
theorem case_000001_candidateFacts :
    CandidateFacts .c004 6000625 ⟨9, by decide⟩ := by
...
private theorem case_000002_sourcePredicate :
    (generatedSpec .c006).Predicate case_000002_rank.val case_000002_mask := by
  intro hlt
  have hrank : (⟨case_000002_rank.val, hlt⟩ : Fin numPairWords) = case_000002_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c006).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c006).support case_000002_rank.val hlt case_000002_mask := by
...
private theorem case_000002_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c006).support case_000002_rank.val case_000002_mask
  rw [show (generatedKey .c006).support = case_000002_support by rfl]
  intro hlt
...
theorem case_000002_candidateFacts :
    CandidateFacts .c006 6000625 ⟨13, by decide⟩ := by
...
private theorem case_000003_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000003_rank.val case_000003_mask
...
theorem case_000003_candidateFacts :
    CandidateFacts .c004 6000625 ⟨20, by decide⟩ := by
...
private theorem case_000004_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c002).support case_000004_rank.val case_000004_mask
...
theorem case_000004_candidateFacts :
    CandidateFacts .c002 6000625 ⟨22, by decide⟩ := by
...
private theorem case_000005_sourcePredicate :
    (generatedSpec .c006).Predicate case_000005_rank.val case_000005_mask := by
  intro hlt
  have hrank : (⟨case_000005_rank.val, hlt⟩ : Fin numPairWords) = case_000005_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c006).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c006).support case_000005_rank.val hlt case_000005_mask := by
...
private theorem case_000005_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c006).support case_000005_rank.val case_000005_mask
  rw [show (generatedKey .c006).support = case_000005_support by rfl]
  intro hlt
...
theorem case_000005_candidateFacts :
    CandidateFacts .c006 6000625 ⟨29, by decide⟩ := by
...
private theorem case_000007_sourcePredicate :
    (generatedSpec .c005).Predicate case_000007_rank.val case_000007_mask := by
  intro hlt
  have hrank : (⟨case_000007_rank.val, hlt⟩ : Fin numPairWords) = case_000007_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c005).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c005).support case_000007_rank.val hlt case_000007_mask := by
...
private theorem case_000007_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c005).support case_000007_rank.val case_000007_mask
  rw [show (generatedKey .c005).support = case_000007_support by rfl]
  intro hlt
...
theorem case_000007_candidateFacts :
    CandidateFacts .c005 6000625 ⟨45, by decide⟩ := by
...
private theorem case_000009_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c003).support case_000009_rank.val case_000009_mask
...
theorem case_000009_candidateFacts :
    CandidateFacts .c003 6000625 ⟨55, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedRank6000625CandidateFactsSmoke
