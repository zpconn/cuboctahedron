...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx59Smoke
...
def cubexxx00x : MaskSubcube where
  fixed
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        ...
        all_goals
          simp [poly905_1, reduced905_1, WalshQuadratic.coeffEval, SignBit.value, hd11m, hd1m1, hy, hz, hd111, hdm11]
          norm_num

private def reducedBound905_1 :
    WalshQuadraticReducedAbsBound cubexxx00x poly905_1 where
...
private def cubeBound905_1 :
    WalshQuadraticCubeBound cubexxx00x poly905_1 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cubexxx00x.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank905 < numPairWords)
    (_hmember : cubexxx00x.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank905, hlt⟩ : Fin numPairWords) mask weights1 =
      poly905_1.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx59Smoke
