...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx81Smoke
...
private theorem poly955_1_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly955_1, reduced955_1, WalshQuadratic.coeffEval, SignBit.value, hd111, hd11m, hd1m1, hy, hz, hdm11]
        norm_num

private def reducedBound955_1 :
    WalshQuadraticReducedAbsBound cubexx100x poly955_1 where
...
private def cubeBound955_1 :
    WalshQuadraticCubeBound cubexx100x poly955_1 :=
...
def reducedObstruction955_1
    ...
    WeightedWalshQuadraticNonposObstruction rank955 cubexx100x.Member where
  weights := weights1
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx81Smoke
