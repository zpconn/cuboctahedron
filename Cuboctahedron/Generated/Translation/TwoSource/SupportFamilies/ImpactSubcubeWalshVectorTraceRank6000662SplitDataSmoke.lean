...
/-!
Generated AP16DK split Walsh-vector trace data for rank `6000662`.
-/
...
def generatedRank : Fin numPairWords := ⟨6000662, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.dm11, PairId.y, PairId.y, PairId.z, PairId.d11m, PairId.d11m, PairId.z], by decide⟩
...
@[simp] theorem generatedWord_get_01
    (h : (1 : Nat) < 13) :
    generatedWord.get ⟨1, h⟩ = PairId.d1m1 := by
...
@[simp] theorem generatedWord_get_02
    (h : (2 : Nat) < 13) :
    generatedWord.get ⟨2, h⟩ = PairId.d1m1 := by
...
@[simp] theorem generatedWord_get_04
    (h : (4 : Nat) < 13) :
    generatedWord.get ⟨4, h⟩ = PairId.d111 := by
...
@[simp] theorem generatedWord_get_06
    (h : (6 : Nat) < 13) :
    generatedWord.get ⟨6, h⟩ = PairId.dm11 := by
...
@[simp] theorem generatedWord_getFin_07 :
    Vector.get generatedWord (7 : WordIndex) = PairId.y := by
  rfl

@[simp] theorem generatedWord_get_07
    (h : (7 : Nat) < 13) :
    generatedWord.get ⟨7, h⟩ = PairId.y := by
...
@[simp] theorem generatedWord_getFin_08 :
    Vector.get generatedWord (8 : WordIndex) = PairId.y := by
  rfl

@[simp] theorem generatedWord_get_08
    (h : (8 : Nat) < 13) :
    generatedWord.get ⟨8, h⟩ = PairId.y := by
...
@[simp] theorem generatedWord_getFin_09 :
    Vector.get generatedWord (9 : WordIndex) = PairId.z := by
  rfl

@[simp] theorem generatedWord_get_09
    (h : (9 : Nat) < 13) :
    generatedWord.get ⟨9, h⟩ = PairId.z := by
...
@[simp] theorem generatedWord_get_12
    (h : (12 : Nat) < 13) :
    generatedWord.get ⟨12, h⟩ = PairId.z := by
