...
/-!
Generated AP16DK split Walsh-vector trace data for rank `716`.
-/
...
def generatedRank : Fin numPairWords := ⟨716, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d111, PairId.dm11, PairId.dm11, PairId.d11m], by decide⟩
...
@[simp] theorem generatedWord_getFin_05 :
    Vector.get generatedWord (5 : WordIndex) = PairId.d11m := by
  rfl

@[simp] theorem generatedWord_get_05
    (h : (5 : Nat) < 13) :
    generatedWord.get ⟨5, h⟩ = PairId.d11m := by
...
@[simp] theorem generatedWord_getFin_06 :
    Vector.get generatedWord (6 : WordIndex) = PairId.d111 := by
  rfl

@[simp] theorem generatedWord_get_06
    (h : (6 : Nat) < 13) :
    generatedWord.get ⟨6, h⟩ = PairId.d111 := by
...
@[simp] theorem generatedWord_getFin_07 :
    Vector.get generatedWord (7 : WordIndex) = PairId.d1m1 := by
  rfl

@[simp] theorem generatedWord_get_07
    (h : (7 : Nat) < 13) :
    generatedWord.get ⟨7, h⟩ = PairId.d1m1 := by
...
@[simp] theorem generatedWord_getFin_08 :
    Vector.get generatedWord (8 : WordIndex) = PairId.d1m1 := by
  rfl

@[simp] theorem generatedWord_get_08
    (h : (8 : Nat) < 13) :
    generatedWord.get ⟨8, h⟩ = PairId.d1m1 := by
...
@[simp] theorem generatedWord_getFin_09 :
    Vector.get generatedWord (9 : WordIndex) = PairId.d111 := by
  rfl

@[simp] theorem generatedWord_get_09
    (h : (9 : Nat) < 13) :
    generatedWord.get ⟨9, h⟩ = PairId.d111 := by
...
@[simp] theorem generatedWord_getFin_10 :
    Vector.get generatedWord (10 : WordIndex) = PairId.dm11 := by
  rfl

@[simp] theorem generatedWord_get_10
    (h : (10 : Nat) < 13) :
    generatedWord.get ⟨10, h⟩ = PairId.dm11 := by
...
@[simp] theorem generatedWord_getFin_11 :
    Vector.get generatedWord (11 : WordIndex) = PairId.dm11 := by
  rfl

@[simp] theorem generatedWord_get_11
    (h : (11 : Nat) < 13) :
    generatedWord.get ⟨11, h⟩ = PairId.dm11 := by
...
@[simp] theorem generatedWord_getFin_12 :
    Vector.get generatedWord (12 : WordIndex) = PairId.d11m := by
  rfl

@[simp] theorem generatedWord_get_12
    (h : (12 : Nat) < 13) :
    generatedWord.get ⟨12, h⟩ = PairId.d11m := by
