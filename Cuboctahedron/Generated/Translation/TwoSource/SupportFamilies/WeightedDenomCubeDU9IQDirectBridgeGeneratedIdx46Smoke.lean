...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx46Smoke
...
private theorem poly903_2_12_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly903_2_12, reduced903_2_12, WalshQuadratic.coeffEval, SignBit.value, hy, hd11m, hdm11, hz, hd111, hd1m1]
        norm_num

private def reducedBound903_2_12 :
    WalshQuadraticReducedAbsBound cube0xx1x1 poly903_2_12 where
...
private def cubeBound903_2_12 :
    WalshQuadraticCubeBound cube0xx1x1 poly903_2_12 :=
...
def reducedObstruction903_2_12
    ...
    WeightedWalshQuadraticNonposObstruction rank903 cube0xx1x1.Member where
  weights := weights2_12
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx46Smoke
