...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx11Smoke
...
def cube11xx00 : MaskSubcube where
  fixed
    | SignBit.y => some true
    | SignBit.z => some true
...
private theorem poly896_4_8_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube11xx00.Member mask) :
    poly896_4_8.coeffEval mask = reduced896_4_8.coeffEval mask := by
  have hy : maskBitForPair mask SignBit.y.toPairId = true := by
    simpa [cube11xx00, MaskSubcube.Member] using hmask SignBit.y
  have hz : maskBitForPair mask SignBit.z.toPairId = true := by
    simpa [cube11xx00, MaskSubcube.Member] using hmask SignBit.z
  have hd1m1 : maskBitForPair mask SignBit.d1m1.toPairId = false := by
    simpa [cube11xx00, MaskSubcube.Member] using hmask SignBit.d1m1
  have hdm11 : maskBitForPair mask SignBit.dm11.toPairId = false := by
    simpa [cube11xx00, MaskSubcube.Member] using hmask SignBit.dm11
  by_cases hd111 : maskBitForPair mask SignBit.d111.toPairId
  all_goals
    by_cases hd11m : maskBitForPair mask SignBit.d11m.toPairId
    all_goals
      simp [poly896_4_8, reduced896_4_8, WalshQuadratic.coeffEval, SignBit.value, hy, hz, hd1m1, hdm11, hd111, hd11m]
      norm_num

private def reducedBound896_4_8 :
    WalshQuadraticReducedAbsBound cube11xx00 poly896_4_8 where
...
private def cubeBound896_4_8 :
    WalshQuadraticCubeBound cube11xx00 poly896_4_8 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cube11xx00.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank896 < numPairWords)
    (_hmember : cube11xx00.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank896, hlt⟩ : Fin numPairWords) mask weights4_8 =
      poly896_4_8.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx11Smoke
