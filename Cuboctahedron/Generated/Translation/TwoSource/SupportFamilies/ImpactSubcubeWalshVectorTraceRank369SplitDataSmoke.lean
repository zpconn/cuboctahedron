...
/-!
Generated AP16DK split Walsh-vector trace data for rank `369`.
-/
...
def generatedRank : Fin numPairWords := ⟨369, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.d11m, PairId.d111, PairId.dm11, PairId.dm11], by decide⟩
...
@[simp] theorem generatedWord_getFin_10 :
    Vector.get generatedWord (10 : WordIndex) = PairId.d111 := by
  rfl

@[simp] theorem generatedWord_get_10
    (h : (10 : Nat) < 13) :
    generatedWord.get ⟨10, h⟩ = PairId.d111 := by
