...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx16Smoke
...
def poly897_2_8 : WalshQuadratic where
  c := 12
  y := 0
  z := 0
  d111 := 0
...
private def reduced897_2_8 : WalshQuadratic where
  c := -4
  y := 0
  z := 4
  d111 := 0
...
private theorem poly897_2_8_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube0xx1x1.Member mask) :
    poly897_2_8.coeffEval mask = reduced897_2_8.coeffEval mask := by
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly897_2_8, reduced897_2_8, WalshQuadratic.coeffEval, SignBit.value, hy, hd11m, hdm11, hz, hd111, hd1m1]
        norm_num

private def reducedBound897_2_8 :
    WalshQuadraticReducedAbsBound cube0xx1x1 poly897_2_8 where
  reduced := reduced897_2_8
  eq_on_cube := by
    intro mask hmask
    exact poly897_2_8_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced897_2_8, WalshQuadratic.absBoundSum]

private def cubeBound897_2_8 :
    WalshQuadraticCubeBound cube0xx1x1 poly897_2_8 :=
  WalshQuadraticCubeBound.leaf reducedBound897_2_8

private theorem poly897_2_8_nonpos
    {mask : SignMask} (hmask : cube0xx1x1.Member mask) :
    poly897_2_8.coeffEval mask <= 0 :=
  cubeBound897_2_8.coeffEval_nonpos hmask

def reducedObstruction897_2_8
    (direct_eq :
      forall {mask : SignMask} (hlt : rank897 < numPairWords),
        cube0xx1x1.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2_8 =
            poly897_2_8.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank897 cube0xx1x1.Member where
  weights := weights2_8
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly897_2_8_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    weightedDenomAtRank
      (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2_8 <= 0 :=
  (reducedObstruction897_2_8 direct_eq).nonpos hlt hmember
...
private theorem dot_sum_eval
    ...
    dot01.coeffEval mask + dot07.coeffEval mask =
      poly897_2_8.coeffEval mask := by
  simp [dot01, dot07, poly897_2_8,
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx16Smoke
