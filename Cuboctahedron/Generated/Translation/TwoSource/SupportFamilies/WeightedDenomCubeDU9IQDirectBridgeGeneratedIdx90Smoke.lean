...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx90Smoke
...
def cubexx1x00 : MaskSubcube where
  fixed
...
private theorem poly955_1_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly955_1, reduced955_1, WalshQuadratic.coeffEval, SignBit.value, hd111, hd1m1, hdm11, hy, hz, hd11m]
        norm_num

private def reducedBound955_1 :
    WalshQuadraticReducedAbsBound cubexx1x00 poly955_1 where
...
private def cubeBound955_1 :
    WalshQuadraticCubeBound cubexx1x00 poly955_1 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cubexx1x00.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank955 < numPairWords)
    (_hmember : cubexx1x00.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank955, hlt⟩ : Fin numPairWords) mask weights1 =
      poly955_1.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx90Smoke
