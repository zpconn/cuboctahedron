...
import Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke
...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx34Smoke
...
abbrev generatedNormal05 : WalshAffineVec3 :=
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke.generatedNormal05

def rank899 : Nat := 899

def cube1xx00x : MaskSubcube where
  fixed
    | SignBit.y => some true
...
def weights1_6 : InternalImpactWeights where
  w1 := 1
  w2 := 0
  w3 := 0
  w4 := 0
...
private theorem weights1_6_nonnegative :
    weights1_6.Nonnegative := by
  norm_num [weights1_6, InternalImpactWeights.Nonnegative]

private theorem weights1_6_positive :
    weights1_6.PositiveSome := by
  norm_num [weights1_6, InternalImpactWeights.PositiveSome]

def poly899_1_6 : WalshQuadratic where
  c := 12
  y := 0
  z := 0
  d111 := 8/3
...
private def reduced899_1_6 : WalshQuadratic where
  c := -4
  y := 0
  z := 4
  d111 := 0
...
private theorem poly899_1_6_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube1xx00x.Member mask) :
    poly899_1_6.coeffEval mask = reduced899_1_6.coeffEval mask := by
  have hy : maskBitForPair mask SignBit.y.toPairId = true := by
    simpa [cube1xx00x, MaskSubcube.Member] using hmask SignBit.y
  have hd11m : maskBitForPair mask SignBit.d11m.toPairId = false := by
    simpa [cube1xx00x, MaskSubcube.Member] using hmask SignBit.d11m
  have hd1m1 : maskBitForPair mask SignBit.d1m1.toPairId = false := by
    simpa [cube1xx00x, MaskSubcube.Member] using hmask SignBit.d1m1
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly899_1_6, reduced899_1_6, WalshQuadratic.coeffEval, SignBit.value, hy, hd11m, hd1m1, hz, hd111, hdm11]
        norm_num

private def reducedBound899_1_6 :
    WalshQuadraticReducedAbsBound cube1xx00x poly899_1_6 where
  reduced := reduced899_1_6
  eq_on_cube := by
    intro mask hmask
    exact poly899_1_6_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced899_1_6, WalshQuadratic.absBoundSum]

private def cubeBound899_1_6 :
    WalshQuadraticCubeBound cube1xx00x poly899_1_6 :=
  WalshQuadraticCubeBound.leaf reducedBound899_1_6

private theorem poly899_1_6_nonpos
    {mask : SignMask} (hmask : cube1xx00x.Member mask) :
    poly899_1_6.coeffEval mask <= 0 :=
  cubeBound899_1_6.coeffEval_nonpos hmask

def reducedObstruction899_1_6
    (direct_eq :
      forall {mask : SignMask} (hlt : rank899 < numPairWords),
        cube1xx00x.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank899, hlt⟩ : Fin numPairWords) mask weights1_6 =
            poly899_1_6.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank899 cube1xx00x.Member where
  weights := weights1_6
  nonnegative := weights1_6_nonnegative
  positive_some := weights1_6_positive
  poly := poly899_1_6
  direct_eq := by
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly899_1_6_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cube1xx00x.Member mask) :
    weightedDenomAtRank
      (⟨rank899, hlt⟩ : Fin numPairWords) mask weights1_6 <= 0 :=
  (reducedObstruction899_1_6 direct_eq).nonpos hlt hmember
...
private theorem dot05_eq :
  ...
  norm_num [dot05, generatedNormal05, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke.generatedNormal05, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke.generatedNormal05_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke.generatedNormal05_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke.generatedNormal05_z, generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank899ChainSmoke.generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank899ChainSmoke.generatedVector_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank899ChainSmoke.generatedVector_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank899ChainSmoke.generatedVector_z, WalshAffineVec3.dot, WalshQuadratic.add, WalshAffine.mul]
...
private theorem direct05_eq
    (mask : SignMask) (hlt : rank899 < numPairWords) :
    directWalshDotAtRank
        (⟨rank899, hlt⟩ : Fin numPairWords) mask (5 : WordIndex) =
      dot (generatedNormal05.eval mask) (generatedVector.eval mask) := by
  rw [generatedRank_eq hlt]
  unfold directWalshDotAtRank
  rw [Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank899ChainSmoke.generatedUnrank_builds]
  rw [← Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank899Idx05Smoke.generatedNormal05_eq]
  rw [← Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank899ChainSmoke.generatedVector_eq_translationVectorWalsh]
...
private theorem direct05_eq_of_val
    ...
    directWalshDotAtRank
      ...
      dot (generatedNormal05.eval mask) (generatedVector.eval mask) := by
  rw [directWalshDotAtRank_eq_of_val
    (⟨rank899, hlt⟩ : Fin numPairWords) mask (j := (5 : WordIndex)) hi]
  exact direct05_eq mask hlt

private theorem dot_sum_eval
    (mask : SignMask) :
    dot00.coeffEval mask + dot05.coeffEval mask =
      poly899_1_6.coeffEval mask := by
  simp [dot00, dot05, poly899_1_6,
    WalshQuadratic.coeffEval]
  try ring_nf

theorem direct_eq
    {mask : SignMask} (hlt : rank899 < numPairWords)
    (_hmember : cube1xx00x.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank899, hlt⟩ : Fin numPairWords) mask weights1_6 =
      poly899_1_6.coeffEval mask := by
  unfold weightedDirectWalshDotAtRank
  norm_num [weights1_6]
  rw [direct00_eq_of_val (mask := mask) (hlt := hlt) (hi := rfl), direct05_eq_of_val (mask := mask) (hlt := hlt) (hi := rfl), dot00_eval mask, dot05_eval mask]
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx34Smoke
