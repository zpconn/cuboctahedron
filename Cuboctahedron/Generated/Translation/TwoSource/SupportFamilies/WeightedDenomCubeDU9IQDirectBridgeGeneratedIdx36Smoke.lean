...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx36Smoke
...
def cubexx0x01 : MaskSubcube where
  fixed
...
private theorem poly899_1_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly899_1, reduced899_1, WalshQuadratic.coeffEval, SignBit.value, hd111, hd1m1, hdm11, hy, hz, hd11m]
        norm_num

private def reducedBound899_1 :
    WalshQuadraticReducedAbsBound cubexx0x01 poly899_1 where
...
private def cubeBound899_1 :
    WalshQuadraticCubeBound cubexx0x01 poly899_1 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cubexx0x01.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank899 < numPairWords)
    (_hmember : cubexx0x01.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank899, hlt⟩ : Fin numPairWords) mask weights1 =
      poly899_1.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx36Smoke
