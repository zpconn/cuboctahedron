...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx18Smoke
...
private theorem poly897_4_6_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly897_4_6, reduced897_4_6, WalshQuadratic.coeffEval, SignBit.value, hz, hd111, hd11m, hy, hd1m1, hdm11]
        norm_num

private def reducedBound897_4_6 :
    WalshQuadraticReducedAbsBound cubex010xx poly897_4_6 where
...
private def cubeBound897_4_6 :
    WalshQuadraticCubeBound cubex010xx poly897_4_6 :=
...
def reducedObstruction897_4_6
    ...
    WeightedWalshQuadraticNonposObstruction rank897 cubex010xx.Member where
  weights := weights4_6
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx18Smoke
