...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx08Smoke
...
def poly896_2_8 : WalshQuadratic where
  c := 12
  y := 0
  z := 0
  d111 := 0
...
private def reduced896_2_8 : WalshQuadratic where
  c := -4
  y := 0
  z := 4
  d111 := 0
...
private theorem poly896_2_8_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube0xx1x1.Member mask) :
    poly896_2_8.coeffEval mask = reduced896_2_8.coeffEval mask := by
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly896_2_8, reduced896_2_8, WalshQuadratic.coeffEval, SignBit.value, hy, hd11m, hdm11, hz, hd111, hd1m1]
        norm_num

private def reducedBound896_2_8 :
    WalshQuadraticReducedAbsBound cube0xx1x1 poly896_2_8 where
  reduced := reduced896_2_8
  eq_on_cube := by
    intro mask hmask
    exact poly896_2_8_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced896_2_8, WalshQuadratic.absBoundSum]

private def cubeBound896_2_8 :
    WalshQuadraticCubeBound cube0xx1x1 poly896_2_8 :=
  WalshQuadraticCubeBound.leaf reducedBound896_2_8

private theorem poly896_2_8_nonpos
    {mask : SignMask} (hmask : cube0xx1x1.Member mask) :
    poly896_2_8.coeffEval mask <= 0 :=
  cubeBound896_2_8.coeffEval_nonpos hmask

def reducedObstruction896_2_8
    (direct_eq :
      forall {mask : SignMask} (hlt : rank896 < numPairWords),
        cube0xx1x1.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank896, hlt⟩ : Fin numPairWords) mask weights2_8 =
            poly896_2_8.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank896 cube0xx1x1.Member where
  weights := weights2_8
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly896_2_8_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    weightedDenomAtRank
      (⟨rank896, hlt⟩ : Fin numPairWords) mask weights2_8 <= 0 :=
  (reducedObstruction896_2_8 direct_eq).nonpos hlt hmember
...
private theorem dot_sum_eval
    ...
    dot01.coeffEval mask + dot07.coeffEval mask =
      poly896_2_8.coeffEval mask := by
  simp [dot01, dot07, poly896_2_8,
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx08Smoke
