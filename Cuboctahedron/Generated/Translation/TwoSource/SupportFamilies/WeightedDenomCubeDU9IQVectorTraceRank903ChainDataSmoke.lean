...
/-!
Generated AP16DK split Walsh-vector trace data for rank `903`.
-/
...
def generatedRank : Fin numPairWords := ⟨903, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.d1m1, PairId.d111, PairId.d111, PairId.d1m1, PairId.d11m, PairId.dm11, PairId.dm11], by decide⟩
