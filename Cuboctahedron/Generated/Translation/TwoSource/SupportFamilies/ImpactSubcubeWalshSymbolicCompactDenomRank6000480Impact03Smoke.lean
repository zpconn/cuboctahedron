...
import Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank6000480SplitSmoke

/-!
Generated AP16CQ compact-denominator consumer for rank `6000480`.
...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshSymbolicCompactDenomRank6000480Impact03Smoke
...
abbrev generatedRank : Fin numPairWords :=
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank6000480SplitSmoke.generatedRank

abbrev generatedWord : PairWord :=
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank6000480SplitSmoke.generatedWord
...
def generatedMask14 : SignMask := ⟨14, by decide⟩
...
def selectedWordImpactIndex : WordIndex := ⟨3, by decide⟩
...
private theorem generatedVector_eq_translationVector (mask : SignMask) :
  ...
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank6000480SplitSmoke.generatedVector_eval_eq_translationVector
    mask
...
theorem generatedDenomDotCompact (mask : SignMask) :
  ...
  exact impactDenomAtRank_wordImpact_eq_walshDot
    Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank6000480SplitSmoke.generatedUnrank_builds
    (generatedNormal_eval_eq_compact mask)
    (generatedVector_eq_translationVector mask)

theorem generatedDenomDotCompact_mask14 :
    impactDenomAtRank generatedRank generatedMask14
        (wordImpact firstWordImpactIndex) =
      Cuboctahedron.dot (generatedNormal.eval generatedMask14)
        (generatedVector.eval generatedMask14) :=
  generatedDenomDotCompact generatedMask14
...
theorem generatedDotPositive_mask14_of_goodDirection
    (hgood : GoodDirectionAtRank generatedRank generatedMask14) :
    0 < Cuboctahedron.dot (generatedNormal.eval generatedMask14)
      (generatedVector.eval generatedMask14) :=
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshSymbolicCompactDenomRank6000480Impact03Smoke
