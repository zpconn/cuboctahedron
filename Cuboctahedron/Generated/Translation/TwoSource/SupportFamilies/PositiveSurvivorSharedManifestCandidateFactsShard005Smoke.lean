...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard005Smoke
...
/-- AP.16W shared candidate fact: rank `100800`, mask `4`. -/
private def case_000000_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000000_mask : SignMask := ⟨4, by decide⟩
private def case_000000_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000000_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000000_b : Vec3 Rat := { x := (-140/27), y := (-380/27), z := (-140/27) }
private def case_000000_firstLine : StrictLin2 := { a := -1, b := -1, c := (-45/7) }
...
private theorem case_000000_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c007).support case_000000_rank.val case_000000_mask
...
theorem case_000000_candidateFacts :
    CandidateFacts .c007 100800 ⟨4, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `11`. -/
private def case_000001_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000001_mask : SignMask := ⟨11, by decide⟩
private def case_000001_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000001_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000001_b : Vec3 Rat := { x := (-172/27), y := (284/27), z := (-244/27) }
private def case_000001_firstLine : StrictLin2 := { a := (-86/33), b := (-86/33), c := (-112/33) }
...
private theorem case_000001_sourcePredicate :
    (generatedSpec .c003).Predicate case_000001_rank.val case_000001_mask := by
  intro hlt
  have hrank : (⟨case_000001_rank.val, hlt⟩ : Fin numPairWords) = case_000001_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c003).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c003).support case_000001_rank.val hlt case_000001_mask := by
...
private theorem case_000001_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c003).support case_000001_rank.val case_000001_mask
  rw [show (generatedKey .c003).support = case_000001_support by rfl]
  intro hlt
...
theorem case_000001_candidateFacts :
    CandidateFacts .c003 100800 ⟨11, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `14`. -/
private def case_000002_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000002_mask : SignMask := ⟨14, by decide⟩
private def case_000002_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000002_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000002_b : Vec3 Rat := { x := (-380/27), y := (-44/27), z := (-164/27) }
private def case_000002_firstLine : StrictLin2 := { a := (95/147), b := (95/147), c := (-89/49) }
...
private theorem case_000002_shape :
    EqEqNegVarFirst case_000002_support case_000002_rank.val case_000002_mask := by
  intro hlt
  ...
  have case_000002_rowFirst :
      EqEqNegRow (FirstLineAt case_000002_support case_000002_rank.val hlt case_000002_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000002_firstLine, EqEqNegRow]
...
private theorem case_000002_checkedAtRank :
  ...
  eqEqNegVarFirst_checkedOn case_000002_support case_000002_rank.val case_000002_rank.isLt
...
private theorem case_000002_rowsForKey :
  ...
  change EqEqNegVarFirstRows (generatedKey .c000).support case_000002_rank.val case_000002_mask
...
theorem case_000002_candidateFacts :
    CandidateFacts .c000 100800 ⟨14, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `15`. -/
private def case_000003_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000003_mask : SignMask := ⟨15, by decide⟩
private def case_000003_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000003_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000003_b : Vec3 Rat := { x := (-380/27), y := (172/27), z := (-164/27) }
private def case_000003_firstLine : StrictLin2 := { a := (-190/93), b := (-190/93), c := (-368/93) }
...
private theorem case_000003_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c003).support case_000003_rank.val case_000003_mask
...
theorem case_000003_candidateFacts :
    CandidateFacts .c003 100800 ⟨15, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `20`. -/
private def case_000004_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000004_mask : SignMask := ⟨20, by decide⟩
private def case_000004_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000004_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmpp
private def case_000004_b : Vec3 Rat := { x := (-188/27), y := (-428/27), z := (100/27) }
private def case_000004_firstLine : StrictLin2 := { a := -1, b := -1, c := (-117/47) }
...
private theorem case_000004_sourcePredicate :
    (generatedSpec .c007).Predicate case_000004_rank.val case_000004_mask := by
  intro hlt
  have hrank : (⟨case_000004_rank.val, hlt⟩ : Fin numPairWords) = case_000004_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c007).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c007).support case_000004_rank.val hlt case_000004_mask := by
...
private theorem case_000004_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c007).support case_000004_rank.val case_000004_mask
  rw [show (generatedKey .c007).support = case_000004_support by rfl]
  intro hlt
...
theorem case_000004_candidateFacts :
    CandidateFacts .c007 100800 ⟨20, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `22`. -/
private def case_000005_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000005_mask : SignMask := ⟨22, by decide⟩
private def case_000005_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000005_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmpp
private def case_000005_b : Vec3 Rat := { x := (-380/27), y := (-332/27), z := (124/27) }
private def case_000005_firstLine : StrictLin2 := { a := -1, b := 1, c := (-7/5) }
...
private theorem case_000005_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c006).support case_000005_rank.val case_000005_mask
...
theorem case_000005_candidateFacts :
    CandidateFacts .c006 100800 ⟨22, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `31`. -/
private def case_000006_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000006_mask : SignMask := ⟨31, by decide⟩
private def case_000006_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000006_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmpp
private def case_000006_b : Vec3 Rat := { x := (-428/27), y := (124/27), z := (76/27) }
private def case_000006_firstLine : StrictLin2 := { a := (-107/57), b := (-107/57), c := (-69/19) }
...
private theorem case_000006_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c005).support case_000006_rank.val case_000006_mask
...
theorem case_000006_candidateFacts :
    CandidateFacts .c005 100800 ⟨31, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `43`. -/
private def case_000007_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000007_mask : SignMask := ⟨43, by decide⟩
private def case_000007_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000007_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000007_b : Vec3 Rat := { x := (-28/27), y := (428/27), z := (-100/27) }
private def case_000007_firstLine : StrictLin2 := { a := 1, b := -1, c := (-257/7) }
...
theorem case_000007_candidateFacts :
    CandidateFacts .c002 100800 ⟨43, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `47`. -/
private def case_000008_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000008_mask : SignMask := ⟨47, by decide⟩
private def case_000008_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000008_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000008_b : Vec3 Rat := { x := (-236/27), y := (316/27), z := (-20/27) }
private def case_000008_firstLine : StrictLin2 := { a := (-59/15), b := (-59/15), c := (-39/5) }
...
private theorem case_000008_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c001).support case_000008_rank.val case_000008_mask
...
theorem case_000008_candidateFacts :
    CandidateFacts .c001 100800 ⟨47, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `59`. -/
private def case_000009_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000009_mask : SignMask := ⟨59, by decide⟩
private def case_000009_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000009_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tpmm
private def case_000009_b : Vec3 Rat := { x := (-76/27), y := (380/27), z := (140/27) }
private def case_000009_firstLine : StrictLin2 := { a := 1, b := -1, c := (-101/19) }
...
private theorem case_000009_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c002).support case_000009_rank.val case_000009_mask
...
theorem case_000009_candidateFacts :
    CandidateFacts .c002 100800 ⟨59, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `100800`, mask `63`. -/
private def case_000010_rank : Fin numPairWords := ⟨100800, by decide⟩
private def case_000010_mask : SignMask := ⟨63, by decide⟩
private def case_000010_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11], by decide⟩
...
private def case_000010_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tpmm
private def case_000010_b : Vec3 Rat := { x := (-284/27), y := (268/27), z := (220/27) }
private def case_000010_firstLine : StrictLin2 := { a := 1, b := 1, c := (-173/71) }
...
private theorem case_000010_sourcePredicate :
    (generatedSpec .c004).Predicate case_000010_rank.val case_000010_mask := by
  intro hlt
  have hrank : (⟨case_000010_rank.val, hlt⟩ : Fin numPairWords) = case_000010_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c004).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c004).support case_000010_rank.val hlt case_000010_mask := by
...
private theorem case_000010_rowsForKey :
  ...
  change EqEqNegVarFirstRows (generatedKey .c004).support case_000010_rank.val case_000010_mask
  rw [show (generatedKey .c004).support = case_000010_support by rfl]
  intro hlt
...
theorem case_000010_candidateFacts :
    CandidateFacts .c004 100800 ⟨63, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard005Smoke
