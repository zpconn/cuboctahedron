import Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.RowPropertySemanticRangeSmoke
...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.RowPropertySemanticRange2_4Smoke
  ...
  complete := by
    ...
    · subst rank
      ...
      | shard000 h =>
          cases h
      | shard001 h =>
          exact semanticFacts_of_shard001_case h
      | shard002 h =>
          cases h
    · subst rank
      have hcase :=
      ...
      | shard001 h =>
          exact semanticFacts_of_shard001_case h
      | shard002 h =>
          exact semanticFacts_of_shard002_case h
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.RowPropertySemanticRange2_4Smoke
