...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx51Smoke
...
def cubexx100x : MaskSubcube where
  fixed
...
private theorem poly903_1_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly903_1, reduced903_1, WalshQuadratic.coeffEval, SignBit.value, hd111, hd11m, hd1m1, hy, hz, hdm11]
        norm_num

private def reducedBound903_1 :
    WalshQuadraticReducedAbsBound cubexx100x poly903_1 where
...
private def cubeBound903_1 :
    WalshQuadraticCubeBound cubexx100x poly903_1 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cubexx100x.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank903 < numPairWords)
    (_hmember : cubexx100x.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank903, hlt⟩ : Fin numPairWords) mask weights1 =
      poly903_1.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx51Smoke
