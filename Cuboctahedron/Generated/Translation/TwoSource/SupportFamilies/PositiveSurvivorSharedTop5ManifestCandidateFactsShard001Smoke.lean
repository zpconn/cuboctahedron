...
/-!
Generated 6Z.6K.8AP.16AN shared candidate facts smoke.

This module exports reusable source/row candidate facts for a small
multi-signature AP.16 smoke. It is diagnostic only.
-/

namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedTop5ManifestCandidateFactsShard001Smoke
...
private def case_000000_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000000_mask : SignMask := ⟨8, by decide⟩
private def case_000000_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000000_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.yp
  | ⟨13, _⟩ => Face.zp
private def case_000000_b : Vec3 Rat := { x := (-4/9), y := (-4/9), z := (-100/9) }
private def case_000000_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000000_secondLine : StrictLin2 := { a := (-1/42), b := (-1/42), c := (-10/63) }
...
private theorem case_000000_sourcePredicate :
    (generatedSpec .c007).Predicate case_000000_rank.val case_000000_mask := by
  intro hlt
  have hrank : (⟨case_000000_rank.val, hlt⟩ : Fin numPairWords) = case_000000_rank := by
    ext
    rfl
  ...
  have hsourceChecks :
      SourceChecks (generatedSpec .c007).support case_000000_rank.val hlt case_000000_mask := by
...
private theorem case_000000_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c007).support case_000000_rank.val case_000000_mask
  rw [show (generatedKey .c007).support = case_000000_support by rfl]
  intro hlt
...
theorem case_000000_candidateFacts :
    CandidateFacts .c007 6000625 ⟨8, by decide⟩ := by
...
private def case_000001_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000001_mask : SignMask := ⟨9, by decide⟩
private def case_000001_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000001_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zp
private def case_000001_b : Vec3 Rat := { x := (-4/9), y := (68/9), z := (-100/9) }
private def case_000001_firstLine : StrictLin2 := { a := -1, b := -1, c := -15 }
...
private theorem case_000001_sourcePredicate :
    (generatedSpec .c006).Predicate case_000001_rank.val case_000001_mask := by
  intro hlt
  have hrank : (⟨case_000001_rank.val, hlt⟩ : Fin numPairWords) = case_000001_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c006).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c006).support case_000001_rank.val hlt case_000001_mask := by
...
private theorem case_000001_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c006).support case_000001_rank.val case_000001_mask
  rw [show (generatedKey .c006).support = case_000001_support by rfl]
  intro hlt
...
theorem case_000001_candidateFacts :
    CandidateFacts .c006 6000625 ⟨9, by decide⟩ := by
...
private def case_000002_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000002_mask : SignMask := ⟨13, by decide⟩
private def case_000002_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private theorem case_000002_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c008).support case_000002_rank.val case_000002_mask
...
theorem case_000002_candidateFacts :
    CandidateFacts .c008 6000625 ⟨13, by decide⟩ := by
...
private def case_000003_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000003_mask : SignMask := ⟨20, by decide⟩
private def case_000003_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000003_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.yp
  | ⟨13, _⟩ => Face.zp
private def case_000003_b : Vec3 Rat := { x := (-116/9), y := (-116/9), z := (-20/9) }
private def case_000003_firstLine : StrictLin2 := { a := -1, b := -1, c := (-39/29) }
...
private theorem case_000003_sourcePredicate :
    (generatedSpec .c006).Predicate case_000003_rank.val case_000003_mask := by
  intro hlt
  have hrank : (⟨case_000003_rank.val, hlt⟩ : Fin numPairWords) = case_000003_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c006).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c006).support case_000003_rank.val hlt case_000003_mask := by
...
private theorem case_000003_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c006).support case_000003_rank.val case_000003_mask
  rw [show (generatedKey .c006).support = case_000003_support by rfl]
  intro hlt
...
theorem case_000003_candidateFacts :
    CandidateFacts .c006 6000625 ⟨20, by decide⟩ := by
...
private def case_000004_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000004_mask : SignMask := ⟨22, by decide⟩
private def case_000004_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000004_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.yp
  | ⟨13, _⟩ => Face.zm
private def case_000004_b : Vec3 Rat := { x := (-116/9), y := (-116/9), z := (52/9) }
private def case_000004_firstLine : StrictLin2 := { a := (-58/45), b := (-58/45), c := (-196/135) }
...
private theorem case_000004_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c003).support case_000004_rank.val case_000004_mask
...
theorem case_000004_candidateFacts :
    CandidateFacts .c003 6000625 ⟨22, by decide⟩ := by
...
private def case_000005_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000005_mask : SignMask := ⟨29, by decide⟩
private def case_000005_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000005_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zp
private def case_000005_b : Vec3 Rat := { x := (-44/3), y := 4, z := -4 }
...
theorem case_000005_candidateFacts :
    CandidateFacts .c008 6000625 ⟨29, by decide⟩ := by
...
private def case_000006_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000006_mask : SignMask := ⟨31, by decide⟩
private def case_000006_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000006_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zm
private def case_000006_b : Vec3 Rat := { x := (-44/3), y := 4, z := 4 }
...
private theorem case_000006_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c000).support case_000006_rank.val case_000006_mask
...
theorem case_000006_candidateFacts :
    CandidateFacts .c000 6000625 ⟨31, by decide⟩ := by
...
private def case_000007_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000007_mask : SignMask := ⟨45, by decide⟩
private def case_000007_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000007_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zp
private def case_000007_b : Vec3 Rat := { x := -4, y := (44/3), z := -4 }
private def case_000007_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000007_secondLine : StrictLin2 := { a := (-27/230), b := (-27/230), c := (-3/23) }
...
private theorem case_000007_shape :
    EqEqPosVarSecond case_000007_support case_000007_rank.val case_000007_mask := by
  intro hlt
  ...
  have case_000007_fixedFirst :
      FixedRow (FirstLineAt case_000007_support case_000007_rank.val hlt case_000007_mask)
        (1) (1) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000007_firstLine, FixedRow]
  have case_000007_rowSecond :
      EqEqPosRow (SecondLineAt case_000007_support case_000007_rank.val hlt case_000007_mask) := by
    rw [SecondLineAt, hsecond]
    norm_num [case_000007_secondLine, EqEqPosRow]
  exact ⟨case_000007_sourceChecks, case_000007_fixedFirst, case_000007_rowSecond⟩
...
private theorem case_000007_checkedAtRank :
  ...
  eqEqPosVarSecond_checkedOn case_000007_support case_000007_rank.val case_000007_rank.isLt
...
private theorem case_000007_sourcePredicate :
    (generatedSpec .c007).Predicate case_000007_rank.val case_000007_mask := by
  intro hlt
  have hrank : (⟨case_000007_rank.val, hlt⟩ : Fin numPairWords) = case_000007_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c007).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c007).support case_000007_rank.val hlt case_000007_mask := by
...
private theorem case_000007_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c007).support case_000007_rank.val case_000007_mask
  rw [show (generatedKey .c007).support = case_000007_support by rfl]
  intro hlt
...
theorem case_000007_candidateFacts :
    CandidateFacts .c007 6000625 ⟨45, by decide⟩ := by
...
private def case_000008_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000008_mask : SignMask := ⟨47, by decide⟩
private def case_000008_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000008_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zm
private def case_000008_b : Vec3 Rat := { x := -4, y := (44/3), z := 4 }
private def case_000008_firstLine : StrictLin2 := { a := -1, b := 1, c := 1 }
private def case_000008_secondLine : StrictLin2 := { a := (3/20), b := (-3/20), c := (-13/20) }
...
private theorem case_000008_shape :
    OppMinusOneVarSecond case_000008_support case_000008_rank.val case_000008_mask := by
  intro hlt
  ...
  have case_000008_rowSecond :
      OppNegRow (SecondLineAt case_000008_support case_000008_rank.val hlt case_000008_mask) := by
    rw [SecondLineAt, hsecond]
    norm_num [case_000008_secondLine, OppNegRow]
...
private theorem case_000008_checkedAtRank :
  ...
  oppMinusOneVarSecond_checkedOn case_000008_support case_000008_rank.val case_000008_rank.isLt
...
private theorem case_000008_rowsForKey :
  ...
  change OppMinusOneVarSecondRows (generatedKey .c001).support case_000008_rank.val case_000008_mask
...
theorem case_000008_candidateFacts :
    CandidateFacts .c001 6000625 ⟨47, by decide⟩ := by
...
private def case_000009_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000009_mask : SignMask := ⟨55, by decide⟩
private def case_000009_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000009_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zm
private def case_000009_b : Vec3 Rat := { x := (-68/9), y := (4/9), z := (100/9) }
private def case_000009_firstLine : StrictLin2 := { a := -1, b := 1, c := (-31/17) }
...
private theorem case_000009_shape :
    OppOneMinusVarFirst case_000009_support case_000009_rank.val case_000009_mask := by
  intro hlt
  ...
  have case_000009_rowFirst :
      OppPosRow (FirstLineAt case_000009_support case_000009_rank.val hlt case_000009_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000009_firstLine, OppPosRow]
...
private theorem case_000009_checkedAtRank :
  ...
  oppOneMinusVarFirst_checkedOn case_000009_support case_000009_rank.val case_000009_rank.isLt
...
private theorem case_000009_sourcePredicate :
    (generatedSpec .c005).Predicate case_000009_rank.val case_000009_mask := by
  intro hlt
  have hrank : (⟨case_000009_rank.val, hlt⟩ : Fin numPairWords) = case_000009_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c005).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c005).support case_000009_rank.val hlt case_000009_mask := by
...
private theorem case_000009_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c005).support case_000009_rank.val case_000009_mask
  rw [show (generatedKey .c005).support = case_000009_support by rfl]
  intro hlt
...
theorem case_000009_candidateFacts :
    CandidateFacts .c005 6000625 ⟨55, by decide⟩ := by
...
private def case_000010_rank : Fin numPairWords := ⟨6000625, by decide⟩
private def case_000010_mask : SignMask := ⟨63, by decide⟩
private def case_000010_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.y, PairId.z, PairId.y, PairId.z], by decide⟩
...
private def case_000010_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.ym
  | ⟨13, _⟩ => Face.zm
private def case_000010_b : Vec3 Rat := { x := (-28/3), y := (28/3), z := (28/3) }
...
private theorem case_000010_shape :
    OppMinusOneVarFirst case_000010_support case_000010_rank.val case_000010_mask := by
  intro hlt
  ...
  have case_000010_rowFirst :
      OppNegRow (FirstLineAt case_000010_support case_000010_rank.val hlt case_000010_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000010_firstLine, OppNegRow]
...
private theorem case_000010_checkedAtRank :
  ...
  oppMinusOneVarFirst_checkedOn case_000010_support case_000010_rank.val case_000010_rank.isLt
...
private theorem case_000010_sourcePredicate :
    (generatedSpec .c000).Predicate case_000010_rank.val case_000010_mask := by
  intro hlt
  have hrank : (⟨case_000010_rank.val, hlt⟩ : Fin numPairWords) = case_000010_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c000).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c000).support case_000010_rank.val hlt case_000010_mask := by
...
private theorem case_000010_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c000).support case_000010_rank.val case_000010_mask
  rw [show (generatedKey .c000).support = case_000010_support by rfl]
  intro hlt
...
theorem case_000010_candidateFacts :
    CandidateFacts .c000 6000625 ⟨63, by decide⟩ := by
...
private def case_000011_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000011_mask : SignMask := ⟨14, by decide⟩
private def case_000011_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000011_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000011_b : Vec3 Rat := { x := (-100/9), y := (92/9), z := (-28/9) }
private def case_000011_firstLine : StrictLin2 := { a := (-25/9), b := (-25/9), c := (-19/3) }
...
private theorem case_000011_sourcePredicate :
    (generatedSpec .c004).Predicate case_000011_rank.val case_000011_mask := by
  intro hlt
  have hrank : (⟨case_000011_rank.val, hlt⟩ : Fin numPairWords) = case_000011_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c004).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c004).support case_000011_rank.val hlt case_000011_mask := by
...
private theorem case_000011_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000011_rank.val case_000011_mask
  rw [show (generatedKey .c004).support = case_000011_support by rfl]
  intro hlt
...
theorem case_000011_candidateFacts :
    CandidateFacts .c004 6000480 ⟨14, by decide⟩ := by
...
private def case_000012_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000012_mask : SignMask := ⟨17, by decide⟩
private def case_000012_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000012_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tppm
  | ⟨13, _⟩ => Face.tmpp
private def case_000012_b : Vec3 Rat := { x := (-20/9), y := (-140/9), z := (-20/9) }
private def case_000012_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000012_secondLine : StrictLin2 := { a := (-1/10), b := (-1/10), c := (-13/3) }
...
private theorem case_000012_sourcePredicate :
    (generatedSpec .c007).Predicate case_000012_rank.val case_000012_mask := by
  intro hlt
  have hrank : (⟨case_000012_rank.val, hlt⟩ : Fin numPairWords) = case_000012_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c007).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c007).support case_000012_rank.val hlt case_000012_mask := by
...
private theorem case_000012_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c007).support case_000012_rank.val case_000012_mask
  rw [show (generatedKey .c007).support = case_000012_support by rfl]
  intro hlt
...
theorem case_000012_candidateFacts :
    CandidateFacts .c007 6000480 ⟨17, by decide⟩ := by
...
private def case_000013_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000013_mask : SignMask := ⟨23, by decide⟩
private def case_000013_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000013_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tppm
  | ⟨13, _⟩ => Face.tmpp
private def case_000013_b : Vec3 Rat := { x := (-164/9), y := (-92/9), z := (4/9) }
private def case_000013_firstLine : StrictLin2 := { a := (-82/63), b := (-82/63), c := (-256/189) }
...
private theorem case_000013_sourcePredicate :
    (generatedSpec .c003).Predicate case_000013_rank.val case_000013_mask := by
  intro hlt
  have hrank : (⟨case_000013_rank.val, hlt⟩ : Fin numPairWords) = case_000013_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c003).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c003).support case_000013_rank.val hlt case_000013_mask := by
...
private theorem case_000013_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c003).support case_000013_rank.val case_000013_mask
  rw [show (generatedKey .c003).support = case_000013_support by rfl]
  intro hlt
...
theorem case_000013_candidateFacts :
    CandidateFacts .c003 6000480 ⟨23, by decide⟩ := by
...
private def case_000014_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000014_mask : SignMask := ⟨31, by decide⟩
private def case_000014_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000014_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000014_b : Vec3 Rat := { x := -20, y := (-4/3), z := (-4/3) }
...
private theorem case_000014_shape :
    OppMinusOneVarFirst case_000014_support case_000014_rank.val case_000014_mask := by
  intro hlt
  ...
  have case_000014_rowFirst :
      OppNegRow (FirstLineAt case_000014_support case_000014_rank.val hlt case_000014_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000014_firstLine, OppNegRow]
...
private theorem case_000014_checkedAtRank :
  ...
  oppMinusOneVarFirst_checkedOn case_000014_support case_000014_rank.val case_000014_rank.isLt
...
private theorem case_000014_sourcePredicate :
    (generatedSpec .c000).Predicate case_000014_rank.val case_000014_mask := by
  intro hlt
  have hrank : (⟨case_000014_rank.val, hlt⟩ : Fin numPairWords) = case_000014_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c000).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c000).support case_000014_rank.val hlt case_000014_mask := by
...
private theorem case_000014_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c000).support case_000014_rank.val case_000014_mask
  rw [show (generatedKey .c000).support = case_000014_support by rfl]
  intro hlt
...
theorem case_000014_candidateFacts :
    CandidateFacts .c000 6000480 ⟨31, by decide⟩ := by
...
private def case_000015_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000015_mask : SignMask := ⟨46, by decide⟩
private def case_000015_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000015_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000015_b : Vec3 Rat := { x := (-52/9), y := (140/9), z := (20/9) }
private def case_000015_firstLine : StrictLin2 := { a := (-13/17), b := (13/17), c := (-49/51) }
...
private theorem case_000015_shape :
    OppOneMinusVarFirst case_000015_support case_000015_rank.val case_000015_mask := by
  intro hlt
  ...
  have case_000015_rowFirst :
      OppPosRow (FirstLineAt case_000015_support case_000015_rank.val hlt case_000015_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000015_firstLine, OppPosRow]
...
private theorem case_000015_checkedAtRank :
  ...
  oppOneMinusVarFirst_checkedOn case_000015_support case_000015_rank.val case_000015_rank.isLt
...
private theorem case_000015_sourcePredicate :
    (generatedSpec .c002).Predicate case_000015_rank.val case_000015_mask := by
  intro hlt
  have hrank : (⟨case_000015_rank.val, hlt⟩ : Fin numPairWords) = case_000015_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c002).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c002).support case_000015_rank.val hlt case_000015_mask := by
...
private theorem case_000015_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c002).support case_000015_rank.val case_000015_mask
  rw [show (generatedKey .c002).support = case_000015_support by rfl]
  intro hlt
...
theorem case_000015_candidateFacts :
    CandidateFacts .c002 6000480 ⟨46, by decide⟩ := by
...
private def case_000016_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000016_mask : SignMask := ⟨62, by decide⟩
private def case_000016_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000016_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000016_b : Vec3 Rat := { x := (-100/9), y := (92/9), z := (68/9) }
private def case_000016_firstLine : StrictLin2 := { a := (25/19), b := (-25/19), c := (-49/19) }
...
private theorem case_000016_shape :
    OppMinusOneVarFirst case_000016_support case_000016_rank.val case_000016_mask := by
  intro hlt
  ...
  have case_000016_rowFirst :
      OppNegRow (FirstLineAt case_000016_support case_000016_rank.val hlt case_000016_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000016_firstLine, OppNegRow]
...
private theorem case_000016_checkedAtRank :
  ...
  oppMinusOneVarFirst_checkedOn case_000016_support case_000016_rank.val case_000016_rank.isLt
...
private theorem case_000016_sourcePredicate :
    (generatedSpec .c000).Predicate case_000016_rank.val case_000016_mask := by
  intro hlt
  have hrank : (⟨case_000016_rank.val, hlt⟩ : Fin numPairWords) = case_000016_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c000).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c000).support case_000016_rank.val hlt case_000016_mask := by
...
private theorem case_000016_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c000).support case_000016_rank.val case_000016_mask
  rw [show (generatedKey .c000).support = case_000016_support by rfl]
  intro hlt
...
theorem case_000016_candidateFacts :
    CandidateFacts .c000 6000480 ⟨62, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedTop5ManifestCandidateFactsShard001Smoke
