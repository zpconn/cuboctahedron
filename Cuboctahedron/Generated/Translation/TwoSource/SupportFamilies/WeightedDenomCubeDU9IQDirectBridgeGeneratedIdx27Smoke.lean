...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx27Smoke
...
def cube001x10 : MaskSubcube where
  fixed
...
private theorem poly897_11_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube001x10.Member mask) :
    poly897_11.coeffEval mask = reduced897_11.coeffEval mask := by
  have hy : maskBitForPair mask SignBit.y.toPairId = false := by
    simpa [cube001x10, MaskSubcube.Member] using hmask SignBit.y
  have hz : maskBitForPair mask SignBit.z.toPairId = false := by
    simpa [cube001x10, MaskSubcube.Member] using hmask SignBit.z
  have hd111 : maskBitForPair mask SignBit.d111.toPairId = true := by
    simpa [cube001x10, MaskSubcube.Member] using hmask SignBit.d111
  have hd1m1 : maskBitForPair mask SignBit.d1m1.toPairId = true := by
    simpa [cube001x10, MaskSubcube.Member] using hmask SignBit.d1m1
  have hdm11 : maskBitForPair mask SignBit.dm11.toPairId = false := by
    simpa [cube001x10, MaskSubcube.Member] using hmask SignBit.dm11
  by_cases hd11m : maskBitForPair mask SignBit.d11m.toPairId
  all_goals
    simp [poly897_11, reduced897_11, WalshQuadratic.coeffEval, SignBit.value, hy, hz, hd111, hd1m1, hdm11, hd11m]
    norm_num

private def reducedBound897_11 :
    WalshQuadraticReducedAbsBound cube001x10 poly897_11 where
...
private def cubeBound897_11 :
    WalshQuadraticCubeBound cube001x10 poly897_11 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cube001x10.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank897 < numPairWords)
    (_hmember : cube001x10.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank897, hlt⟩ : Fin numPairWords) mask weights11 =
      poly897_11.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx27Smoke
