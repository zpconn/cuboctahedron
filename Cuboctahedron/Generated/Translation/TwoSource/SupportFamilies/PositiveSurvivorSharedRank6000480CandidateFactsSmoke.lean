...
/-!
Generated 6Z.6K.8AP.16DN shared candidate facts smoke.

This module exports reusable source/row candidate facts for a small
multi-signature AP.16 smoke. It is diagnostic only.
-/

namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedRank6000480CandidateFactsSmoke
...
private def case_000000_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000000_mask : SignMask := ⟨14, by decide⟩
private def case_000000_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000000_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000000_b : Vec3 Rat := { x := (-100/9), y := (92/9), z := (-28/9) }
private def case_000000_firstLine : StrictLin2 := { a := (-25/9), b := (-25/9), c := (-19/3) }
...
theorem case_000000_candidateFacts :
    CandidateFacts .c003 6000480 ⟨14, by decide⟩ := by
...
private def case_000001_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000001_mask : SignMask := ⟨17, by decide⟩
private def case_000001_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000001_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tppm
  | ⟨13, _⟩ => Face.tmpp
private def case_000001_b : Vec3 Rat := { x := (-20/9), y := (-140/9), z := (-20/9) }
private def case_000001_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000001_secondLine : StrictLin2 := { a := (-1/10), b := (-1/10), c := (-13/3) }
...
private theorem case_000001_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c004).support case_000001_rank.val case_000001_mask
...
theorem case_000001_candidateFacts :
    CandidateFacts .c004 6000480 ⟨17, by decide⟩ := by
...
private def case_000002_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000002_mask : SignMask := ⟨23, by decide⟩
private def case_000002_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000002_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tppm
  | ⟨13, _⟩ => Face.tmpp
private def case_000002_b : Vec3 Rat := { x := (-164/9), y := (-92/9), z := (4/9) }
private def case_000002_firstLine : StrictLin2 := { a := (-82/63), b := (-82/63), c := (-256/189) }
...
theorem case_000002_candidateFacts :
    CandidateFacts .c002 6000480 ⟨23, by decide⟩ := by
...
private def case_000003_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000003_mask : SignMask := ⟨31, by decide⟩
private def case_000003_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000003_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000003_b : Vec3 Rat := { x := -20, y := (-4/3), z := (-4/3) }
...
private theorem case_000003_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c000).support case_000003_rank.val case_000003_mask
...
private def case_000004_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000004_mask : SignMask := ⟨46, by decide⟩
private def case_000004_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000004_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000004_b : Vec3 Rat := { x := (-52/9), y := (140/9), z := (20/9) }
private def case_000004_firstLine : StrictLin2 := { a := (-13/17), b := (13/17), c := (-49/51) }
...
private theorem case_000004_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c001).support case_000004_rank.val case_000004_mask
...
theorem case_000004_candidateFacts :
    CandidateFacts .c001 6000480 ⟨46, by decide⟩ := by
...
private def case_000005_rank : Fin numPairWords := ⟨6000480, by decide⟩
private def case_000005_mask : SignMask := ⟨62, by decide⟩
private def case_000005_word : PairWord := ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000005_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000005_b : Vec3 Rat := { x := (-100/9), y := (92/9), z := (68/9) }
private def case_000005_firstLine : StrictLin2 := { a := (25/19), b := (-25/19), c := (-49/19) }
...
private theorem case_000005_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c000).support case_000005_rank.val case_000005_mask
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedRank6000480CandidateFactsSmoke
