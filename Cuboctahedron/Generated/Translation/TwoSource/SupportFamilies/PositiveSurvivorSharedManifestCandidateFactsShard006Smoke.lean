...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard006Smoke
...
/-- AP.16W shared candidate fact: rank `2075`, mask `4`. -/
private def case_000000_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000000_mask : SignMask := ⟨4, by decide⟩
private def case_000000_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000000_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tppm
  | ⟨13, _⟩ => Face.tmpp
private def case_000000_b : Vec3 Rat := { x := (-220/27), y := (-412/27), z := (-220/27) }
private def case_000000_firstLine : StrictLin2 := { a := -1, b := -1, c := (-261/55) }
...
private theorem case_000000_sourcePredicate :
    (generatedSpec .c006).Predicate case_000000_rank.val case_000000_mask := by
  intro hlt
  have hrank : (⟨case_000000_rank.val, hlt⟩ : Fin numPairWords) = case_000000_rank := by
    ext
    rfl
  ...
  have hsourceChecks :
      SourceChecks (generatedSpec .c006).support case_000000_rank.val hlt case_000000_mask := by
...
private theorem case_000000_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c006).support case_000000_rank.val case_000000_mask
  rw [show (generatedKey .c006).support = case_000000_support by rfl]
  intro hlt
...
theorem case_000000_candidateFacts :
    CandidateFacts .c006 2075 ⟨4, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `8`. -/
private def case_000001_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000001_mask : SignMask := ⟨8, by decide⟩
private def case_000001_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000001_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000001_b : Vec3 Rat := { x := (-20/9), y := (-20/9), z := (-116/9) }
private def case_000001_firstLine : StrictLin2 := { a := -1, b := -1, c := (-63/5) }
...
theorem case_000001_candidateFacts :
    CandidateFacts .c006 2075 ⟨8, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `9`. -/
private def case_000002_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000002_mask : SignMask := ⟨9, by decide⟩
private def case_000002_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000002_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000002_b : Vec3 Rat := { x := (-20/9), y := (52/9), z := (-116/9) }
private def case_000002_firstLine : StrictLin2 := { a := -1, b := -1, c := (-27/5) }
...
theorem case_000002_candidateFacts :
    CandidateFacts .c006 2075 ⟨9, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `13`. -/
private def case_000003_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000003_mask : SignMask := ⟨13, by decide⟩
private def case_000003_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000003_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000003_b : Vec3 Rat := { x := (-268/27), y := (44/27), z := (-268/27) }
private def case_000003_firstLine : StrictLin2 := { a := 1, b := -1, c := (-89/67) }
...
private theorem case_000003_shape :
    OppMinusOneVarFirst case_000003_support case_000003_rank.val case_000003_mask := by
  intro hlt
  ...
  have case_000003_rowFirst :
      OppNegRow (FirstLineAt case_000003_support case_000003_rank.val hlt case_000003_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000003_firstLine, OppNegRow]
...
private theorem case_000003_checkedAtRank :
  ...
  oppMinusOneVarFirst_checkedOn case_000003_support case_000003_rank.val case_000003_rank.isLt
...
private theorem case_000003_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c003).support case_000003_rank.val case_000003_mask
...
theorem case_000003_candidateFacts :
    CandidateFacts .c003 2075 ⟨13, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `22`. -/
private def case_000004_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000004_mask : SignMask := ⟨22, by decide⟩
private def case_000004_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private theorem case_000004_sourcePredicate :
    (generatedSpec .c005).Predicate case_000004_rank.val case_000004_mask := by
  intro hlt
  have hrank : (⟨case_000004_rank.val, hlt⟩ : Fin numPairWords) = case_000004_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c005).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c005).support case_000004_rank.val hlt case_000004_mask := by
...
private theorem case_000004_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c005).support case_000004_rank.val case_000004_mask
  rw [show (generatedKey .c005).support = case_000004_support by rfl]
  intro hlt
...
theorem case_000004_candidateFacts :
    CandidateFacts .c005 2075 ⟨22, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `25`. -/
private def case_000005_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000005_mask : SignMask := ⟨25, by decide⟩
private def case_000005_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000005_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tmpp
private def case_000005_b : Vec3 Rat := { x := (-140/27), y := (268/27), z := (-140/27) }
private def case_000005_firstLine : StrictLin2 := { a := (-35/3), b := (-35/3), c := -33 }
...
theorem case_000005_candidateFacts :
    CandidateFacts .c004 2075 ⟨25, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `28`. -/
private def case_000006_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000006_mask : SignMask := ⟨28, by decide⟩
private def case_000006_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
theorem case_000006_candidateFacts :
    CandidateFacts .c001 2075 ⟨28, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `29`. -/
private def case_000007_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000007_mask : SignMask := ⟨29, by decide⟩
private def case_000007_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000007_firstLine : StrictLin2 := { a := (-29/21), b := (-29/21), c := (-15/7) }
...
private theorem case_000007_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000007_rank.val case_000007_mask
...
theorem case_000007_candidateFacts :
    CandidateFacts .c004 2075 ⟨29, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `31`. -/
private def case_000008_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000008_mask : SignMask := ⟨31, by decide⟩
private def case_000008_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000008_firstLine : StrictLin2 := { a := (-29/3), b := (-29/3), c := -31 }
...
private theorem case_000008_sourcePredicate :
    (generatedSpec .c000).Predicate case_000008_rank.val case_000008_mask := by
  intro hlt
  have hrank : (⟨case_000008_rank.val, hlt⟩ : Fin numPairWords) = case_000008_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c000).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c000).support case_000008_rank.val hlt case_000008_mask := by
...
private theorem case_000008_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c000).support case_000008_rank.val case_000008_mask
  rw [show (generatedKey .c000).support = case_000008_support by rfl]
  intro hlt
...
theorem case_000008_candidateFacts :
    CandidateFacts .c000 2075 ⟨31, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `54`. -/
private def case_000009_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000009_mask : SignMask := ⟨54, by decide⟩
private def case_000009_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000009_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tppm
  | ⟨13, _⟩ => Face.tpmm
private def case_000009_b : Vec3 Rat := { x := (-52/9), y := (-52/9), z := (116/9) }
...
theorem case_000009_candidateFacts :
    CandidateFacts .c005 2075 ⟨54, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2075`, mask `63`. -/
private def case_000010_rank : Fin numPairWords := ⟨2075, by decide⟩
private def case_000010_mask : SignMask := ⟨63, by decide⟩
private def case_000010_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.d11m, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11], by decide⟩
...
private def case_000010_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmmp
  | ⟨13, _⟩ => Face.tpmm
private def case_000010_b : Vec3 Rat := { x := (-68/9), y := (100/9), z := (100/9) }
private def case_000010_firstLine : StrictLin2 := { a := (-34/33), b := (-34/33), c := (-40/33) }
...
private theorem case_000010_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c002).support case_000010_rank.val case_000010_mask
...
theorem case_000010_candidateFacts :
    CandidateFacts .c002 2075 ⟨63, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard006Smoke
