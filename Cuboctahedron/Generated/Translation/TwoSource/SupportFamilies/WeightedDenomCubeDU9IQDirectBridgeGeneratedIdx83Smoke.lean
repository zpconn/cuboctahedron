...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx83Smoke
...
private theorem poly955_6_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      simp [poly955_6, reduced955_6, WalshQuadratic.coeffEval, SignBit.value, hd111, hd11m, hd1m1, hdm11, hy, hz]
      norm_num

private def reducedBound955_6 :
    WalshQuadraticReducedAbsBound cubexx0011 poly955_6 where
...
private def cubeBound955_6 :
    WalshQuadraticCubeBound cubexx0011 poly955_6 :=
...
def reducedObstruction955_6
    ...
    WeightedWalshQuadraticNonposObstruction rank955 cubexx0011.Member where
  weights := weights6
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx83Smoke
