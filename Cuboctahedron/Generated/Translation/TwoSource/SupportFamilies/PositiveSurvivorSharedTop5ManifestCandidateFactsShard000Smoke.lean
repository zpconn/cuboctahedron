...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedTop5ManifestCandidateFactsShard000Smoke
...
theorem case_000000_candidateFacts :
    CandidateFacts .c007 6000745 ⟨8, by decide⟩ := by
...
private theorem case_000001_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c004).support case_000001_rank.val case_000001_mask
...
theorem case_000001_candidateFacts :
    CandidateFacts .c004 6000745 ⟨13, by decide⟩ := by
...
theorem case_000002_candidateFacts :
    CandidateFacts .c008 6000745 ⟨16, by decide⟩ := by
...
private theorem case_000004_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c003).support case_000004_rank.val case_000004_mask
...
theorem case_000004_candidateFacts :
    CandidateFacts .c003 6000745 ⟨28, by decide⟩ := by
...
private theorem case_000006_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c005).support case_000006_rank.val case_000006_mask
...
theorem case_000006_candidateFacts :
    CandidateFacts .c005 6000745 ⟨30, by decide⟩ := by
...
private theorem case_000008_sourcePredicate :
    (generatedSpec .c008).Predicate case_000008_rank.val case_000008_mask := by
  intro hlt
  have hrank : (⟨case_000008_rank.val, hlt⟩ : Fin numPairWords) = case_000008_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c008).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c008).support case_000008_rank.val hlt case_000008_mask := by
...
private theorem case_000008_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c008).support case_000008_rank.val case_000008_mask
  rw [show (generatedKey .c008).support = case_000008_support by rfl]
  intro hlt
...
theorem case_000008_candidateFacts :
    CandidateFacts .c008 6000745 ⟨45, by decide⟩ := by
...
theorem case_000009_candidateFacts :
    CandidateFacts .c008 6000745 ⟨47, by decide⟩ := by
...
private theorem case_000011_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c006).support case_000011_rank.val case_000011_mask
...
theorem case_000011_candidateFacts :
    CandidateFacts .c006 6000745 ⟨55, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedTop5ManifestCandidateFactsShard000Smoke
