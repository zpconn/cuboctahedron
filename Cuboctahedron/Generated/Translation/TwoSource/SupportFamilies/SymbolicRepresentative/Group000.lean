...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.SymbolicRepresentative.Group000
...
/-- Symbolic representative family `eq_eq_pos_var_first|source=5adcd045a97319ca2c507f2a2729e7e4b44586b0af09727c0f6dd12e5bb3580b|rowProperty=89150a165454d85708caa44cd6a931ee7e3e1f1eebf92fc2a41907dc9743a8df`.
...
private abbrev fam_000_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_000_support r mask /\
    EqEqPosVarFirstRows fam_000_support r mask

private theorem fam_000_checkedOn :
    SupportFamilyCheckedOn fam_000_support fam_000_contains := by
  intro r hlt mask h
  exact eqEqPosVarFirst_checkedOn fam_000_support r hlt mask
...
/-- Symbolic representative family `opp_1m_var_first|source=5803f35d677ae04166a321d8243e2278ba6a40142643333ae17cbcb910b4f201|rowProperty=83e0bba9a62a5cae753319e32a3086ee23506cf0de85735ba98311f13d1ca082`.
...
private abbrev fam_001_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_001_support r mask /\
    OppOneMinusVarFirstRows fam_001_support r mask

private theorem fam_001_checkedOn :
    SupportFamilyCheckedOn fam_001_support fam_001_contains := by
  intro r hlt mask h
  exact oppOneMinusVarFirst_checkedOn fam_001_support r hlt mask
...
/-- Symbolic representative family `opp_m1_var_first|source=7689ca8f4559480b5882866950c23005b8844177f2c8efd7fdc4ab7fef075198|rowProperty=0006663011bcc6a4229a7d4792afea7ae4224d313e9c9e3da8721c1d955b3403`.
...
private abbrev fam_002_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_002_support r mask /\
    OppMinusOneVarFirstRows fam_002_support r mask

private theorem fam_002_checkedOn :
    SupportFamilyCheckedOn fam_002_support fam_002_contains := by
  intro r hlt mask h
  exact oppMinusOneVarFirst_checkedOn fam_002_support r hlt mask
...
/-- Symbolic representative family `eq_eq_pos_var_first|source=d4bee78b63fa6bcebd58ce23dce690fc537b368d0b8afd26b4c969ef509d6bb4|rowProperty=89150a165454d85708caa44cd6a931ee7e3e1f1eebf92fc2a41907dc9743a8df`.
...
private abbrev fam_003_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_003_support r mask /\
    EqEqPosVarFirstRows fam_003_support r mask

private theorem fam_003_checkedOn :
    SupportFamilyCheckedOn fam_003_support fam_003_contains := by
  intro r hlt mask h
  exact eqEqPosVarFirst_checkedOn fam_003_support r hlt mask
    (eqEqPosVarFirst_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `opp_1m_var_first|source=6a1169c86301f17f88c4ba207f016625742fcfc52d759287e0387c29177eb972|rowProperty=83e0bba9a62a5cae753319e32a3086ee23506cf0de85735ba98311f13d1ca082`.
...
private abbrev fam_004_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_004_support r mask /\
    OppOneMinusVarFirstRows fam_004_support r mask

private theorem fam_004_checkedOn :
    SupportFamilyCheckedOn fam_004_support fam_004_contains := by
  intro r hlt mask h
  exact oppOneMinusVarFirst_checkedOn fam_004_support r hlt mask
    (oppOneMinusVarFirst_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_pos_var_first|source=e077434d25cd2b8256b2c045b2f2c39e2e407562a418eb83b7432401c75cb23e|rowProperty=89150a165454d85708caa44cd6a931ee7e3e1f1eebf92fc2a41907dc9743a8df`.
...
private abbrev fam_005_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_005_support r mask /\
    EqEqPosVarFirstRows fam_005_support r mask

private theorem fam_005_checkedOn :
    SupportFamilyCheckedOn fam_005_support fam_005_contains := by
  intro r hlt mask h
  exact eqEqPosVarFirst_checkedOn fam_005_support r hlt mask
    (eqEqPosVarFirst_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_pos_var_second|source=ca2b14f915ca83a1a12d8dffbbe80a668272f570172001789f97a34e7649e451|rowProperty=8ffcafda0054b4729c0b52066396e52e2ca37d764323ce1b7c10184fa45e0976`.
...
private abbrev fam_006_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_006_support r mask /\
    EqEqPosVarSecondRows fam_006_support r mask

private theorem fam_006_checkedOn :
    SupportFamilyCheckedOn fam_006_support fam_006_contains := by
  intro r hlt mask h
  exact eqEqPosVarSecond_checkedOn fam_006_support r hlt mask
...
/-- Symbolic representative family `eq_eq_pos_var_second|source=513f51128e8b6d356d5f0059d792b6ee98b4d6a8f8e6deb429fb6b769a3bafea|rowProperty=8ffcafda0054b4729c0b52066396e52e2ca37d764323ce1b7c10184fa45e0976`.
...
private abbrev fam_007_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_007_support r mask /\
    EqEqPosVarSecondRows fam_007_support r mask

private theorem fam_007_checkedOn :
    SupportFamilyCheckedOn fam_007_support fam_007_contains := by
  intro r hlt mask h
  exact eqEqPosVarSecond_checkedOn fam_007_support r hlt mask
    (eqEqPosVarSecond_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_pos_var_second|source=5c64d4cb48f5c7b902456fd0d508ac726746f2d6514ca46677c69b3c6a9546a5|rowProperty=8ffcafda0054b4729c0b52066396e52e2ca37d764323ce1b7c10184fa45e0976`.
...
private abbrev fam_008_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_008_support r mask /\
    EqEqPosVarSecondRows fam_008_support r mask

private theorem fam_008_checkedOn :
    SupportFamilyCheckedOn fam_008_support fam_008_contains := by
  intro r hlt mask h
  exact eqEqPosVarSecond_checkedOn fam_008_support r hlt mask
    (eqEqPosVarSecond_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_pos_var_second|source=d611693e904457a75b4b118a7390fd88fd0ef30213e479ab00229c7656f94ead|rowProperty=8ffcafda0054b4729c0b52066396e52e2ca37d764323ce1b7c10184fa45e0976`.
It covered 85 observed GoodDirection survivors in the bounded scan. -/
...
private abbrev fam_009_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_009_support r mask /\
    EqEqPosVarSecondRows fam_009_support r mask

private theorem fam_009_checkedOn :
    SupportFamilyCheckedOn fam_009_support fam_009_contains := by
  intro r hlt mask h
  exact eqEqPosVarSecond_checkedOn fam_009_support r hlt mask
    (eqEqPosVarSecond_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_pos_var_first|source=be545f38cd79ff84fc12e32e2aad4d6ab524ec73af55f6643c76c1b22af7bb92|rowProperty=89150a165454d85708caa44cd6a931ee7e3e1f1eebf92fc2a41907dc9743a8df`.
...
private abbrev fam_010_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_010_support r mask /\
    EqEqPosVarFirstRows fam_010_support r mask

private theorem fam_010_checkedOn :
    SupportFamilyCheckedOn fam_010_support fam_010_contains := by
  intro r hlt mask h
  exact eqEqPosVarFirst_checkedOn fam_010_support r hlt mask
    (eqEqPosVarFirst_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_pos_var_second|source=351b04128f3f1901e5ffdc54430fe02cdaf1bcc1903ee1fbc5c5707bb7bc9b00|rowProperty=8ffcafda0054b4729c0b52066396e52e2ca37d764323ce1b7c10184fa45e0976`.
...
private abbrev fam_011_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_011_support r mask /\
    EqEqPosVarSecondRows fam_011_support r mask

private theorem fam_011_checkedOn :
    SupportFamilyCheckedOn fam_011_support fam_011_contains := by
  intro r hlt mask h
  exact eqEqPosVarSecond_checkedOn fam_011_support r hlt mask
    (eqEqPosVarSecond_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `eq_eq_neg_var_first|source=55f26045ff81f56765c35562394306053ec02060435e216f54f928a6f6cda39b|rowProperty=516bde31c1f986b92695e6f59963e7258037afab996940a9a47e2016c3a06e5b`.
...
private abbrev fam_012_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_012_support r mask /\
    EqEqNegVarFirstRows fam_012_support r mask

private theorem fam_012_checkedOn :
    SupportFamilyCheckedOn fam_012_support fam_012_contains := by
  intro r hlt mask h
  exact eqEqNegVarFirst_checkedOn fam_012_support r hlt mask
...
/-- Symbolic representative family `eq_eq_pos_var_second|source=b7efa03a1d5cfa8e557fd9bad2c2784fe7e03cb5e7e3edda6993009238812716|rowProperty=8ffcafda0054b4729c0b52066396e52e2ca37d764323ce1b7c10184fa45e0976`.
...
private abbrev fam_013_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_013_support r mask /\
    EqEqPosVarSecondRows fam_013_support r mask

private theorem fam_013_checkedOn :
    SupportFamilyCheckedOn fam_013_support fam_013_contains := by
  intro r hlt mask h
  exact eqEqPosVarSecond_checkedOn fam_013_support r hlt mask
    (eqEqPosVarSecond_of_symbolic h.1 h.2)
...
/-- Symbolic representative family `opp_1m_var_second|source=9b167f29cbdda7204b0b18f50069946c17d6178ac44bc418b261ef92694693b1|rowProperty=9e28132282c11c37f33bd4d8e7b679036632d2d844673fc204a5cb501bb03382`.
It covered 67 observed GoodDirection survivors in the bounded scan. -/
...
private abbrev fam_014_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_014_support r mask /\
    OppOneMinusVarSecondRows fam_014_support r mask

private theorem fam_014_checkedOn :
    SupportFamilyCheckedOn fam_014_support fam_014_contains := by
  intro r hlt mask h
  exact oppOneMinusVarSecond_checkedOn fam_014_support r hlt mask
...
/-- Symbolic representative family `opp_1m_var_first|source=e077001d13bb9a1adcd799b5036d214536d800012dab38e348c995f8a8dbbf72|rowProperty=83e0bba9a62a5cae753319e32a3086ee23506cf0de85735ba98311f13d1ca082`.
...
private abbrev fam_015_contains (r : Nat) (mask : SignMask) : Prop :=
  SourceAgrees fam_015_support r mask /\
    OppOneMinusVarFirstRows fam_015_support r mask

private theorem fam_015_checkedOn :
    SupportFamilyCheckedOn fam_015_support fam_015_contains := by
  intro r hlt mask h
  exact oppOneMinusVarFirst_checkedOn fam_015_support r hlt mask
    (oppOneMinusVarFirst_of_symbolic h.1 h.2)
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.SymbolicRepresentative.Group000
