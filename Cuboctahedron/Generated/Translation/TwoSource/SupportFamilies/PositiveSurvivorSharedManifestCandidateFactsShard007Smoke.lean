...
/-!
Generated AP.16Z.1 shared candidate facts smoke.

This module exports reusable source/row candidate facts for a small
multi-signature AP.16 smoke. It is diagnostic only.
-/

namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard007Smoke
...
/-- AP.16W shared candidate fact: rank `2441`, mask `9`. -/
private def case_000000_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000000_mask : SignMask := ⟨9, by decide⟩
private def case_000000_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000000_secondLine : StrictLin2 := { a := (-9/110), b := (-9/110), c := (-4/11) }
...
private theorem case_000000_sourcePredicate :
    (generatedSpec .c001).Predicate case_000000_rank.val case_000000_mask := by
  intro hlt
  have hrank : (⟨case_000000_rank.val, hlt⟩ : Fin numPairWords) = case_000000_rank := by
    ext
    rfl
  ...
  have hsourceChecks :
      SourceChecks (generatedSpec .c001).support case_000000_rank.val hlt case_000000_mask := by
...
private theorem case_000000_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c001).support case_000000_rank.val case_000000_mask
  rw [show (generatedKey .c001).support = case_000000_support by rfl]
  intro hlt
...
theorem case_000000_candidateFacts :
    CandidateFacts .c001 2441 ⟨9, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `13`. -/
private def case_000001_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000001_mask : SignMask := ⟨13, by decide⟩
private def case_000001_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000001_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmmm
private def case_000001_b : Vec3 Rat := { x := (-28/3), y := (28/3), z := (-28/3) }
private def case_000001_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000001_secondLine : StrictLin2 := { a := (-3/28), b := (-3/28), c := (-3/14) }
...
private theorem case_000001_sourcePredicate :
    (generatedSpec .c002).Predicate case_000001_rank.val case_000001_mask := by
  intro hlt
  have hrank : (⟨case_000001_rank.val, hlt⟩ : Fin numPairWords) = case_000001_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c002).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c002).support case_000001_rank.val hlt case_000001_mask := by
...
private theorem case_000001_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c002).support case_000001_rank.val case_000001_mask
  rw [show (generatedKey .c002).support = case_000001_support by rfl]
  intro hlt
...
theorem case_000001_candidateFacts :
    CandidateFacts .c002 2441 ⟨13, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `18`. -/
private def case_000002_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000002_mask : SignMask := ⟨18, by decide⟩
private def case_000002_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000002_secondLine : StrictLin2 := { a := (-9/110), b := (-9/110), c := (-4/11) }
...
theorem case_000002_candidateFacts :
    CandidateFacts .c001 2441 ⟨18, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `22`. -/
private def case_000003_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000003_mask : SignMask := ⟨22, by decide⟩
private def case_000003_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000003_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmmm
private def case_000003_b : Vec3 Rat := { x := (-28/3), y := (-28/3), z := (28/3) }
private def case_000003_firstLine : StrictLin2 := { a := -1, b := 1, c := -3 }
...
private theorem case_000003_sourcePredicate :
    (generatedSpec .c004).Predicate case_000003_rank.val case_000003_mask := by
  intro hlt
  have hrank : (⟨case_000003_rank.val, hlt⟩ : Fin numPairWords) = case_000003_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c004).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c004).support case_000003_rank.val hlt case_000003_mask := by
...
private theorem case_000003_rowsForKey :
  ...
  change OppOneMinusVarFirstRows (generatedKey .c004).support case_000003_rank.val case_000003_mask
  rw [show (generatedKey .c004).support = case_000003_support by rfl]
  intro hlt
...
theorem case_000003_candidateFacts :
    CandidateFacts .c004 2441 ⟨22, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `24`. -/
private def case_000004_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000004_mask : SignMask := ⟨24, by decide⟩
private def case_000004_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000004_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tppp
private def case_000004_b : Vec3 Rat := { x := (-52/9), y := (-116/9), z := (-116/9) }
private def case_000004_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000004_secondLine : StrictLin2 := { a := (-13/710), b := (-13/710), c := (-59/1065) }
...
private theorem case_000004_sourcePredicate :
    (generatedSpec .c001).Predicate case_000004_rank.val case_000004_mask := by
  intro hlt
  have hrank : (⟨case_000004_rank.val, hlt⟩ : Fin numPairWords) = case_000004_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c001).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c001).support case_000004_rank.val hlt case_000004_mask := by
...
private theorem case_000004_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c001).support case_000004_rank.val case_000004_mask
  rw [show (generatedKey .c001).support = case_000004_support by rfl]
  intro hlt
...
theorem case_000004_candidateFacts :
    CandidateFacts .c001 2441 ⟨24, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `29`. -/
private def case_000005_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000005_mask : SignMask := ⟨29, by decide⟩
private def case_000005_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000005_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmmm
private def case_000005_b : Vec3 Rat := { x := (-100/9), y := (4/9), z := (-68/9) }
private def case_000005_firstLine : StrictLin2 := { a := (25/9), b := (25/9), c := (-19/3) }
...
private theorem case_000005_shape :
    EqEqNegVarFirst case_000005_support case_000005_rank.val case_000005_mask := by
  intro hlt
  ...
  have case_000005_rowFirst :
      EqEqNegRow (FirstLineAt case_000005_support case_000005_rank.val hlt case_000005_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000005_firstLine, EqEqNegRow]
...
private theorem case_000005_checkedAtRank :
  ...
  eqEqNegVarFirst_checkedOn case_000005_support case_000005_rank.val case_000005_rank.isLt
...
private theorem case_000005_sourcePredicate :
    (generatedSpec .c005).Predicate case_000005_rank.val case_000005_mask := by
  intro hlt
  have hrank : (⟨case_000005_rank.val, hlt⟩ : Fin numPairWords) = case_000005_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c005).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c005).support case_000005_rank.val hlt case_000005_mask := by
...
private theorem case_000005_rowsForKey :
  ...
  change EqEqNegVarFirstRows (generatedKey .c005).support case_000005_rank.val case_000005_mask
  rw [show (generatedKey .c005).support = case_000005_support by rfl]
  intro hlt
...
theorem case_000005_candidateFacts :
    CandidateFacts .c005 2441 ⟨29, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `30`. -/
private def case_000006_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000006_mask : SignMask := ⟨30, by decide⟩
private def case_000006_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000006_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmmm
private def case_000006_b : Vec3 Rat := { x := (-100/9), y := (-68/9), z := (4/9) }
private def case_000006_firstLine : StrictLin2 := { a := (25/9), b := (25/9), c := (-19/3) }
...
private theorem case_000006_sourcePredicate :
    (generatedSpec .c005).Predicate case_000006_rank.val case_000006_mask := by
  intro hlt
  have hrank : (⟨case_000006_rank.val, hlt⟩ : Fin numPairWords) = case_000006_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c005).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c005).support case_000006_rank.val hlt case_000006_mask := by
...
private theorem case_000006_rowsForKey :
  ...
  change EqEqNegVarFirstRows (generatedKey .c005).support case_000006_rank.val case_000006_mask
  rw [show (generatedKey .c005).support = case_000006_support by rfl]
  intro hlt
...
theorem case_000006_candidateFacts :
    CandidateFacts .c005 2441 ⟨30, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `31`. -/
private def case_000007_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000007_mask : SignMask := ⟨31, by decide⟩
private def case_000007_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000007_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmmm
private def case_000007_b : Vec3 Rat := { x := (-100/9), y := (4/9), z := (4/9) }
private def case_000007_firstLine : StrictLin2 := { a := (-25/23), b := (-25/23), c := (-121/23) }
...
private theorem case_000007_sourcePredicate :
    (generatedSpec .c000).Predicate case_000007_rank.val case_000007_mask := by
  intro hlt
  have hrank : (⟨case_000007_rank.val, hlt⟩ : Fin numPairWords) = case_000007_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c000).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c000).support case_000007_rank.val hlt case_000007_mask := by
...
private theorem case_000007_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c000).support case_000007_rank.val case_000007_mask
  rw [show (generatedKey .c000).support = case_000007_support by rfl]
  intro hlt
...
theorem case_000007_candidateFacts :
    CandidateFacts .c000 2441 ⟨31, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `39`. -/
private def case_000008_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000008_mask : SignMask := ⟨39, by decide⟩
private def case_000008_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000008_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmmm
private def case_000008_b : Vec3 Rat := { x := (-20/9), y := (116/9), z := (116/9) }
private def case_000008_firstLine : StrictLin2 := { a := (-10/63), b := (-10/63), c := (-32/21) }
...
private theorem case_000008_sourcePredicate :
    (generatedSpec .c006).Predicate case_000008_rank.val case_000008_mask := by
  intro hlt
  have hrank : (⟨case_000008_rank.val, hlt⟩ : Fin numPairWords) = case_000008_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c006).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c006).support case_000008_rank.val hlt case_000008_mask := by
...
private theorem case_000008_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c006).support case_000008_rank.val case_000008_mask
  rw [show (generatedKey .c006).support = case_000008_support by rfl]
  intro hlt
...
theorem case_000008_candidateFacts :
    CandidateFacts .c006 2441 ⟨39, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `45`. -/
private def case_000009_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000009_mask : SignMask := ⟨45, by decide⟩
private def case_000009_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000009_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmp
  | ⟨13, _⟩ => Face.tmmm
private def case_000009_b : Vec3 Rat := { x := -4, y := (44/3), z := -4 }
private def case_000009_firstLine : StrictLin2 := { a := (-3/11), b := (-3/11), c := (-25/33) }
...
private theorem case_000009_shape :
    EqEqPosVarFirst case_000009_support case_000009_rank.val case_000009_mask := by
  intro hlt
...
private theorem case_000009_checkedAtRank :
  ...
  eqEqPosVarFirst_checkedOn case_000009_support case_000009_rank.val case_000009_rank.isLt
...
private theorem case_000009_sourcePredicate :
    (generatedSpec .c003).Predicate case_000009_rank.val case_000009_mask := by
  intro hlt
  have hrank : (⟨case_000009_rank.val, hlt⟩ : Fin numPairWords) = case_000009_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c003).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c003).support case_000009_rank.val hlt case_000009_mask := by
...
private theorem case_000009_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c003).support case_000009_rank.val case_000009_mask
  rw [show (generatedKey .c003).support = case_000009_support by rfl]
  intro hlt
...
theorem case_000009_candidateFacts :
    CandidateFacts .c003 2441 ⟨45, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `2441`, mask `54`. -/
private def case_000010_rank : Fin numPairWords := ⟨2441, by decide⟩
private def case_000010_mask : SignMask := ⟨54, by decide⟩
private def case_000010_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.d111], by decide⟩
...
private def case_000010_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpm
  | ⟨13, _⟩ => Face.tmmm
private def case_000010_b : Vec3 Rat := { x := -4, y := -4, z := (44/3) }
private def case_000010_firstLine : StrictLin2 := { a := (-3/11), b := (-3/11), c := (-25/33) }
...
private theorem case_000010_sourcePredicate :
    (generatedSpec .c003).Predicate case_000010_rank.val case_000010_mask := by
  intro hlt
  have hrank : (⟨case_000010_rank.val, hlt⟩ : Fin numPairWords) = case_000010_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c003).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c003).support case_000010_rank.val hlt case_000010_mask := by
...
private theorem case_000010_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c003).support case_000010_rank.val case_000010_mask
  rw [show (generatedKey .c003).support = case_000010_support by rfl]
  intro hlt
...
theorem case_000010_candidateFacts :
    CandidateFacts .c003 2441 ⟨54, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard007Smoke
