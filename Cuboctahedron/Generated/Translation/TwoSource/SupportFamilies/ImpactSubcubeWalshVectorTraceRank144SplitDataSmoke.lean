...
/-!
Generated AP16DK split Walsh-vector trace data for rank `144`.
-/
...
def generatedRank : Fin numPairWords := ⟨144, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d11m, PairId.d11m, PairId.dm11, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
