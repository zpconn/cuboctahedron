...
import Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke
...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx07Smoke
...
abbrev generatedNormal00 : WalshAffineVec3 :=
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke.generatedNormal00
...
def poly896_1_6 : WalshQuadratic where
  c := 12
  y := 0
  z := 0
  d111 := 8/3
...
private def reduced896_1_6 : WalshQuadratic where
  c := -4
  y := 0
  z := 4
  d111 := 0
...
private theorem poly896_1_6_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube1xx00x.Member mask) :
    poly896_1_6.coeffEval mask = reduced896_1_6.coeffEval mask := by
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly896_1_6, reduced896_1_6, WalshQuadratic.coeffEval, SignBit.value, hy, hd11m, hd1m1, hz, hd111, hdm11]
        norm_num

private def reducedBound896_1_6 :
    WalshQuadraticReducedAbsBound cube1xx00x poly896_1_6 where
  reduced := reduced896_1_6
  eq_on_cube := by
    intro mask hmask
    exact poly896_1_6_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced896_1_6, WalshQuadratic.absBoundSum]

private def cubeBound896_1_6 :
    WalshQuadraticCubeBound cube1xx00x poly896_1_6 :=
  WalshQuadraticCubeBound.leaf reducedBound896_1_6

private theorem poly896_1_6_nonpos
    {mask : SignMask} (hmask : cube1xx00x.Member mask) :
    poly896_1_6.coeffEval mask <= 0 :=
  cubeBound896_1_6.coeffEval_nonpos hmask

def reducedObstruction896_1_6
    (direct_eq :
      forall {mask : SignMask} (hlt : rank896 < numPairWords),
        cube1xx00x.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank896, hlt⟩ : Fin numPairWords) mask weights1_6 =
            poly896_1_6.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank896 cube1xx00x.Member where
  weights := weights1_6
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly896_1_6_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    weightedDenomAtRank
      (⟨rank896, hlt⟩ : Fin numPairWords) mask weights1_6 <= 0 :=
  (reducedObstruction896_1_6 direct_eq).nonpos hlt hmember
...
private theorem dot00_eq :
  ...
  norm_num [dot00, generatedNormal00, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke.generatedNormal00, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke.generatedNormal00_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke.generatedNormal00_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke.generatedNormal00_z, generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank896ChainSmoke.generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank896ChainSmoke.generatedVector_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank896ChainSmoke.generatedVector_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank896ChainSmoke.generatedVector_z, WalshAffineVec3.dot, WalshQuadratic.add, WalshAffine.mul]
...
private theorem direct00_eq
    ...
    directWalshDotAtRank
        (⟨rank896, hlt⟩ : Fin numPairWords) mask (0 : WordIndex) =
  ...
  rw [← Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank896Smoke.generatedNormal00_eq]
...
private theorem direct00_eq_of_val
  ...
  rw [directWalshDotAtRank_eq_of_val
    (⟨rank896, hlt⟩ : Fin numPairWords) mask (j := (0 : WordIndex)) hi]
...
private theorem dot_sum_eval
    ...
    dot00.coeffEval mask + dot05.coeffEval mask =
      poly896_1_6.coeffEval mask := by
  simp [dot00, dot05, poly896_1_6,
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx07Smoke
