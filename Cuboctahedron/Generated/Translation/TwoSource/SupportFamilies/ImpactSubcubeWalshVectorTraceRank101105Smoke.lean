...
/-!
Generated AP16CM Walsh-vector trace fixture `ImpactSubcubeWalshVectorTraceRank101105Smoke`.

This file proves the rank-101105 generated Walsh translation vector by
...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank101105Smoke
...
def generatedRank : Fin numPairWords := ⟨101105, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.dm11, PairId.d11m, PairId.z, PairId.d111, PairId.d11m, PairId.z, PairId.d1m1, PairId.d1m1, PairId.d111, PairId.dm11], by decide⟩
...
@[simp] private theorem generatedWord_getFin_08 :
    Vector.get generatedWord (8 : WordIndex) = PairId.z := by
  rfl

@[simp] private theorem generatedWord_get_08
    (h : (8 : Nat) < 13) :
    generatedWord.get ⟨8, h⟩ = PairId.z := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.ImpactSubcubeWalshVectorTraceRank101105Smoke
