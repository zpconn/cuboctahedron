...
/-!
Generated AP16DK split Walsh-vector trace data for rank `32`.
-/
...
def generatedRank : Fin numPairWords := ⟨32, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d1m1, PairId.d11m, PairId.d11m, PairId.dm11, PairId.dm11, PairId.d1m1], by decide⟩
...
@[simp] theorem generatedWord_get_08
    (h : (8 : Nat) < 13) :
    generatedWord.get ⟨8, h⟩ = PairId.d11m := by
...
@[simp] theorem generatedWord_getFin_12 :
    Vector.get generatedWord (12 : WordIndex) = PairId.d1m1 := by
  rfl

@[simp] theorem generatedWord_get_12
    (h : (12 : Nat) < 13) :
    generatedWord.get ⟨12, h⟩ = PairId.d1m1 := by
