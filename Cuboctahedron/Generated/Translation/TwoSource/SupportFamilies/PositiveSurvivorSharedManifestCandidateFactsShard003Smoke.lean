...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard003Smoke
...
/-- AP.16W shared candidate fact: rank `498`, mask `0`. -/
private def case_000000_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000000_mask : SignMask := ⟨0, by decide⟩
private def case_000000_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000000_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tppp
private def case_000000_b : Vec3 Rat := { x := (-268/27), y := (-140/27), z := (-140/27) }
private def case_000000_firstLine : StrictLin2 := { a := -1, b := -1, c := (-73/67) }
...
private theorem case_000000_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000000_rank.val case_000000_mask
...
theorem case_000000_candidateFacts :
    CandidateFacts .c004 498 ⟨0, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `7`. -/
private def case_000001_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000001_mask : SignMask := ⟨7, by decide⟩
private def case_000001_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000001_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tmmm
private def case_000001_b : Vec3 Rat := { x := (-412/27), y := (220/27), z := (220/27) }
private def case_000001_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000001_secondLine : StrictLin2 := { a := (-103/2130), b := (-103/2130), c := (-137/1065) }
...
private theorem case_000001_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c000).support case_000001_rank.val case_000001_mask
...
theorem case_000001_candidateFacts :
    CandidateFacts .c000 498 ⟨7, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `8`. -/
private def case_000002_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000002_mask : SignMask := ⟨8, by decide⟩
private def case_000002_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000002_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tppp
private def case_000002_b : Vec3 Rat := { x := (-52/9), y := (-20/9), z := (-116/9) }
private def case_000002_firstLine : StrictLin2 := { a := -1, b := -1, c := (-55/13) }
...
private theorem case_000002_sourcePredicate :
    (generatedSpec .c004).Predicate case_000002_rank.val case_000002_mask := by
  intro hlt
  have hrank : (⟨case_000002_rank.val, hlt⟩ : Fin numPairWords) = case_000002_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c004).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c004).support case_000002_rank.val hlt case_000002_mask := by
...
private theorem case_000002_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000002_rank.val case_000002_mask
  rw [show (generatedKey .c004).support = case_000002_support by rfl]
  intro hlt
...
theorem case_000002_candidateFacts :
    CandidateFacts .c004 498 ⟨8, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `9`. -/
private def case_000003_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000003_mask : SignMask := ⟨9, by decide⟩
private def case_000003_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000003_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tppp
private def case_000003_b : Vec3 Rat := { x := (-52/9), y := (52/9), z := (-116/9) }
private def case_000003_firstLine : StrictLin2 := { a := -1, b := -1, c := (-19/13) }
...
theorem case_000003_candidateFacts :
    CandidateFacts .c004 498 ⟨9, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `13`. -/
private def case_000004_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000004_mask : SignMask := ⟨13, by decide⟩
private def case_000004_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private theorem case_000004_shape :
    OppMinusOneVarFirst case_000004_support case_000004_rank.val case_000004_mask := by
  intro hlt
  ...
  have case_000004_rowFirst :
      OppNegRow (FirstLineAt case_000004_support case_000004_rank.val hlt case_000004_mask) := by
    rw [FirstLineAt, hfirst]
    norm_num [case_000004_firstLine, OppNegRow]
...
private theorem case_000004_checkedAtRank :
  ...
  oppMinusOneVarFirst_checkedOn case_000004_support case_000004_rank.val case_000004_rank.isLt
...
private theorem case_000004_rowsForKey :
  ...
  change OppMinusOneVarFirstRows (generatedKey .c002).support case_000004_rank.val case_000004_mask
...
theorem case_000004_candidateFacts :
    CandidateFacts .c002 498 ⟨13, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `16`. -/
private def case_000005_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000005_mask : SignMask := ⟨16, by decide⟩
private def case_000005_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000005_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tppp
private def case_000005_b : Vec3 Rat := { x := (-52/9), y := (-116/9), z := (-20/9) }
private def case_000005_firstLine : StrictLin2 := { a := -1, b := -1, c := (-55/13) }
...
private theorem case_000005_sourcePredicate :
    (generatedSpec .c004).Predicate case_000005_rank.val case_000005_mask := by
  intro hlt
  have hrank : (⟨case_000005_rank.val, hlt⟩ : Fin numPairWords) = case_000005_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c004).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c004).support case_000005_rank.val hlt case_000005_mask := by
...
private theorem case_000005_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000005_rank.val case_000005_mask
  rw [show (generatedKey .c004).support = case_000005_support by rfl]
  intro hlt
...
theorem case_000005_candidateFacts :
    CandidateFacts .c004 498 ⟨16, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `18`. -/
private def case_000006_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000006_mask : SignMask := ⟨18, by decide⟩
private def case_000006_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000006_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tppp
private def case_000006_b : Vec3 Rat := { x := (-52/9), y := (-116/9), z := (52/9) }
private def case_000006_firstLine : StrictLin2 := { a := -1, b := -1, c := (-19/13) }
...
private theorem case_000006_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000006_rank.val case_000006_mask
...
theorem case_000006_candidateFacts :
    CandidateFacts .c004 498 ⟨18, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `22`. -/
private def case_000007_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000007_mask : SignMask := ⟨22, by decide⟩
private def case_000007_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000007_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tmmm
private def case_000007_b : Vec3 Rat := { x := (-100/9), y := (-68/9), z := (100/9) }
private def case_000007_firstLine : StrictLin2 := { a := -1, b := 1, c := (-59/25) }
...
theorem case_000007_candidateFacts :
    CandidateFacts .c003 498 ⟨22, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `24`. -/
private def case_000008_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000008_mask : SignMask := ⟨24, by decide⟩
private def case_000008_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000008_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tmpp
  | ⟨13, _⟩ => Face.tppp
private def case_000008_b : Vec3 Rat := { x := (-44/27), y := (-268/27), z := (-268/27) }
private def case_000008_firstLine : StrictLin2 := { a := -1, b := -1, c := (-257/11) }
...
private theorem case_000008_rowsForKey :
  ...
  change EqEqPosVarFirstRows (generatedKey .c004).support case_000008_rank.val case_000008_mask
...
theorem case_000008_candidateFacts :
    CandidateFacts .c004 498 ⟨24, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `47`. -/
private def case_000009_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000009_mask : SignMask := ⟨47, by decide⟩
private def case_000009_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000009_seq : Step14 -> Face
  ...
  | ⟨12, _⟩ => Face.tpmm
  | ⟨13, _⟩ => Face.tmmm
private def case_000009_b : Vec3 Rat := { x := (-20/9), y := (116/9), z := (20/9) }
private def case_000009_firstLine : StrictLin2 := { a := 1, b := 1, c := 1 }
private def case_000009_secondLine : StrictLin2 := { a := (-5/26), b := (-5/26), c := (-12/13) }
...
private theorem case_000009_sourcePredicate :
    (generatedSpec .c001).Predicate case_000009_rank.val case_000009_mask := by
  intro hlt
  have hrank : (⟨case_000009_rank.val, hlt⟩ : Fin numPairWords) = case_000009_rank := by
    ext
    rfl
  ...
  have hsecond : (generatedSpec .c001).second.Holds
    ...
    simp [generatedSpec, SourcePositionSpec.Holds]
  have hsourceChecks :
      SourceChecks (generatedSpec .c001).support case_000009_rank.val hlt case_000009_mask := by
...
private theorem case_000009_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c001).support case_000009_rank.val case_000009_mask
  rw [show (generatedKey .c001).support = case_000009_support by rfl]
  intro hlt
...
theorem case_000009_candidateFacts :
    CandidateFacts .c001 498 ⟨47, by decide⟩ := by
...
/-- AP.16W shared candidate fact: rank `498`, mask `55`. -/
private def case_000010_rank : Fin numPairWords := ⟨498, by decide⟩
private def case_000010_mask : SignMask := ⟨55, by decide⟩
private def case_000010_word : PairWord := ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.dm11, PairId.d11m, PairId.d11m, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111], by decide⟩
...
private def case_000010_secondLine : StrictLin2 := { a := (-5/26), b := (-5/26), c := (-12/13) }
...
private theorem case_000010_shape :
    EqEqPosVarSecond case_000010_support case_000010_rank.val case_000010_mask := by
  intro hlt
  ...
  have case_000010_rowSecond :
      EqEqPosRow (SecondLineAt case_000010_support case_000010_rank.val hlt case_000010_mask) := by
    rw [SecondLineAt, hsecond]
    norm_num [case_000010_secondLine, EqEqPosRow]
...
private theorem case_000010_checkedAtRank :
  ...
  eqEqPosVarSecond_checkedOn case_000010_support case_000010_rank.val case_000010_rank.isLt
...
private theorem case_000010_rowsForKey :
  ...
  change EqEqPosVarSecondRows (generatedKey .c001).support case_000010_rank.val case_000010_mask
...
theorem case_000010_candidateFacts :
    CandidateFacts .c001 498 ⟨55, by decide⟩ := by
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PositiveSurvivorSharedManifestCandidateFactsShard003Smoke
