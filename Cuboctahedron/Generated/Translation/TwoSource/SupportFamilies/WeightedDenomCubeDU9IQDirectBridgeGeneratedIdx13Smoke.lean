...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx13Smoke
...
def cube10111x : MaskSubcube where
  fixed
    | SignBit.y => some true
...
private theorem poly896_11_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube10111x.Member mask) :
    poly896_11.coeffEval mask = reduced896_11.coeffEval mask := by
  have hy : maskBitForPair mask SignBit.y.toPairId = true := by
    simpa [cube10111x, MaskSubcube.Member] using hmask SignBit.y
  have hz : maskBitForPair mask SignBit.z.toPairId = false := by
    simpa [cube10111x, MaskSubcube.Member] using hmask SignBit.z
  have hd111 : maskBitForPair mask SignBit.d111.toPairId = true := by
    simpa [cube10111x, MaskSubcube.Member] using hmask SignBit.d111
  have hd11m : maskBitForPair mask SignBit.d11m.toPairId = true := by
    simpa [cube10111x, MaskSubcube.Member] using hmask SignBit.d11m
  have hd1m1 : maskBitForPair mask SignBit.d1m1.toPairId = true := by
    simpa [cube10111x, MaskSubcube.Member] using hmask SignBit.d1m1
  by_cases hdm11 : maskBitForPair mask SignBit.dm11.toPairId
  all_goals
    simp [poly896_11, reduced896_11, WalshQuadratic.coeffEval, SignBit.value, hy, hz, hd111, hd11m, hd1m1, hdm11]
    norm_num

private def reducedBound896_11 :
    WalshQuadraticReducedAbsBound cube10111x poly896_11 where
...
private def cubeBound896_11 :
    WalshQuadraticCubeBound cube10111x poly896_11 :=
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cube10111x.Member mask) :
    weightedDenomAtRank
...
theorem direct_eq
    {mask : SignMask} (hlt : rank896 < numPairWords)
    (_hmember : cube10111x.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank896, hlt⟩ : Fin numPairWords) mask weights11 =
      poly896_11.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx13Smoke
