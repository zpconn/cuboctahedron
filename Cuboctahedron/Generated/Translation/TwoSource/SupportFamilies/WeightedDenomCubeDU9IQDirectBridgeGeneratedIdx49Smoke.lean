...
import Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke
...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx49Smoke
...
abbrev generatedNormal01 : WalshAffineVec3 :=
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke.generatedNormal01
...
def cube11x0x0 : MaskSubcube where
  fixed
    | SignBit.y => some true
    | SignBit.z => some true
...
def poly903_2_12 : WalshQuadratic where
  c := 24
  y := 0
  z := 0
  d111 := 0
...
private def reduced903_2_12 : WalshQuadratic where
  c := -4
  y := 0
  z := 0
  d111 := -40/27
...
private theorem poly903_2_12_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube11x0x0.Member mask) :
    poly903_2_12.coeffEval mask = reduced903_2_12.coeffEval mask := by
  have hy : maskBitForPair mask SignBit.y.toPairId = true := by
    simpa [cube11x0x0, MaskSubcube.Member] using hmask SignBit.y
  have hz : maskBitForPair mask SignBit.z.toPairId = true := by
    simpa [cube11x0x0, MaskSubcube.Member] using hmask SignBit.z
  have hd11m : maskBitForPair mask SignBit.d11m.toPairId = false := by
    simpa [cube11x0x0, MaskSubcube.Member] using hmask SignBit.d11m
  have hdm11 : maskBitForPair mask SignBit.dm11.toPairId = false := by
    simpa [cube11x0x0, MaskSubcube.Member] using hmask SignBit.dm11
  by_cases hd111 : maskBitForPair mask SignBit.d111.toPairId
  all_goals
    by_cases hd1m1 : maskBitForPair mask SignBit.d1m1.toPairId
    all_goals
      simp [poly903_2_12, reduced903_2_12, WalshQuadratic.coeffEval, SignBit.value, hy, hz, hd11m, hdm11, hd111, hd1m1]
      norm_num

private def reducedBound903_2_12 :
    WalshQuadraticReducedAbsBound cube11x0x0 poly903_2_12 where
  reduced := reduced903_2_12
  eq_on_cube := by
    intro mask hmask
    exact poly903_2_12_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced903_2_12, WalshQuadratic.absBoundSum]

private def cubeBound903_2_12 :
    WalshQuadraticCubeBound cube11x0x0 poly903_2_12 :=
  WalshQuadraticCubeBound.leaf reducedBound903_2_12

private theorem poly903_2_12_nonpos
    {mask : SignMask} (hmask : cube11x0x0.Member mask) :
    poly903_2_12.coeffEval mask <= 0 :=
  cubeBound903_2_12.coeffEval_nonpos hmask

def reducedObstruction903_2_12
    (direct_eq :
      forall {mask : SignMask} (hlt : rank903 < numPairWords),
        cube11x0x0.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank903, hlt⟩ : Fin numPairWords) mask weights2_12 =
            poly903_2_12.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank903 cube11x0x0.Member where
  weights := weights2_12
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly903_2_12_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cube11x0x0.Member mask) :
    weightedDenomAtRank
      (⟨rank903, hlt⟩ : Fin numPairWords) mask weights2_12 <= 0 :=
  (reducedObstruction903_2_12 direct_eq).nonpos hlt hmember
...
private theorem dot01_eq :
  ...
  norm_num [dot01, generatedNormal01, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke.generatedNormal01, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke.generatedNormal01_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke.generatedNormal01_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke.generatedNormal01_z, generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank903ChainSmoke.generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank903ChainSmoke.generatedVector_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank903ChainSmoke.generatedVector_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank903ChainSmoke.generatedVector_z, WalshAffineVec3.dot, WalshQuadratic.add, WalshAffine.mul]
...
private theorem direct01_eq
    ...
    directWalshDotAtRank
        (⟨rank903, hlt⟩ : Fin numPairWords) mask (1 : WordIndex) =
  ...
  rw [← Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank903Idx01Smoke.generatedNormal01_eq]
...
private theorem direct01_eq_of_val
  ...
  rw [directWalshDotAtRank_eq_of_val
    (⟨rank903, hlt⟩ : Fin numPairWords) mask (j := (1 : WordIndex)) hi]
...
private theorem dot_sum_eval
    (mask : SignMask) :
    4 * dot01.coeffEval mask + dot11.coeffEval mask =
      poly903_2_12.coeffEval mask := by
  simp [dot01, dot11, poly903_2_12,
    WalshQuadratic.coeffEval]
  try ring_nf

theorem direct_eq
    {mask : SignMask} (hlt : rank903 < numPairWords)
    (_hmember : cube11x0x0.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank903, hlt⟩ : Fin numPairWords) mask weights2_12 =
      poly903_2_12.coeffEval mask := by
...
theorem notGoodDirection
  ...
  have hpos :
      0 <
        weightedDenomAtRank
          (⟨rank903, hlt⟩ : Fin numPairWords) mask weights2_12 :=
    weightedDenomAtRank_pos_of_goodDirection hlt weights2_12_nonnegative
      weights2_12_positive hgood
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx49Smoke
