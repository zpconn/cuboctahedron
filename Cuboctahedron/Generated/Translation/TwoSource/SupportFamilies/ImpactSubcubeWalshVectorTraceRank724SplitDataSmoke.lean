...
/-!
Generated AP16DK split Walsh-vector trace data for rank `724`.
-/
...
def generatedRank : Fin numPairWords := ⟨724, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m], by decide⟩
...
@[simp] theorem generatedWord_getFin_11 :
    Vector.get generatedWord (11 : WordIndex) = PairId.d111 := by
  rfl

@[simp] theorem generatedWord_get_11
    (h : (11 : Nat) < 13) :
    generatedWord.get ⟨11, h⟩ = PairId.d111 := by
