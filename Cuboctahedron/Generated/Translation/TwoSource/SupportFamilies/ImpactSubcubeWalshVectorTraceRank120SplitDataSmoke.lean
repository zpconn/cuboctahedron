...
/-!
Generated AP16DK split Walsh-vector trace data for rank `120`.
-/
...
def generatedRank : Fin numPairWords := ⟨120, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d11m, PairId.d11m, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.dm11], by decide⟩
