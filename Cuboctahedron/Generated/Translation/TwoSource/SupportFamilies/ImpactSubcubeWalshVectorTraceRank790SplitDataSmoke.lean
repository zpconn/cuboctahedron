...
/-!
Generated AP16DK split Walsh-vector trace data for rank `790`.
-/
...
def generatedRank : Fin numPairWords := ⟨790, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.d111, PairId.dm11, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d11m], by decide⟩
...
@[simp] theorem generatedWord_getFin_07 :
    Vector.get generatedWord (7 : WordIndex) = PairId.dm11 := by
  rfl

@[simp] theorem generatedWord_get_07
    (h : (7 : Nat) < 13) :
    generatedWord.get ⟨7, h⟩ = PairId.dm11 := by
