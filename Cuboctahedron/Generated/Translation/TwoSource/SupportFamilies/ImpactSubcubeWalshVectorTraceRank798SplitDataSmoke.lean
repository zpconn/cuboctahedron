...
/-!
Generated AP16DK split Walsh-vector trace data for rank `798`.
-/
...
def generatedRank : Fin numPairWords := ⟨798, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m, PairId.d111, PairId.dm11, PairId.dm11, PairId.d111, PairId.d11m, PairId.d1m1, PairId.d1m1], by decide⟩
...
@[simp] theorem generatedWord_getFin_10 :
    Vector.get generatedWord (10 : WordIndex) = PairId.d11m := by
  rfl

@[simp] theorem generatedWord_get_10
    (h : (10 : Nat) < 13) :
    generatedWord.get ⟨10, h⟩ = PairId.d11m := by
