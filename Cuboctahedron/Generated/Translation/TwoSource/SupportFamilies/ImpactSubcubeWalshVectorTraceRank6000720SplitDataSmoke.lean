...
/-!
Generated AP16DK split Walsh-vector trace data for rank `6000720`.
-/
...
def generatedRank : Fin numPairWords := ⟨6000720, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.d1m1, PairId.d1m1, PairId.dm11, PairId.d111, PairId.d111, PairId.dm11, PairId.d11m, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d11m], by decide⟩
...
@[simp] theorem generatedWord_get_09
    (h : (9 : Nat) < 13) :
    generatedWord.get ⟨9, h⟩ = PairId.y := by
...
@[simp] theorem generatedWord_get_10
    (h : (10 : Nat) < 13) :
    generatedWord.get ⟨10, h⟩ = PairId.z := by
...
@[simp] theorem generatedWord_getFin_11 :
    Vector.get generatedWord (11 : WordIndex) = PairId.z := by
  rfl

@[simp] theorem generatedWord_get_11
    (h : (11 : Nat) < 13) :
    generatedWord.get ⟨11, h⟩ = PairId.z := by
