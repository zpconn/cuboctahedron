...
/-!
Generated AP16DK split Walsh-vector trace data for rank `362`.
-/
...
def generatedRank : Fin numPairWords := ⟨362, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d111, PairId.d11m, PairId.dm11, PairId.dm11, PairId.d11m], by decide⟩
...
@[simp] theorem generatedWord_getFin_06 :
    Vector.get generatedWord (6 : WordIndex) = PairId.d1m1 := by
  rfl

@[simp] theorem generatedWord_get_06
    (h : (6 : Nat) < 13) :
    generatedWord.get ⟨6, h⟩ = PairId.d1m1 := by
