...
namespace Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PairSignProducerCoverageSmoke
...
Observed bounded GoodDirection cases: 1316. -/
...
Observed bounded GoodDirection cases: 547. -/
...
private def source_002_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 52 /\
      ...
      SourceIndexStateSourcePredicate
        52 0 source_002_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 339. -/
...
private def source_004_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 83 /\
      ...
      SourceIndexStateSourcePredicate
        83 0 source_004_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 123. -/
...
Observed bounded GoodDirection cases: 110. -/
...
private def source_009_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 83 /\
      ...
      SourceIndexStateSourcePredicate
        83 1 source_009_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 105. -/
...
Observed bounded GoodDirection cases: 99. -/
...
private def source_012_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 96 /\
      ...
      SourceIndexStateSourcePredicate
        96 0 source_012_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_013_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 26 /\
      ...
      SourceIndexStateSourcePredicate
        26 3 source_013_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_014_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 0 /\
      ...
      SourceIndexStateSourcePredicate
        0 12 source_014_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_015_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 0 /\
      ...
      SourceIndexStateSourcePredicate
        0 10 source_015_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_016_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 0 /\
      ...
      SourceIndexStateSourcePredicate
        0 14 source_016_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_018_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 70 /\
      ...
      SourceIndexStateSourcePredicate
        70 2 source_018_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_019_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 1 /\
      ...
      SourceIndexStateSourcePredicate
        1 15 source_019_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 77. -/
...
Observed bounded GoodDirection cases: 71. -/
...
private def source_021_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 148 /\
      ...
      SourceIndexStateSourcePredicate
        148 0 source_021_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_022_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 161 /\
      ...
      SourceIndexStateSourcePredicate
        161 0 source_022_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 66. -/
...
private def source_023_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 162 /\
      ...
      SourceIndexStateSourcePredicate
        162 0 source_023_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_024_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 70 /\
      ...
      SourceIndexStateSourcePredicate
        70 1 source_024_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_026_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 175 /\
      ...
      SourceIndexStateSourcePredicate
        175 0 source_026_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 56. -/
...
private def source_027_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 183 /\
      ...
      SourceIndexStateSourcePredicate
        183 0 source_027_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_028_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 2 /\
      ...
      SourceIndexStateSourcePredicate
        2 15 source_028_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_029_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 122 /\
      ...
      SourceIndexStateSourcePredicate
        122 0 source_029_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_030_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 2 /\
      ...
      SourceIndexStateSourcePredicate
        2 10 source_030_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_031_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 136 /\
      ...
      SourceIndexStateSourcePredicate
        136 0 source_031_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_032_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 0 /\
      ...
      SourceIndexStateSourcePredicate
        0 16 source_032_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_033_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 84 /\
      ...
      SourceIndexStateSourcePredicate
        84 0 source_033_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_034_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 109 /\
      ...
      SourceIndexStateSourcePredicate
        109 1 source_034_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_035_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 1 /\
      ...
      SourceIndexStateSourcePredicate
        1 12 source_035_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_036_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 135 /\
      ...
      SourceIndexStateSourcePredicate
        135 0 source_036_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_037_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 1 /\
      ...
      SourceIndexStateSourcePredicate
        1 13 source_037_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_039_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 2 /\
      ...
      SourceIndexStateSourcePredicate
        2 13 source_039_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_040_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 162 /\
      ...
      SourceIndexStateSourcePredicate
        162 1 source_040_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `d6809a16afa33515a0cae399eab8f4db9540c851072d74c68217031edd3d6d14`.
Observed bounded GoodDirection cases: 38. -/
...
private def source_041_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 71 /\
      ...
      SourceIndexStateSourcePredicate
        71 2 source_041_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_042_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 1 /\
      ...
      SourceIndexStateSourcePredicate
        1 14 source_042_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_043_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 110 /\
      ...
      SourceIndexStateSourcePredicate
        110 0 source_043_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_045_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 96 /\
      ...
      SourceIndexStateSourcePredicate
        96 1 source_045_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_046_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 84 /\
      ...
      SourceIndexStateSourcePredicate
        84 1 source_046_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_047_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 44 /\
      ...
      SourceIndexStateSourcePredicate
        44 5 source_047_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_048_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 1 /\
      ...
      SourceIndexStateSourcePredicate
        1 16 source_048_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `8e0f687b84f4a5abf48d359bd8382d260c5f4514f20326313b8b078ade597f06`.
...
private def source_049_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 63 /\
      ...
      SourceIndexStateSourcePredicate
        63 0 source_049_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_050_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 175 /\
      ...
      SourceIndexStateSourcePredicate
        175 1 source_050_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_051_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 97 /\
      ...
      SourceIndexStateSourcePredicate
        97 0 source_051_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_052_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 76 /\
      ...
      SourceIndexStateSourcePredicate
        76 1 source_052_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_053_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 167 /\
      ...
      SourceIndexStateSourcePredicate
        167 0 source_053_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_054_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 1 /\
      ...
      SourceIndexStateSourcePredicate
        1 11 source_054_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_055_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 161 /\
      ...
      SourceIndexStateSourcePredicate
        161 1 source_055_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_056_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 84 /\
      ...
      SourceIndexStateSourcePredicate
        84 2 source_056_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_057_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 49 /\
      ...
      SourceIndexStateSourcePredicate
        49 3 source_057_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_059_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 83 /\
      ...
      SourceIndexStateSourcePredicate
        83 2 source_059_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_060_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 149 /\
      ...
      SourceIndexStateSourcePredicate
        149 0 source_060_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_061_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 184 /\
      ...
      SourceIndexStateSourcePredicate
        184 1 source_061_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_062_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 136 /\
      ...
      SourceIndexStateSourcePredicate
        136 1 source_062_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `8599091b7fc1325edd3ba2976e505059d19bd95fc2b4d6e73927e45cb2aae4bc`.
Observed bounded GoodDirection cases: 21. -/
...
private def source_063_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 57 /\
      ...
      SourceIndexStateSourcePredicate
        57 3 source_063_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `9ccaca8cd86149c557cbe3f7d1cc91310700d44b2f174b0b108f4d63ef0a508a`.
Observed bounded GoodDirection cases: 21. -/
...
private def source_064_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 58 /\
      ...
      SourceIndexStateSourcePredicate
        58 0 source_064_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_065_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 103 /\
      ...
      SourceIndexStateSourcePredicate
        103 0 source_065_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_066_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 123 /\
      ...
      SourceIndexStateSourcePredicate
        123 0 source_066_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_067_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 122 /\
      ...
      SourceIndexStateSourcePredicate
        122 1 source_067_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_068_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 2 /\
      ...
      SourceIndexStateSourcePredicate
        2 11 source_068_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_069_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 95 /\
      ...
      SourceIndexStateSourcePredicate
        95 0 source_069_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_071_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 149 /\
      ...
      SourceIndexStateSourcePredicate
        149 1 source_071_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
/-- Source producer `bf4457e78be6e2bd999099a6b538a4a3f151a71d52337e94ecbec0a109054a06`.
Observed bounded GoodDirection cases: 15. -/
...
private def source_073_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 92 /\
      ...
      SourceIndexStateSourcePredicate
        92 1 source_073_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_074_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 5 /\
      ...
      SourceIndexStateSourcePredicate
        5 8 source_074_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `011ae653c893a615ca51ac92d56e9e6ba083d459e450fab5a4ed573475b4f5eb`.
...
private def source_075_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 57 /\
      ...
      SourceIndexStateSourcePredicate
        57 0 source_075_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_076_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 147 /\
      ...
      SourceIndexStateSourcePredicate
        147 0 source_076_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_077_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 83 /\
      ...
      SourceIndexStateSourcePredicate
        83 3 source_077_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_078_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 119 /\
      ...
      SourceIndexStateSourcePredicate
        119 0 source_078_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_079_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 115 /\
      ...
      SourceIndexStateSourcePredicate
        115 0 source_079_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `dd1030dd6ac72086ff02e024b50f92c097bc3161a9f731dae500af923f2c349c`.
Observed bounded GoodDirection cases: 13. -/
...
private def source_080_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 106 /\
      ...
      SourceIndexStateSourcePredicate
        106 0 source_080_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_081_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 109 /\
      ...
      SourceIndexStateSourcePredicate
        109 2 source_081_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_082_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 148 /\
      ...
      SourceIndexStateSourcePredicate
        148 1 source_082_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_083_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 96 /\
      ...
      SourceIndexStateSourcePredicate
        96 2 source_083_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_084_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 105 /\
      ...
      SourceIndexStateSourcePredicate
        105 0 source_084_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_085_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 121 /\
      ...
      SourceIndexStateSourcePredicate
        121 0 source_085_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_086_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 136 /\
      ...
      SourceIndexStateSourcePredicate
        136 2 source_086_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_087_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 84 /\
      ...
      SourceIndexStateSourcePredicate
        84 3 source_087_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_088_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 141 /\
      ...
      SourceIndexStateSourcePredicate
        141 0 source_088_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_089_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 107 /\
      ...
      SourceIndexStateSourcePredicate
        107 0 source_089_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_091_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 95 /\
      ...
      SourceIndexStateSourcePredicate
        95 2 source_091_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_093_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 3 /\
      ...
      SourceIndexStateSourcePredicate
        3 11 source_093_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_094_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 110 /\
      ...
      SourceIndexStateSourcePredicate
        110 1 source_094_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `6a5c441fd6f0f613f3eda6282054a2e10107f5d93bc7261e2dbcc875f69e755a`.
...
private def source_095_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 44 /\
      ...
      SourceIndexStateSourcePredicate
        44 0 source_095_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_096_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 170 /\
      ...
      SourceIndexStateSourcePredicate
        170 1 source_096_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_097_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 2 /\
      ...
      SourceIndexStateSourcePredicate
        2 16 source_097_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_098_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 3 /\
      ...
      SourceIndexStateSourcePredicate
        3 15 source_098_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_099_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 70 /\
      ...
      SourceIndexStateSourcePredicate
        70 4 source_099_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `54f218d927bf9a0ae5575a44d7ad195dbe7eb01181c86c3fbfc3f21294f8b5b1`.
...
private def source_100_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 79 /\
      ...
      SourceIndexStateSourcePredicate
        79 2 source_100_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_101_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 136 /\
      ...
      SourceIndexStateSourcePredicate
        136 3 source_101_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_102_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 135 /\
      ...
      SourceIndexStateSourcePredicate
        135 2 source_102_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `cfbd7318451fe6fba6edef2bded091dadff38ad8262057231002b05781fabb12`.
Observed bounded GoodDirection cases: 6. -/
...
private def source_103_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 69 /\
      ...
      SourceIndexStateSourcePredicate
        69 0 source_103_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_104_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 162 /\
      ...
      SourceIndexStateSourcePredicate
        162 3 source_104_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_105_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 3 /\
      ...
      SourceIndexStateSourcePredicate
        3 10 source_105_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_106_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 131 /\
      ...
      SourceIndexStateSourcePredicate
        131 0 source_106_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_107_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 129 /\
      ...
      SourceIndexStateSourcePredicate
        129 0 source_107_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_108_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 175 /\
      ...
      SourceIndexStateSourcePredicate
        175 3 source_108_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_109_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 175 /\
      ...
      SourceIndexStateSourcePredicate
        175 2 source_109_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_110_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 156 /\
      ...
      SourceIndexStateSourcePredicate
        156 1 source_110_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_111_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 122 /\
      ...
      SourceIndexStateSourcePredicate
        122 2 source_111_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_112_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 92 /\
      ...
      SourceIndexStateSourcePredicate
        92 3 source_112_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_113_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 148 /\
      ...
      SourceIndexStateSourcePredicate
        148 2 source_113_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_114_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 101 /\
      ...
      SourceIndexStateSourcePredicate
        101 4 source_114_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_115_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 3 /\
      ...
      SourceIndexStateSourcePredicate
        3 12 source_115_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_116_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 16 /\
      ...
      SourceIndexStateSourcePredicate
        16 5 source_116_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_117_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 94 /\
      ...
      SourceIndexStateSourcePredicate
        94 1 source_117_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_118_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 128 /\
      ...
      SourceIndexStateSourcePredicate
        128 3 source_118_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `152ee16b2dbbf706363edc213ea2ae598d3a579a8ffbf18feae466e7931e948e`.
...
private def source_120_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 144 /\
      ...
      SourceIndexStateSourcePredicate
        144 1 source_120_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_121_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 107 /\
      ...
      SourceIndexStateSourcePredicate
        107 2 source_121_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_122_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 97 /\
      ...
      SourceIndexStateSourcePredicate
        97 3 source_122_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_123_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 132 /\
      ...
      SourceIndexStateSourcePredicate
        132 0 source_123_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_124_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 110 /\
      ...
      SourceIndexStateSourcePredicate
        110 3 source_124_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_125_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 3 /\
      ...
      SourceIndexStateSourcePredicate
        3 13 source_125_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_126_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 120 /\
      ...
      SourceIndexStateSourcePredicate
        120 1 source_126_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_127_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 135 /\
      ...
      SourceIndexStateSourcePredicate
        135 3 source_127_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_128_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 106 /\
      ...
      SourceIndexStateSourcePredicate
        106 1 source_128_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `d896c956a1267875440cc616ccaefa8b2692396a5de18040633a40aaba830b5c`.
Observed bounded GoodDirection cases: 3. -/
...
private def source_129_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 172 /\
      ...
      SourceIndexStateSourcePredicate
        172 0 source_129_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `da53f4ea22c91f2b8c6e0ed77d80742d484d15f1fb806da3de394a5404b859dd`.
Observed bounded GoodDirection cases: 3. -/
...
private def source_130_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 116 /\
      ...
      SourceIndexStateSourcePredicate
        116 1 source_130_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_131_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 142 /\
      ...
      SourceIndexStateSourcePredicate
        142 1 source_131_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `4181f0ba7dcce281e2868112d0cb6f0bc5f79724edfc4940079d7061c26e30b1`.
...
private def source_132_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 146 /\
      ...
      SourceIndexStateSourcePredicate
        146 0 source_132_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_133_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 157 /\
      ...
      SourceIndexStateSourcePredicate
        157 0 source_133_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_134_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 161 /\
      ...
      SourceIndexStateSourcePredicate
        161 2 source_134_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_135_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 167 /\
      ...
      SourceIndexStateSourcePredicate
        167 2 source_135_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_136_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 4 /\
      ...
      SourceIndexStateSourcePredicate
        4 12 source_136_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_137_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 166 /\
      ...
      SourceIndexStateSourcePredicate
        166 10 source_137_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_138_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 133 /\
      ...
      SourceIndexStateSourcePredicate
        133 0 source_138_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_139_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 152 /\
      ...
      SourceIndexStateSourcePredicate
        152 9 source_139_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_140_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 118 /\
      ...
      SourceIndexStateSourcePredicate
        118 1 source_140_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_141_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 160 /\
      ...
      SourceIndexStateSourcePredicate
        160 9 source_141_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_142_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 129 /\
      ...
      SourceIndexStateSourcePredicate
        129 2 source_142_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_143_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 175 /\
      ...
      SourceIndexStateSourcePredicate
        175 6 source_143_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_144_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 149 /\
      ...
      SourceIndexStateSourcePredicate
        149 2 source_144_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `e93af0ba63563d455eefd927f703722dd00bf61dc0e8c5b554d860203f33134a`.
Observed bounded GoodDirection cases: 2. -/
...
private def source_145_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 171 /\
      ...
      SourceIndexStateSourcePredicate
        171 0 source_145_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_146_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 123 /\
      ...
      SourceIndexStateSourcePredicate
        123 1 source_146_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_147_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 4 /\
      ...
      SourceIndexStateSourcePredicate
        4 13 source_147_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_148_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 145 /\
      ...
      SourceIndexStateSourcePredicate
        145 0 source_148_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_149_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 99 /\
      ...
      SourceIndexStateSourcePredicate
        99 7 source_149_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_150_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 130 /\
      ...
      SourceIndexStateSourcePredicate
        130 1 source_150_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `fff3e849baef0de482d1b523f2abc6bb69927ab0c74388f4a85696a09a9d85f3`.
Observed bounded GoodDirection cases: 2. -/
...
private def source_152_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 100 /\
      ...
      SourceIndexStateSourcePredicate
        100 9 source_152_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_153_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 96 /\
      ...
      SourceIndexStateSourcePredicate
        96 3 source_153_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_154_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 182 /\
      ...
      SourceIndexStateSourcePredicate
        182 9 source_154_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `0ccb3b3be7878e707e80bae612d415a03fed23c684f7b3bbdd7a875fd3071b0f`.
Observed bounded GoodDirection cases: 1. -/
...
private def source_155_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 143 /\
      ...
      SourceIndexStateSourcePredicate
        143 0 source_155_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_156_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 16 /\
      ...
      SourceIndexStateSourcePredicate
        16 10 source_156_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_157_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 14 /\
      ...
      SourceIndexStateSourcePredicate
        14 7 source_157_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `264cfb935745e916f8cf2f76925ef0200f34891fee60b86f2159ea131eb5041c`.
Observed bounded GoodDirection cases: 1. -/
...
private def source_158_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 48 /\
      ...
      SourceIndexStateSourcePredicate
        48 2 source_158_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_159_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 150 /\
      ...
      SourceIndexStateSourcePredicate
        150 9 source_159_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_160_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 38 /\
      ...
      SourceIndexStateSourcePredicate
        38 9 source_160_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_161_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 15 /\
      ...
      SourceIndexStateSourcePredicate
        15 9 source_161_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_162_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 82 /\
      ...
      SourceIndexStateSourcePredicate
        82 1 source_162_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_164_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 149 /\
      ...
      SourceIndexStateSourcePredicate
        149 3 source_164_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_165_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 138 /\
      ...
      SourceIndexStateSourcePredicate
        138 8 source_165_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_166_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 165 /\
      ...
      SourceIndexStateSourcePredicate
        165 4 source_166_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_167_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 159 /\
      ...
      SourceIndexStateSourcePredicate
        159 2 source_167_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_168_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 155 /\
      ...
      SourceIndexStateSourcePredicate
        155 0 source_168_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_169_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 144 /\
      ...
      SourceIndexStateSourcePredicate
        144 1 source_169_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_170_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 4 /\
      ...
      SourceIndexStateSourcePredicate
        4 11 source_170_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_171_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 151 /\
      ...
      SourceIndexStateSourcePredicate
        151 8 source_171_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_172_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 131 /\
      ...
      SourceIndexStateSourcePredicate
        131 2 source_172_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_173_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 166 /\
      ...
      SourceIndexStateSourcePredicate
        166 12 source_173_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_174_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 169 /\
      ...
      SourceIndexStateSourcePredicate
        169 2 source_174_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_175_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 126 /\
      ...
      SourceIndexStateSourcePredicate
        126 9 source_175_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2

/-- Source producer `882b49b12a59ca13a1d381f35893da77b333846186729b8a3890e9797f21034c`.
Observed bounded GoodDirection cases: 1. -/
...
private def source_176_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 128 /\
      ...
      SourceIndexStateSourcePredicate
        128 1 source_176_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_177_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 4 /\
      ...
      SourceIndexStateSourcePredicate
        4 14 source_177_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_178_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 131 /\
      ...
      SourceIndexStateSourcePredicate
        131 0 source_178_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_179_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 125 /\
      ...
      SourceIndexStateSourcePredicate
        125 8 source_179_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_180_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 85 /\
      ...
      SourceIndexStateSourcePredicate
        85 8 source_180_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_181_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 143 /\
      ...
      SourceIndexStateSourcePredicate
        143 2 source_181_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_182_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 6 /\
      ...
      SourceIndexStateSourcePredicate
        6 12 source_182_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_183_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 119 /\
      ...
      SourceIndexStateSourcePredicate
        119 2 source_183_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_184_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 4 /\
      ...
      SourceIndexStateSourcePredicate
        4 15 source_184_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_185_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 15 /\
      ...
      SourceIndexStateSourcePredicate
        15 7 source_185_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_186_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 7 /\
      ...
      SourceIndexStateSourcePredicate
        7 11 source_186_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_187_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 3 /\
      ...
      SourceIndexStateSourcePredicate
        3 14 source_187_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_188_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 115 /\
      ...
      SourceIndexStateSourcePredicate
        115 10 source_188_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_189_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 132 /\
      ...
      SourceIndexStateSourcePredicate
        132 1 source_189_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
private def source_190_producer : SourceIndexStateSourceProducer where
  Applies := fun key r mask =>
    key.firstIndex = 163 /\
      ...
      SourceIndexStateSourcePredicate
        163 7 source_190_support r mask
  sourceFacts := by
    intro key r mask h
    exact SourceIndexStateSourceFacts.of_sourcePredicate
      h.1 h.2.1 h.2.2.1 h.2.2.2
...
Observed bounded GoodDirection cases: 3148. -/
...
Observed bounded GoodDirection cases: 1302. -/
...
Observed bounded GoodDirection cases: 955. -/
...
Observed bounded GoodDirection cases: 721. -/
...
Observed bounded GoodDirection cases: 406. -/
...
Observed bounded GoodDirection cases: 258. -/
...
Observed bounded GoodDirection cases: 197. -/
...
Observed representative GoodDirection cases: 1316. -/
...
Observed representative GoodDirection cases: 547. -/
...
Observed representative GoodDirection cases: 339. -/
...
Observed representative GoodDirection cases: 283. -/
...
theorem fam_004_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_004_key.support r mask) :
    row_000_producer.Applies fam_004_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 271. -/
...
Observed representative GoodDirection cases: 128. -/
...
theorem fam_007_rowApplies_of_rows
    ...
    row_002_producer.Applies fam_007_key r mask := by
  unfold row_002_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 123. -/
...
Observed representative GoodDirection cases: 110. -/
...
theorem fam_009_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_009_key.support r mask) :
    row_001_producer.Applies fam_009_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 107. -/
...
Observed representative GoodDirection cases: 105. -/
...
Observed representative GoodDirection cases: 99. -/
...
theorem fam_012_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_012_key.support r mask) :
    row_000_producer.Applies fam_012_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_013_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_013_key.support r mask) :
    row_006_producer.Applies fam_013_key r mask := by
...
theorem fam_014_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        0 10 source_015_support r mask) :
    source_015_producer.Applies fam_014_key r mask := by
  unfold source_015_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_014_key, fam_014_support, source_015_support],
    hsource⟩⟩⟩
...
theorem fam_015_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        0 12 source_014_support r mask) :
    source_014_producer.Applies fam_015_key r mask := by
  unfold source_014_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_015_key, fam_015_support, source_014_support],
    hsource⟩⟩⟩

theorem fam_015_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarSecondRows fam_015_key.support r mask) :
    row_002_producer.Applies fam_015_key r mask := by
  unfold row_002_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 91. -/
...
Observed representative GoodDirection cases: 86. -/
...
theorem fam_018_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_018_key.support r mask) :
    row_003_producer.Applies fam_018_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 78. -/
...
Observed representative GoodDirection cases: 77. -/
...
Observed representative GoodDirection cases: 71. -/
...
Observed representative GoodDirection cases: 66. -/
...
Observed representative GoodDirection cases: 64. -/
...
theorem fam_024_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_024_key.support r mask) :
    row_001_producer.Applies fam_024_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_025_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarSecondRows fam_025_key.support r mask) :
    row_004_producer.Applies fam_025_key r mask := by
  unfold row_004_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 56. -/
...
theorem fam_031_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        84 0 source_033_support r mask) :
    source_033_producer.Applies fam_031_key r mask := by
  unfold source_033_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_031_key, fam_031_support, source_033_support],
    hsource⟩⟩⟩
...
theorem fam_032_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        136 0 source_031_support r mask) :
    source_031_producer.Applies fam_032_key r mask := by
  unfold source_031_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_032_key, fam_032_support, source_031_support],
    hsource⟩⟩⟩
...
theorem fam_033_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        0 16 source_032_support r mask) :
    source_032_producer.Applies fam_033_key r mask := by
  unfold source_032_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_033_key, fam_033_support, source_032_support],
    hsource⟩⟩⟩
...
theorem fam_034_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        109 1 source_034_support r mask) :
    source_034_producer.Applies fam_034_key r mask := by
  unfold source_034_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_034_key, fam_034_support, source_034_support],
    hsource⟩⟩⟩
...
theorem fam_035_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        135 0 source_036_support r mask) :
    source_036_producer.Applies fam_035_key r mask := by
  unfold source_036_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_035_key, fam_035_support, source_036_support],
    hsource⟩⟩⟩
...
theorem fam_036_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        1 12 source_035_support r mask) :
    source_035_producer.Applies fam_036_key r mask := by
  unfold source_035_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_036_key, fam_036_support, source_035_support],
    hsource⟩⟩⟩
...
theorem fam_037_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarSecondRows fam_037_key.support r mask) :
    row_004_producer.Applies fam_037_key r mask := by
  unfold row_004_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 39. -/
...
theorem fam_039_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        162 1 source_040_support r mask) :
    source_040_producer.Applies fam_039_key r mask := by
  unfold source_040_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_039_key, fam_039_support, source_040_support],
    hsource⟩⟩⟩

theorem fam_039_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_039_key.support r mask) :
    row_001_producer.Applies fam_039_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `04d07b4e792e9cf481fc622e9847fc20970197fe495f824977bd4e58553f16cc`.
Observed representative GoodDirection cases: 38. -/
...
theorem fam_040_rowApplies_of_rows
    ...
    row_003_producer.Applies fam_040_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_041_sourceApplies_of_sourcePredicate
  ...
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_041_key, fam_041_support, source_039_support],
    hsource⟩⟩⟩
...
Observed representative GoodDirection cases: 37. -/
...
theorem fam_042_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarSecondRows fam_042_key.support r mask) :
    row_004_producer.Applies fam_042_key r mask := by
  unfold row_004_producer
  exact ⟨rfl, hrows⟩
...
Observed representative GoodDirection cases: 33. -/
...
theorem fam_045_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_045_key.support r mask) :
    row_001_producer.Applies fam_045_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_047_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        1 16 source_048_support r mask) :
    source_048_producer.Applies fam_047_key r mask := by
  unfold source_048_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_047_key, fam_047_support, source_048_support],
    hsource⟩⟩⟩

theorem fam_047_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarSecondRows fam_047_key.support r mask) :
    row_004_producer.Applies fam_047_key r mask := by
  unfold row_004_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `851d88021afe185a12c0337735c732da704cf4df00848f6304e68971ac244866`.
...
theorem fam_048_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        63 0 source_049_support r mask) :
    source_049_producer.Applies fam_048_key r mask := by
  unfold source_049_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_048_key, fam_048_support, source_049_support],
    hsource⟩⟩⟩

theorem fam_048_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_048_key.support r mask) :
    row_000_producer.Applies fam_048_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_050_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_050_key.support r mask) :
    row_000_producer.Applies fam_050_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_051_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        76 1 source_052_support r mask) :
    source_052_producer.Applies fam_051_key r mask := by
  unfold source_052_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_051_key, fam_051_support, source_052_support],
    hsource⟩⟩⟩
...
Observed representative GoodDirection cases: 24. -/
...
theorem fam_052_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        167 0 source_053_support r mask) :
    source_053_producer.Applies fam_052_key r mask := by
  unfold source_053_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_052_key, fam_052_support, source_053_support],
    hsource⟩⟩⟩
...
theorem fam_053_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        161 1 source_055_support r mask) :
    source_055_producer.Applies fam_053_key r mask := by
  unfold source_055_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_053_key, fam_053_support, source_055_support],
    hsource⟩⟩⟩

theorem fam_053_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_053_key.support r mask) :
    row_001_producer.Applies fam_053_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_054_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarSecondRows fam_054_key.support r mask) :
    row_004_producer.Applies fam_054_key r mask := by
  unfold row_004_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_055_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        49 3 source_057_support r mask) :
    source_057_producer.Applies fam_055_key r mask := by
  unfold source_057_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_055_key, fam_055_support, source_057_support],
    hsource⟩⟩⟩

theorem fam_055_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_055_key.support r mask) :
    row_006_producer.Applies fam_055_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_056_rowApplies_of_rows
    ...
    row_003_producer.Applies fam_056_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_057_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarSecondRows fam_057_key.support r mask) :
    row_005_producer.Applies fam_057_key r mask := by
  unfold row_005_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_058_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        149 0 source_060_support r mask) :
    source_060_producer.Applies fam_058_key r mask := by
  unfold source_060_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_058_key, fam_058_support, source_060_support],
    hsource⟩⟩⟩

theorem fam_058_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_058_key.support r mask) :
    row_000_producer.Applies fam_058_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_059_sourceApplies_of_sourcePredicate
  ...
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_059_key, fam_059_support, source_059_support],
    hsource⟩⟩⟩

theorem fam_059_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_059_key.support r mask) :
    row_003_producer.Applies fam_059_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `802364c20465a9328147000d42c4e86125b5e1b85f849646c163b4dae9b3b19b`.
...
theorem fam_060_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        57 3 source_063_support r mask) :
    source_063_producer.Applies fam_060_key r mask := by
  unfold source_063_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_060_key, fam_060_support, source_063_support],
    hsource⟩⟩⟩

theorem fam_060_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_060_key.support r mask) :
    row_006_producer.Applies fam_060_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `a05a26da50f840a31417267dd2c46c126f87b2e0548ae9b718309ec3a25e9106`.
Observed representative GoodDirection cases: 21. -/
...
theorem fam_061_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        58 0 source_064_support r mask) :
    source_064_producer.Applies fam_061_key r mask := by
  unfold source_064_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_061_key, fam_061_support, source_064_support],
    hsource⟩⟩⟩
...
theorem fam_062_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        136 1 source_062_support r mask) :
    source_062_producer.Applies fam_062_key r mask := by
  unfold source_062_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_062_key, fam_062_support, source_062_support],
    hsource⟩⟩⟩
...
theorem fam_063_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        184 1 source_061_support r mask) :
    source_061_producer.Applies fam_063_key r mask := by
  unfold source_061_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_063_key, fam_063_support, source_061_support],
    hsource⟩⟩⟩

theorem fam_063_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_063_key.support r mask) :
    row_001_producer.Applies fam_063_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_064_sourceApplies_of_sourcePredicate
  ...
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_064_key, fam_064_support, source_065_support],
    hsource⟩⟩⟩
...
theorem fam_065_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        123 0 source_066_support r mask) :
    source_066_producer.Applies fam_065_key r mask := by
  unfold source_066_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_065_key, fam_065_support, source_066_support],
    hsource⟩⟩⟩
...
theorem fam_066_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        122 1 source_067_support r mask) :
    source_067_producer.Applies fam_066_key r mask := by
  unfold source_067_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_066_key, fam_066_support, source_067_support],
    hsource⟩⟩⟩

theorem fam_066_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_066_key.support r mask) :
    row_001_producer.Applies fam_066_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_067_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        2 11 source_068_support r mask) :
    source_068_producer.Applies fam_067_key r mask := by
  unfold source_068_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_067_key, fam_067_support, source_068_support],
    hsource⟩⟩⟩

theorem fam_067_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarSecondRows fam_067_key.support r mask) :
    row_005_producer.Applies fam_067_key r mask := by
  unfold row_005_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_068_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        95 0 source_069_support r mask) :
    source_069_producer.Applies fam_068_key r mask := by
  unfold source_069_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_068_key, fam_068_support, source_069_support],
    hsource⟩⟩⟩

theorem fam_068_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_068_key.support r mask) :
    row_000_producer.Applies fam_068_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_069_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        135 1 source_070_support r mask) :
    source_070_producer.Applies fam_069_key r mask := by
  unfold source_070_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_069_key, fam_069_support, source_070_support],
    hsource⟩⟩⟩
...
theorem fam_070_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        149 1 source_071_support r mask) :
    source_071_producer.Applies fam_070_key r mask := by
  unfold source_071_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_070_key, fam_070_support, source_071_support],
    hsource⟩⟩⟩
...
/-- Pair-sign producer coverage key `4db3cf9f18eeafbe72a79585ad52ee73c3d4fd405e77045d0035b39b71340b9c`.
Observed representative GoodDirection cases: 15. -/
...
theorem fam_071_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        92 1 source_073_support r mask) :
    source_073_producer.Applies fam_071_key r mask := by
  unfold source_073_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_071_key, fam_071_support, source_073_support],
    hsource⟩⟩⟩

theorem fam_071_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_071_key.support r mask) :
    row_001_producer.Applies fam_071_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_072_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        162 2 source_072_support r mask) :
    source_072_producer.Applies fam_072_key r mask := by
  unfold source_072_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_072_key, fam_072_support, source_072_support],
    hsource⟩⟩⟩
...
theorem fam_073_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        83 3 source_077_support r mask) :
    source_077_producer.Applies fam_073_key r mask := by
  unfold source_077_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_073_key, fam_073_support, source_077_support],
    hsource⟩⟩⟩

theorem fam_073_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_073_key.support r mask) :
    row_006_producer.Applies fam_073_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_074_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        119 0 source_078_support r mask) :
    source_078_producer.Applies fam_074_key r mask := by
  unfold source_078_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_074_key, fam_074_support, source_078_support],
    hsource⟩⟩⟩

theorem fam_074_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_074_key.support r mask) :
    row_000_producer.Applies fam_074_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `5481126105e4b34e09adf23d8cd55515392cb4e016d6daf98497bf4050d0d8eb`.
Observed representative GoodDirection cases: 14. -/
...
theorem fam_076_sourceApplies_of_sourcePredicate
  ...
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_076_key, fam_076_support, source_075_support],
    hsource⟩⟩⟩
...
theorem fam_077_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        115 0 source_079_support r mask) :
    source_079_producer.Applies fam_077_key r mask := by
  unfold source_079_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_077_key, fam_077_support, source_079_support],
    hsource⟩⟩⟩

theorem fam_077_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_077_key.support r mask) :
    row_000_producer.Applies fam_077_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `d5b37784035b793cceab65dbcceeea8298be3921112d07e76996ba0c41227fc3`.
Observed representative GoodDirection cases: 13. -/
...
theorem fam_078_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        106 0 source_080_support r mask) :
    source_080_producer.Applies fam_078_key r mask := by
  unfold source_080_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_078_key, fam_078_support, source_080_support],
    hsource⟩⟩⟩

theorem fam_078_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_078_key.support r mask) :
    row_000_producer.Applies fam_078_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_079_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_079_key.support r mask) :
    row_003_producer.Applies fam_079_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_080_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        105 0 source_084_support r mask) :
    source_084_producer.Applies fam_080_key r mask := by
  unfold source_084_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_080_key, fam_080_support, source_084_support],
    hsource⟩⟩⟩

theorem fam_080_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_080_key.support r mask) :
    row_000_producer.Applies fam_080_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_081_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        148 1 source_082_support r mask) :
    source_082_producer.Applies fam_081_key r mask := by
  unfold source_082_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_081_key, fam_081_support, source_082_support],
    hsource⟩⟩⟩

theorem fam_081_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_081_key.support r mask) :
    row_001_producer.Applies fam_081_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_082_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_082_key.support r mask) :
    row_003_producer.Applies fam_082_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_083_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        121 0 source_085_support r mask) :
    source_085_producer.Applies fam_083_key r mask := by
  unfold source_085_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_083_key, fam_083_support, source_085_support],
    hsource⟩⟩⟩
...
theorem fam_084_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        5 8 source_074_support r mask) :
    source_074_producer.Applies fam_084_key r mask := by
  unfold source_074_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_084_key, fam_084_support, source_074_support],
    hsource⟩⟩⟩

theorem fam_084_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_084_key.support r mask) :
    row_010_producer.Applies fam_084_key r mask := by
...
theorem fam_085_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        44 5 source_047_support r mask) :
    source_047_producer.Applies fam_085_key r mask := by
  unfold source_047_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_085_key, fam_085_support, source_047_support],
    hsource⟩⟩⟩

theorem fam_085_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_085_key.support r mask) :
    row_009_producer.Applies fam_085_key r mask := by
...
theorem fam_086_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_086_key.support r mask) :
    row_006_producer.Applies fam_086_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_087_sourceApplies_of_sourcePredicate
  ...
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_087_key, fam_087_support, source_086_support],
    hsource⟩⟩⟩

theorem fam_087_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_087_key.support r mask) :
    row_003_producer.Applies fam_087_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_088_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        44 5 source_047_support r mask) :
    source_047_producer.Applies fam_088_key r mask := by
  unfold source_047_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_088_key, fam_088_support, source_047_support],
    hsource⟩⟩⟩

theorem fam_088_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_088_key.support r mask) :
    row_011_producer.Applies fam_088_key r mask := by
...
theorem fam_089_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        141 0 source_088_support r mask) :
    source_088_producer.Applies fam_089_key r mask := by
  unfold source_088_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_089_key, fam_089_support, source_088_support],
    hsource⟩⟩⟩

theorem fam_089_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_089_key.support r mask) :
    row_000_producer.Applies fam_089_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_090_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        107 0 source_089_support r mask) :
    source_089_producer.Applies fam_090_key r mask := by
  unfold source_089_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_090_key, fam_090_support, source_089_support],
    hsource⟩⟩⟩
...
theorem fam_091_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        110 2 source_090_support r mask) :
    source_090_producer.Applies fam_091_key r mask := by
  unfold source_090_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_091_key, fam_091_support, source_090_support],
    hsource⟩⟩⟩

theorem fam_091_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_091_key.support r mask) :
    row_003_producer.Applies fam_091_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_092_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        3 11 source_093_support r mask) :
    source_093_producer.Applies fam_092_key r mask := by
  unfold source_093_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_092_key, fam_092_support, source_093_support],
    hsource⟩⟩⟩

theorem fam_092_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_092_key.support r mask) :
    row_007_producer.Applies fam_092_key r mask := by
...
theorem fam_093_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        110 1 source_094_support r mask) :
    source_094_producer.Applies fam_093_key r mask := by
  unfold source_094_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_093_key, fam_093_support, source_094_support],
    hsource⟩⟩⟩
...
theorem fam_094_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        168 1 source_092_support r mask) :
    source_092_producer.Applies fam_094_key r mask := by
  unfold source_092_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_094_key, fam_094_support, source_092_support],
    hsource⟩⟩⟩

theorem fam_094_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_094_key.support r mask) :
    row_001_producer.Applies fam_094_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_095_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        95 2 source_091_support r mask) :
    source_091_producer.Applies fam_095_key r mask := by
  unfold source_091_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_095_key, fam_095_support, source_091_support],
    hsource⟩⟩⟩
...
theorem fam_096_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        70 4 source_099_support r mask) :
    source_099_producer.Applies fam_096_key r mask := by
  unfold source_099_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_096_key, fam_096_support, source_099_support],
    hsource⟩⟩⟩

theorem fam_096_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_096_key.support r mask) :
    row_009_producer.Applies fam_096_key r mask := by
  unfold row_009_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `0821344f96583eaf3b3ca5e79f92ef028726b7bdbed9af709f2081ee12234e79`.
Observed representative GoodDirection cases: 7. -/
...
theorem fam_098_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        44 0 source_095_support r mask) :
    source_095_producer.Applies fam_098_key r mask := by
  unfold source_095_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_098_key, fam_098_support, source_095_support],
    hsource⟩⟩⟩

theorem fam_098_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_098_key.support r mask) :
    row_000_producer.Applies fam_098_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_099_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        170 1 source_096_support r mask) :
    source_096_producer.Applies fam_099_key r mask := by
  unfold source_096_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_099_key, fam_099_support, source_096_support],
    hsource⟩⟩⟩

theorem fam_099_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_099_key.support r mask) :
    row_001_producer.Applies fam_099_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_100_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        2 16 source_097_support r mask) :
    source_097_producer.Applies fam_100_key r mask := by
  unfold source_097_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_100_key, fam_100_support, source_097_support],
    hsource⟩⟩⟩

theorem fam_100_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarSecondRows fam_100_key.support r mask) :
    row_005_producer.Applies fam_100_key r mask := by
  unfold row_005_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_101_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        44 5 source_047_support r mask) :
    source_047_producer.Applies fam_101_key r mask := by
  unfold source_047_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_101_key, fam_101_support, source_047_support],
    hsource⟩⟩⟩

theorem fam_101_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_101_key.support r mask) :
    row_013_producer.Applies fam_101_key r mask := by
...
theorem fam_102_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        162 3 source_104_support r mask) :
    source_104_producer.Applies fam_102_key r mask := by
  unfold source_104_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_102_key, fam_102_support, source_104_support],
    hsource⟩⟩⟩

theorem fam_102_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_102_key.support r mask) :
    row_006_producer.Applies fam_102_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_103_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        136 3 source_101_support r mask) :
    source_101_producer.Applies fam_103_key r mask := by
  unfold source_101_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_103_key, fam_103_support, source_101_support],
    hsource⟩⟩⟩

theorem fam_103_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_103_key.support r mask) :
    row_006_producer.Applies fam_103_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_104_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        3 10 source_105_support r mask) :
    source_105_producer.Applies fam_104_key r mask := by
  unfold source_105_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_104_key, fam_104_support, source_105_support],
    hsource⟩⟩⟩

theorem fam_104_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_104_key.support r mask) :
    row_007_producer.Applies fam_104_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `9e625379e636c46abdc5141f46aee75b731e027ee5d6da26f48074927e43315d`.
Observed representative GoodDirection cases: 6. -/
...
theorem fam_105_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        69 0 source_103_support r mask) :
    source_103_producer.Applies fam_105_key r mask := by
  unfold source_103_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_105_key, fam_105_support, source_103_support],
    hsource⟩⟩⟩

theorem fam_105_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_105_key.support r mask) :
    row_000_producer.Applies fam_105_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `0c3de529ae6cbd8e8999b726b1c60544c2e24d3ef25521c83e2316fa948c4d9e`.
Observed representative GoodDirection cases: 6. -/
...
theorem fam_106_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        79 2 source_100_support r mask) :
    source_100_producer.Applies fam_106_key r mask := by
  unfold source_100_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_106_key, fam_106_support, source_100_support],
    hsource⟩⟩⟩

theorem fam_106_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_106_key.support r mask) :
    row_003_producer.Applies fam_106_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_107_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        135 2 source_102_support r mask) :
    source_102_producer.Applies fam_107_key r mask := by
  unfold source_102_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_107_key, fam_107_support, source_102_support],
    hsource⟩⟩⟩

theorem fam_107_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_107_key.support r mask) :
    row_003_producer.Applies fam_107_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_108_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        175 3 source_108_support r mask) :
    source_108_producer.Applies fam_108_key r mask := by
  unfold source_108_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_108_key, fam_108_support, source_108_support],
    hsource⟩⟩⟩

theorem fam_108_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_108_key.support r mask) :
    row_006_producer.Applies fam_108_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_109_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        131 0 source_106_support r mask) :
    source_106_producer.Applies fam_109_key r mask := by
  unfold source_106_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_109_key, fam_109_support, source_106_support],
    hsource⟩⟩⟩
...
theorem fam_110_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        129 0 source_107_support r mask) :
    source_107_producer.Applies fam_110_key r mask := by
  unfold source_107_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_110_key, fam_110_support, source_107_support],
    hsource⟩⟩⟩
...
theorem fam_111_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        175 2 source_109_support r mask) :
    source_109_producer.Applies fam_111_key r mask := by
  unfold source_109_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_111_key, fam_111_support, source_109_support],
    hsource⟩⟩⟩

theorem fam_111_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_111_key.support r mask) :
    row_003_producer.Applies fam_111_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_112_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        44 5 source_047_support r mask) :
    source_047_producer.Applies fam_112_key r mask := by
  unfold source_047_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_112_key, fam_112_support, source_047_support],
    hsource⟩⟩⟩

theorem fam_112_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_112_key.support r mask) :
    row_016_producer.Applies fam_112_key r mask := by
...
theorem fam_113_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        101 4 source_114_support r mask) :
    source_114_producer.Applies fam_113_key r mask := by
  unfold source_114_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_113_key, fam_113_support, source_114_support],
    hsource⟩⟩⟩

theorem fam_113_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_113_key.support r mask) :
    row_011_producer.Applies fam_113_key r mask := by
  unfold row_011_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_114_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        92 3 source_112_support r mask) :
    source_112_producer.Applies fam_114_key r mask := by
  unfold source_112_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_114_key, fam_114_support, source_112_support],
    hsource⟩⟩⟩

theorem fam_114_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_114_key.support r mask) :
    row_006_producer.Applies fam_114_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_115_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        128 3 source_118_support r mask) :
    source_118_producer.Applies fam_115_key r mask := by
  unfold source_118_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_115_key, fam_115_support, source_118_support],
    hsource⟩⟩⟩

theorem fam_115_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_115_key.support r mask) :
    row_006_producer.Applies fam_115_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_116_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        3 12 source_115_support r mask) :
    source_115_producer.Applies fam_116_key r mask := by
  unfold source_115_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_116_key, fam_116_support, source_115_support],
    hsource⟩⟩⟩

theorem fam_116_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_116_key.support r mask) :
    row_007_producer.Applies fam_116_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_117_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        5 8 source_074_support r mask) :
    source_074_producer.Applies fam_117_key r mask := by
  unfold source_074_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_117_key, fam_117_support, source_074_support],
    hsource⟩⟩⟩

theorem fam_117_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_117_key.support r mask) :
    row_008_producer.Applies fam_117_key r mask := by
...
theorem fam_118_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        16 5 source_116_support r mask) :
    source_116_producer.Applies fam_118_key r mask := by
  unfold source_116_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_118_key, fam_118_support, source_116_support],
    hsource⟩⟩⟩
...
theorem fam_119_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        94 1 source_117_support r mask) :
    source_117_producer.Applies fam_119_key r mask := by
  unfold source_117_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_119_key, fam_119_support, source_117_support],
    hsource⟩⟩⟩

theorem fam_119_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_119_key.support r mask) :
    row_001_producer.Applies fam_119_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_120_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        156 1 source_110_support r mask) :
    source_110_producer.Applies fam_120_key r mask := by
  unfold source_110_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_120_key, fam_120_support, source_110_support],
    hsource⟩⟩⟩

theorem fam_120_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_120_key.support r mask) :
    row_001_producer.Applies fam_120_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_121_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        122 2 source_111_support r mask) :
    source_111_producer.Applies fam_121_key r mask := by
  unfold source_111_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_121_key, fam_121_support, source_111_support],
    hsource⟩⟩⟩

theorem fam_121_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_121_key.support r mask) :
    row_003_producer.Applies fam_121_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_122_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        148 2 source_113_support r mask) :
    source_113_producer.Applies fam_122_key r mask := by
  unfold source_113_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_122_key, fam_122_support, source_113_support],
    hsource⟩⟩⟩

theorem fam_122_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_122_key.support r mask) :
    row_003_producer.Applies fam_122_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_123_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        135 3 source_127_support r mask) :
    source_127_producer.Applies fam_123_key r mask := by
  unfold source_127_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_123_key, fam_123_support, source_127_support],
    hsource⟩⟩⟩

theorem fam_123_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_123_key.support r mask) :
    row_006_producer.Applies fam_123_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_124_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        97 3 source_122_support r mask) :
    source_122_producer.Applies fam_124_key r mask := by
  unfold source_122_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_124_key, fam_124_support, source_122_support],
    hsource⟩⟩⟩

theorem fam_124_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_124_key.support r mask) :
    row_006_producer.Applies fam_124_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_125_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_125_key.support r mask) :
    row_006_producer.Applies fam_125_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_126_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        3 13 source_125_support r mask) :
    source_125_producer.Applies fam_126_key r mask := by
  unfold source_125_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_126_key, fam_126_support, source_125_support],
    hsource⟩⟩⟩

theorem fam_126_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_126_key.support r mask) :
    row_007_producer.Applies fam_126_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_127_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        132 0 source_123_support r mask) :
    source_123_producer.Applies fam_127_key r mask := by
  unfold source_123_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_127_key, fam_127_support, source_123_support],
    hsource⟩⟩⟩

theorem fam_127_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_127_key.support r mask) :
    row_000_producer.Applies fam_127_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `ceca311366b59cc10ba0325f388eb3cc58cf0168d2de0b460f27e802f790d805`.
Observed representative GoodDirection cases: 3. -/
...
theorem fam_128_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        172 0 source_129_support r mask) :
    source_129_producer.Applies fam_128_key r mask := by
  unfold source_129_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_128_key, fam_128_support, source_129_support],
    hsource⟩⟩⟩

theorem fam_128_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_128_key.support r mask) :
    row_000_producer.Applies fam_128_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `addb204375a279a8b1c4daa4700c3794f0ef9caff3bfffc48f4a91fecf2109f7`.
Observed representative GoodDirection cases: 3. -/
...
theorem fam_129_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        0 9 source_119_support r mask) :
    source_119_producer.Applies fam_129_key r mask := by
  unfold source_119_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_129_key, fam_129_support, source_119_support],
    hsource⟩⟩⟩

theorem fam_129_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarSecondRows fam_129_key.support r mask) :
    row_002_producer.Applies fam_129_key r mask := by
  unfold row_002_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_131_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        142 1 source_131_support r mask) :
    source_131_producer.Applies fam_131_key r mask := by
  unfold source_131_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_131_key, fam_131_support, source_131_support],
    hsource⟩⟩⟩

theorem fam_131_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_131_key.support r mask) :
    row_001_producer.Applies fam_131_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_132_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        106 1 source_128_support r mask) :
    source_128_producer.Applies fam_132_key r mask := by
  unfold source_128_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_132_key, fam_132_support, source_128_support],
    hsource⟩⟩⟩

theorem fam_132_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_132_key.support r mask) :
    row_001_producer.Applies fam_132_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `c1e2089cb1c54246e5ccc74e05ac34f9b3759960ae6f7e6f05055519e061ed41`.
Observed representative GoodDirection cases: 3. -/
...
theorem fam_133_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        116 1 source_130_support r mask) :
    source_130_producer.Applies fam_133_key r mask := by
  unfold source_130_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_133_key, fam_133_support, source_130_support],
    hsource⟩⟩⟩

theorem fam_133_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_133_key.support r mask) :
    row_001_producer.Applies fam_133_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_134_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        144 1 source_120_support r mask) :
    source_120_producer.Applies fam_134_key r mask := by
  unfold source_120_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_134_key, fam_134_support, source_120_support],
    hsource⟩⟩⟩

theorem fam_134_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_134_key.support r mask) :
    row_001_producer.Applies fam_134_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_135_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        107 2 source_121_support r mask) :
    source_121_producer.Applies fam_135_key r mask := by
  unfold source_121_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_135_key, fam_135_support, source_121_support],
    hsource⟩⟩⟩

theorem fam_135_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_135_key.support r mask) :
    row_003_producer.Applies fam_135_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_136_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        4 13 source_147_support r mask) :
    source_147_producer.Applies fam_136_key r mask := by
  unfold source_147_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_136_key, fam_136_support, source_147_support],
    hsource⟩⟩⟩

theorem fam_136_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_136_key.support r mask) :
    row_015_producer.Applies fam_136_key r mask := by
...
theorem fam_137_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        4 12 source_136_support r mask) :
    source_136_producer.Applies fam_137_key r mask := by
  unfold source_136_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_137_key, fam_137_support, source_136_support],
    hsource⟩⟩⟩

theorem fam_137_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_137_key.support r mask) :
    row_018_producer.Applies fam_137_key r mask := by
...
theorem fam_138_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        99 7 source_149_support r mask) :
    source_149_producer.Applies fam_138_key r mask := by
  unfold source_149_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_138_key, fam_138_support, source_149_support],
    hsource⟩⟩⟩

theorem fam_138_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_138_key.support r mask) :
    row_014_producer.Applies fam_138_key r mask := by
...
theorem fam_139_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        175 6 source_143_support r mask) :
    source_143_producer.Applies fam_139_key r mask := by
  unfold source_143_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_139_key, fam_139_support, source_143_support],
    hsource⟩⟩⟩

theorem fam_139_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_139_key.support r mask) :
    row_017_producer.Applies fam_139_key r mask := by
...
/-- Pair-sign producer coverage key `16fa5902f983fb8c95757e4cd29793bca8ad00cf8c6c73b18ca701778ab53efd`.
Observed representative GoodDirection cases: 2. -/
...
theorem fam_140_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        146 0 source_132_support r mask) :
    source_132_producer.Applies fam_140_key r mask := by
  unfold source_132_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_140_key, fam_140_support, source_132_support],
    hsource⟩⟩⟩

theorem fam_140_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_140_key.support r mask) :
    row_000_producer.Applies fam_140_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_141_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        157 0 source_133_support r mask) :
    source_133_producer.Applies fam_141_key r mask := by
  unfold source_133_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_141_key, fam_141_support, source_133_support],
    hsource⟩⟩⟩

theorem fam_141_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_141_key.support r mask) :
    row_000_producer.Applies fam_141_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_142_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        145 0 source_148_support r mask) :
    source_148_producer.Applies fam_142_key r mask := by
  unfold source_148_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_142_key, fam_142_support, source_148_support],
    hsource⟩⟩⟩

theorem fam_142_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_142_key.support r mask) :
    row_000_producer.Applies fam_142_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `e476af11fbc424e45d2877d76b8595038837e99962308d347b3b0a5499a660e6`.
Observed representative GoodDirection cases: 2. -/
...
theorem fam_143_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        171 0 source_145_support r mask) :
    source_145_producer.Applies fam_143_key r mask := by
  unfold source_145_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_143_key, fam_143_support, source_145_support],
    hsource⟩⟩⟩

theorem fam_143_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_143_key.support r mask) :
    row_000_producer.Applies fam_143_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_144_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        133 0 source_138_support r mask) :
    source_138_producer.Applies fam_144_key r mask := by
  unfold source_138_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_144_key, fam_144_support, source_138_support],
    hsource⟩⟩⟩

theorem fam_144_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_144_key.support r mask) :
    row_000_producer.Applies fam_144_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `e486f955ec14fa078ace78bb139f3d7f03e6bd89ebe6f7340687d5d0497ed2ab`.
Observed representative GoodDirection cases: 2. -/
...
theorem fam_145_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        0 8 source_151_support r mask) :
    source_151_producer.Applies fam_145_key r mask := by
  unfold source_151_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_145_key, fam_145_support, source_151_support],
    hsource⟩⟩⟩

theorem fam_145_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarSecondRows fam_145_key.support r mask) :
    row_002_producer.Applies fam_145_key r mask := by
  unfold row_002_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_146_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        160 9 source_141_support r mask) :
    source_141_producer.Applies fam_146_key r mask := by
  unfold source_141_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_146_key, fam_146_support, source_141_support],
    hsource⟩⟩⟩

theorem fam_146_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_146_key.support r mask) :
    row_008_producer.Applies fam_146_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_147_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        166 10 source_137_support r mask) :
    source_137_producer.Applies fam_147_key r mask := by
  unfold source_137_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_147_key, fam_147_support, source_137_support],
    hsource⟩⟩⟩

theorem fam_147_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_147_key.support r mask) :
    row_008_producer.Applies fam_147_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_148_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        152 9 source_139_support r mask) :
    source_139_producer.Applies fam_148_key r mask := by
  unfold source_139_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_148_key, fam_148_support, source_139_support],
    hsource⟩⟩⟩

theorem fam_148_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_148_key.support r mask) :
    row_010_producer.Applies fam_148_key r mask := by
  unfold row_010_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_149_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_149_key.support r mask) :
    row_001_producer.Applies fam_149_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_150_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        118 1 source_140_support r mask) :
    source_140_producer.Applies fam_150_key r mask := by
  unfold source_140_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_150_key, fam_150_support, source_140_support],
    hsource⟩⟩⟩

theorem fam_150_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_150_key.support r mask) :
    row_001_producer.Applies fam_150_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_151_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        123 1 source_146_support r mask) :
    source_146_producer.Applies fam_151_key r mask := by
  unfold source_146_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_151_key, fam_151_support, source_146_support],
    hsource⟩⟩⟩

theorem fam_151_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_151_key.support r mask) :
    row_001_producer.Applies fam_151_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_152_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        167 2 source_135_support r mask) :
    source_135_producer.Applies fam_152_key r mask := by
  unfold source_135_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_152_key, fam_152_support, source_135_support],
    hsource⟩⟩⟩

theorem fam_152_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_152_key.support r mask) :
    row_003_producer.Applies fam_152_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_153_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        161 2 source_134_support r mask) :
    source_134_producer.Applies fam_153_key r mask := by
  unfold source_134_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_153_key, fam_153_support, source_134_support],
    hsource⟩⟩⟩

theorem fam_153_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_153_key.support r mask) :
    row_003_producer.Applies fam_153_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_154_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        149 2 source_144_support r mask) :
    source_144_producer.Applies fam_154_key r mask := by
  unfold source_144_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_154_key, fam_154_support, source_144_support],
    hsource⟩⟩⟩

theorem fam_154_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_154_key.support r mask) :
    row_003_producer.Applies fam_154_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_155_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        129 2 source_142_support r mask) :
    source_142_producer.Applies fam_155_key r mask := by
  unfold source_142_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_155_key, fam_155_support, source_142_support],
    hsource⟩⟩⟩

theorem fam_155_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_155_key.support r mask) :
    row_003_producer.Applies fam_155_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_156_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        4 11 source_170_support r mask) :
    source_170_producer.Applies fam_156_key r mask := by
  unfold source_170_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_156_key, fam_156_support, source_170_support],
    hsource⟩⟩⟩

theorem fam_156_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_156_key.support r mask) :
    row_015_producer.Applies fam_156_key r mask := by
  unfold row_015_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_157_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        4 15 source_184_support r mask) :
    source_184_producer.Applies fam_157_key r mask := by
  unfold source_184_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_157_key, fam_157_support, source_184_support],
    hsource⟩⟩⟩

theorem fam_157_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_157_key.support r mask) :
    row_015_producer.Applies fam_157_key r mask := by
  unfold row_015_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_158_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        165 4 source_166_support r mask) :
    source_166_producer.Applies fam_158_key r mask := by
  unfold source_166_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_158_key, fam_158_support, source_166_support],
    hsource⟩⟩⟩

theorem fam_158_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_158_key.support r mask) :
    row_011_producer.Applies fam_158_key r mask := by
  unfold row_011_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_159_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        4 14 source_177_support r mask) :
    source_177_producer.Applies fam_159_key r mask := by
  unfold source_177_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_159_key, fam_159_support, source_177_support],
    hsource⟩⟩⟩

theorem fam_159_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisAOnlyRows fam_159_key.support r mask) :
    row_015_producer.Applies fam_159_key r mask := by
  unfold row_015_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_160_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        15 7 source_185_support r mask) :
    source_185_producer.Applies fam_160_key r mask := by
  unfold source_185_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_160_key, fam_160_support, source_185_support],
    hsource⟩⟩⟩

theorem fam_160_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_160_key.support r mask) :
    row_014_producer.Applies fam_160_key r mask := by
  unfold row_014_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_161_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        7 11 source_186_support r mask) :
    source_186_producer.Applies fam_161_key r mask := by
  unfold source_186_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_161_key, fam_161_support, source_186_support],
    hsource⟩⟩⟩

theorem fam_161_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_161_key.support r mask) :
    row_020_producer.Applies fam_161_key r mask := by
...
theorem fam_162_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        6 12 source_182_support r mask) :
    source_182_producer.Applies fam_162_key r mask := by
  unfold source_182_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_162_key, fam_162_support, source_182_support],
    hsource⟩⟩⟩

theorem fam_162_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_162_key.support r mask) :
    row_019_producer.Applies fam_162_key r mask := by
...
theorem fam_163_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        14 7 source_157_support r mask) :
    source_157_producer.Applies fam_163_key r mask := by
  unfold source_157_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_163_key, fam_163_support, source_157_support],
    hsource⟩⟩⟩

theorem fam_163_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_163_key.support r mask) :
    row_014_producer.Applies fam_163_key r mask := by
  unfold row_014_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_164_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        163 7 source_190_support r mask) :
    source_190_producer.Applies fam_164_key r mask := by
  unfold source_190_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_164_key, fam_164_support, source_190_support],
    hsource⟩⟩⟩

theorem fam_164_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : AxisBOnlyRows fam_164_key.support r mask) :
    row_014_producer.Applies fam_164_key r mask := by
  unfold row_014_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_165_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        96 3 source_153_support r mask) :
    source_153_producer.Applies fam_165_key r mask := by
  unfold source_153_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_165_key, fam_165_support, source_153_support],
    hsource⟩⟩⟩

theorem fam_165_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_165_key.support r mask) :
    row_006_producer.Applies fam_165_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_166_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        149 3 source_164_support r mask) :
    source_164_producer.Applies fam_166_key r mask := by
  unfold source_164_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_166_key, fam_166_support, source_164_support],
    hsource⟩⟩⟩

theorem fam_166_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarFirstRows fam_166_key.support r mask) :
    row_006_producer.Applies fam_166_key r mask := by
  unfold row_006_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_167_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        3 7 source_163_support r mask) :
    source_163_producer.Applies fam_167_key r mask := by
  unfold source_163_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_167_key, fam_167_support, source_163_support],
    hsource⟩⟩⟩

theorem fam_167_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_167_key.support r mask) :
    row_007_producer.Applies fam_167_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_168_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        3 14 source_187_support r mask) :
    source_187_producer.Applies fam_168_key r mask := by
  unfold source_187_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_168_key, fam_168_support, source_187_support],
    hsource⟩⟩⟩

theorem fam_168_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqNegVarSecondRows fam_168_key.support r mask) :
    row_007_producer.Applies fam_168_key r mask := by
  unfold row_007_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `6a09a4c660dba8c16a90d0992c8f25335151c3e8f338c869d2f7eaed2254b695`.
Observed representative GoodDirection cases: 1. -/
...
theorem fam_169_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        143 0 source_155_support r mask) :
    source_155_producer.Applies fam_169_key r mask := by
  unfold source_155_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_169_key, fam_169_support, source_155_support],
    hsource⟩⟩⟩

theorem fam_169_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_169_key.support r mask) :
    row_000_producer.Applies fam_169_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_170_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        155 0 source_168_support r mask) :
    source_168_producer.Applies fam_170_key r mask := by
  unfold source_168_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_170_key, fam_170_support, source_168_support],
    hsource⟩⟩⟩

theorem fam_170_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_170_key.support r mask) :
    row_000_producer.Applies fam_170_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_171_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        131 0 source_178_support r mask) :
    source_178_producer.Applies fam_171_key r mask := by
  unfold source_178_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_171_key, fam_171_support, source_178_support],
    hsource⟩⟩⟩

theorem fam_171_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : EqEqPosVarFirstRows fam_171_key.support r mask) :
    row_000_producer.Applies fam_171_key r mask := by
  unfold row_000_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_172_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        125 8 source_179_support r mask) :
    source_179_producer.Applies fam_172_key r mask := by
  unfold source_179_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_172_key, fam_172_support, source_179_support],
    hsource⟩⟩⟩

theorem fam_172_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_172_key.support r mask) :
    row_008_producer.Applies fam_172_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_173_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        16 10 source_156_support r mask) :
    source_156_producer.Applies fam_173_key r mask := by
  unfold source_156_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_173_key, fam_173_support, source_156_support],
    hsource⟩⟩⟩

theorem fam_173_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_173_key.support r mask) :
    row_008_producer.Applies fam_173_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_174_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        38 9 source_160_support r mask) :
    source_160_producer.Applies fam_174_key r mask := by
  unfold source_160_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_174_key, fam_174_support, source_160_support],
    hsource⟩⟩⟩

theorem fam_174_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_174_key.support r mask) :
    row_008_producer.Applies fam_174_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_175_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        151 8 source_171_support r mask) :
    source_171_producer.Applies fam_175_key r mask := by
  unfold source_171_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_175_key, fam_175_support, source_171_support],
    hsource⟩⟩⟩

theorem fam_175_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_175_key.support r mask) :
    row_012_producer.Applies fam_175_key r mask := by
...
theorem fam_176_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        115 10 source_188_support r mask) :
    source_188_producer.Applies fam_176_key r mask := by
  unfold source_188_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_176_key, fam_176_support, source_188_support],
    hsource⟩⟩⟩

theorem fam_176_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_176_key.support r mask) :
    row_012_producer.Applies fam_176_key r mask := by
  unfold row_012_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_177_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        182 9 source_154_support r mask) :
    source_154_producer.Applies fam_177_key r mask := by
  unfold source_154_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_177_key, fam_177_support, source_154_support],
    hsource⟩⟩⟩

theorem fam_177_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_177_key.support r mask) :
    row_008_producer.Applies fam_177_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_178_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        100 9 source_152_support r mask) :
    source_152_producer.Applies fam_178_key r mask := by
  unfold source_152_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_178_key, fam_178_support, source_152_support],
    hsource⟩⟩⟩

theorem fam_178_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_178_key.support r mask) :
    row_012_producer.Applies fam_178_key r mask := by
  unfold row_012_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_179_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        126 9 source_175_support r mask) :
    source_175_producer.Applies fam_179_key r mask := by
  unfold source_175_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_179_key, fam_179_support, source_175_support],
    hsource⟩⟩⟩

theorem fam_179_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_179_key.support r mask) :
    row_012_producer.Applies fam_179_key r mask := by
  unfold row_012_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_180_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        138 8 source_165_support r mask) :
    source_165_producer.Applies fam_180_key r mask := by
  unfold source_165_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_180_key, fam_180_support, source_165_support],
    hsource⟩⟩⟩

theorem fam_180_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_180_key.support r mask) :
    row_012_producer.Applies fam_180_key r mask := by
  unfold row_012_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_181_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        15 9 source_161_support r mask) :
    source_161_producer.Applies fam_181_key r mask := by
  unfold source_161_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_181_key, fam_181_support, source_161_support],
    hsource⟩⟩⟩

theorem fam_181_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_181_key.support r mask) :
    row_010_producer.Applies fam_181_key r mask := by
  unfold row_010_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_182_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        150 9 source_159_support r mask) :
    source_159_producer.Applies fam_182_key r mask := by
  unfold source_159_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_182_key, fam_182_support, source_159_support],
    hsource⟩⟩⟩

theorem fam_182_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_182_key.support r mask) :
    row_012_producer.Applies fam_182_key r mask := by
  unfold row_012_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_183_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        166 12 source_173_support r mask) :
    source_173_producer.Applies fam_183_key r mask := by
  unfold source_173_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_183_key, fam_183_support, source_173_support],
    hsource⟩⟩⟩

theorem fam_183_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_183_key.support r mask) :
    row_012_producer.Applies fam_183_key r mask := by
  unfold row_012_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_184_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        85 8 source_180_support r mask) :
    source_180_producer.Applies fam_184_key r mask := by
  unfold source_180_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_184_key, fam_184_support, source_180_support],
    hsource⟩⟩⟩

theorem fam_184_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : ExactTwoSourceValidRows fam_184_key.support r mask) :
    row_008_producer.Applies fam_184_key r mask := by
  unfold row_008_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_185_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        82 1 source_162_support r mask) :
    source_162_producer.Applies fam_185_key r mask := by
  unfold source_162_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_185_key, fam_185_support, source_162_support],
    hsource⟩⟩⟩

theorem fam_185_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_185_key.support r mask) :
    row_001_producer.Applies fam_185_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `57d1d13db8a960fecc6d0baa35100933a49eaba04009d43e7583acbdfd3fc7a1`.
Observed representative GoodDirection cases: 1. -/
...
theorem fam_186_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        128 1 source_176_support r mask) :
    source_176_producer.Applies fam_186_key r mask := by
  unfold source_176_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_186_key, fam_186_support, source_176_support],
    hsource⟩⟩⟩

theorem fam_186_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_186_key.support r mask) :
    row_001_producer.Applies fam_186_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_187_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        132 1 source_189_support r mask) :
    source_189_producer.Applies fam_187_key r mask := by
  unfold source_189_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_187_key, fam_187_support, source_189_support],
    hsource⟩⟩⟩

theorem fam_187_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_187_key.support r mask) :
    row_001_producer.Applies fam_187_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_188_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        144 1 source_169_support r mask) :
    source_169_producer.Applies fam_188_key r mask := by
  unfold source_169_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_188_key, fam_188_support, source_169_support],
    hsource⟩⟩⟩

theorem fam_188_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppOneMinusVarFirstRows fam_188_key.support r mask) :
    row_001_producer.Applies fam_188_key r mask := by
  unfold row_001_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_189_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        131 2 source_172_support r mask) :
    source_172_producer.Applies fam_189_key r mask := by
  unfold source_172_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_189_key, fam_189_support, source_172_support],
    hsource⟩⟩⟩

theorem fam_189_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_189_key.support r mask) :
    row_003_producer.Applies fam_189_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_190_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        159 2 source_167_support r mask) :
    source_167_producer.Applies fam_190_key r mask := by
  unfold source_167_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_190_key, fam_190_support, source_167_support],
    hsource⟩⟩⟩

theorem fam_190_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_190_key.support r mask) :
    row_003_producer.Applies fam_190_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
/-- Pair-sign producer coverage key `326d28c7fdf06dd65f97fd6712c0c3a6029264b8a7a3624ba91a864f0f121a47`.
Observed representative GoodDirection cases: 1. -/
...
theorem fam_191_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        48 2 source_158_support r mask) :
    source_158_producer.Applies fam_191_key r mask := by
  unfold source_158_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_191_key, fam_191_support, source_158_support],
    hsource⟩⟩⟩

theorem fam_191_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_191_key.support r mask) :
    row_003_producer.Applies fam_191_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_192_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        169 2 source_174_support r mask) :
    source_174_producer.Applies fam_192_key r mask := by
  unfold source_174_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_192_key, fam_192_support, source_174_support],
    hsource⟩⟩⟩

theorem fam_192_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_192_key.support r mask) :
    row_003_producer.Applies fam_192_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_193_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        143 2 source_181_support r mask) :
    source_181_producer.Applies fam_193_key r mask := by
  unfold source_181_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_193_key, fam_193_support, source_181_support],
    hsource⟩⟩⟩

theorem fam_193_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_193_key.support r mask) :
    row_003_producer.Applies fam_193_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
theorem fam_194_sourceApplies_of_sourcePredicate
    ...
    (hsource : SourceIndexStateSourcePredicate
        119 2 source_183_support r mask) :
    source_183_producer.Applies fam_194_key r mask := by
  unfold source_183_producer
  exact ⟨rfl, ⟨rfl, ⟨by
    simp [fam_194_key, fam_194_support, source_183_support],
    hsource⟩⟩⟩

theorem fam_194_rowApplies_of_rows
    {r : Nat} {mask : SignMask}
    (hrows : OppMinusOneVarFirstRows fam_194_key.support r mask) :
    row_003_producer.Applies fam_194_key r mask := by
  unfold row_003_producer
  exact ⟨rfl, hrows⟩
...
end Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.PairSignProducerCoverageSmoke
