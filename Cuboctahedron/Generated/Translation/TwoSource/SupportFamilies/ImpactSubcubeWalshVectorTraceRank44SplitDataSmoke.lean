...
/-!
Generated AP16DK split Walsh-vector trace data for rank `44`.
-/
...
def generatedRank : Fin numPairWords := ⟨44, by decide⟩

def generatedWord : PairWord :=
  ⟨#[PairId.x, PairId.y, PairId.y, PairId.z, PairId.z, PairId.d111, PairId.d111, PairId.d1m1, PairId.d1m1, PairId.d11m, PairId.dm11, PairId.dm11, PairId.d11m], by decide⟩
...
@[simp] theorem generatedWord_getFin_09 :
    Vector.get generatedWord (9 : WordIndex) = PairId.d11m := by
  rfl

@[simp] theorem generatedWord_get_09
    (h : (9 : Nat) < 13) :
    generatedWord.get ⟨9, h⟩ = PairId.d11m := by
