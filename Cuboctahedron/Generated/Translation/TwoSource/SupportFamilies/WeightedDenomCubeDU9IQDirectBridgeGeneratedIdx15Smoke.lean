...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx15Smoke
...
def poly897_2_11 : WalshQuadratic where
  c := 16
  y := 0
  z := 0
  d111 := 4/3
...
private def reduced897_2_11 : WalshQuadratic where
  c := -32/9
  y := 0
  z := -4/3
  d111 := 0
...
private theorem poly897_2_11_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube1x0x1x.Member mask) :
    poly897_2_11.coeffEval mask = reduced897_2_11.coeffEval mask := by
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly897_2_11, reduced897_2_11, WalshQuadratic.coeffEval, SignBit.value, hy, hd111, hd1m1, hz, hd11m, hdm11]
        norm_num

private def reducedBound897_2_11 :
    WalshQuadraticReducedAbsBound cube1x0x1x poly897_2_11 where
  reduced := reduced897_2_11
  eq_on_cube := by
    intro mask hmask
    exact poly897_2_11_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced897_2_11, WalshQuadratic.absBoundSum]

private def cubeBound897_2_11 :
    WalshQuadraticCubeBound cube1x0x1x poly897_2_11 :=
  WalshQuadraticCubeBound.leaf reducedBound897_2_11

private theorem poly897_2_11_nonpos
    {mask : SignMask} (hmask : cube1x0x1x.Member mask) :
    poly897_2_11.coeffEval mask <= 0 :=
  cubeBound897_2_11.coeffEval_nonpos hmask

def reducedObstruction897_2_11
    (direct_eq :
      forall {mask : SignMask} (hlt : rank897 < numPairWords),
        cube1x0x1x.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2_11 =
            poly897_2_11.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank897 cube1x0x1x.Member where
  weights := weights2_11
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly897_2_11_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    weightedDenomAtRank
      (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2_11 <= 0 :=
  (reducedObstruction897_2_11 direct_eq).nonpos hlt hmember
...
private theorem dot_sum_eval
    ...
    2 * dot01.coeffEval mask + dot10.coeffEval mask =
      poly897_2_11.coeffEval mask := by
  simp [dot01, dot10, poly897_2_11,
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx15Smoke
