...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx89Smoke
...
private theorem poly955_7_eq_reduced_on_cube
  ...
  all_goals
    ...
    all_goals
      ...
      all_goals
        simp [poly955_7, reduced955_7, WalshQuadratic.coeffEval, SignBit.value, hd111, hd1m1, hdm11, hy, hz, hd11m]
        norm_num

private def reducedBound955_7 :
    WalshQuadraticReducedAbsBound cubexx0x01 poly955_7 where
...
private def cubeBound955_7 :
    WalshQuadraticCubeBound cubexx0x01 poly955_7 :=
...
def reducedObstruction955_7
    ...
    WeightedWalshQuadraticNonposObstruction rank955 cubexx0x01.Member where
  weights := weights7
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx89Smoke
