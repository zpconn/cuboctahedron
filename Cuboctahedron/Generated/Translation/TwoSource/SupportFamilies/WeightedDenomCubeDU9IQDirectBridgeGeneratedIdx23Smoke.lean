...
import Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke
...
namespace WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx23Smoke
...
abbrev generatedNormal01 : WalshAffineVec3 :=
  Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke.generatedNormal01

def rank897 : Nat := 897

def cube0x110x : MaskSubcube where
  fixed
...
def poly897_2 : WalshQuadratic where
  c := 4
  y := 0
  z := 0
  d111 := 0
...
private def reduced897_2 : WalshQuadratic where
  c := -52/9
  y := 0
  z := 0
  d111 := 0
...
private theorem poly897_2_eq_reduced_on_cube
    {mask : SignMask} (hmask : cube0x110x.Member mask) :
    poly897_2.coeffEval mask = reduced897_2.coeffEval mask := by
  have hy : maskBitForPair mask SignBit.y.toPairId = false := by
    simpa [cube0x110x, MaskSubcube.Member] using hmask SignBit.y
  have hd111 : maskBitForPair mask SignBit.d111.toPairId = true := by
    simpa [cube0x110x, MaskSubcube.Member] using hmask SignBit.d111
  have hd11m : maskBitForPair mask SignBit.d11m.toPairId = true := by
    simpa [cube0x110x, MaskSubcube.Member] using hmask SignBit.d11m
  have hd1m1 : maskBitForPair mask SignBit.d1m1.toPairId = false := by
    simpa [cube0x110x, MaskSubcube.Member] using hmask SignBit.d1m1
  by_cases hz : maskBitForPair mask SignBit.z.toPairId
  all_goals
    by_cases hdm11 : maskBitForPair mask SignBit.dm11.toPairId
    all_goals
      simp [poly897_2, reduced897_2, WalshQuadratic.coeffEval, SignBit.value, hy, hd111, hd11m, hd1m1, hz, hdm11]
      norm_num

private def reducedBound897_2 :
    WalshQuadraticReducedAbsBound cube0x110x poly897_2 where
  reduced := reduced897_2
  eq_on_cube := by
    intro mask hmask
    exact poly897_2_eq_reduced_on_cube hmask
  abs_bound_nonpos := by
    norm_num [reduced897_2, WalshQuadratic.absBoundSum]

private def cubeBound897_2 :
    WalshQuadraticCubeBound cube0x110x poly897_2 :=
  WalshQuadraticCubeBound.leaf reducedBound897_2

private theorem poly897_2_nonpos
    {mask : SignMask} (hmask : cube0x110x.Member mask) :
    poly897_2.coeffEval mask <= 0 :=
  cubeBound897_2.coeffEval_nonpos hmask

def reducedObstruction897_2
    (direct_eq :
      forall {mask : SignMask} (hlt : rank897 < numPairWords),
        cube0x110x.Member mask ->
          weightedDirectWalshDotAtRank
            (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2 =
            poly897_2.coeffEval mask) :
    WeightedWalshQuadraticNonposObstruction rank897 cube0x110x.Member where
  weights := weights2
  ...
  poly_nonpos := by
    intro mask hmember
    exact poly897_2_nonpos hmember
...
theorem weightedDenom_nonpos_of_reduced_bound
    ...
    (hmember : cube0x110x.Member mask) :
    weightedDenomAtRank
      (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2 <= 0 :=
  (reducedObstruction897_2 direct_eq).nonpos hlt hmember
...
private theorem dot01_eq :
  ...
  norm_num [dot01, generatedNormal01, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke.generatedNormal01, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke.generatedNormal01_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke.generatedNormal01_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke.generatedNormal01_z, generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank897ChainSmoke.generatedVector, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank897ChainSmoke.generatedVector_x, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank897ChainSmoke.generatedVector_y, Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQVectorTraceRank897ChainSmoke.generatedVector_z, WalshAffineVec3.dot, WalshQuadratic.add, WalshAffine.mul]
...
private theorem direct01_eq
    ...
    directWalshDotAtRank
        (⟨rank897, hlt⟩ : Fin numPairWords) mask (1 : WordIndex) =
  ...
  rw [← Cuboctahedron.Generated.Translation.TwoSource.SupportFamilies.WeightedDenomCubeDU9IQNormalTraceRank897Idx01Smoke.generatedNormal01_eq]
...
private theorem direct01_eq_of_val
  ...
  rw [directWalshDotAtRank_eq_of_val
    (⟨rank897, hlt⟩ : Fin numPairWords) mask (j := (1 : WordIndex)) hi]
  exact direct01_eq mask hlt

private theorem dot_sum_eval
    (mask : SignMask) :
    dot01.coeffEval mask =
      poly897_2.coeffEval mask := by
  simp [dot01, poly897_2,
    WalshQuadratic.coeffEval]
  try ring_nf

theorem direct_eq
    {mask : SignMask} (hlt : rank897 < numPairWords)
    (_hmember : cube0x110x.Member mask) :
    weightedDirectWalshDotAtRank
        (⟨rank897, hlt⟩ : Fin numPairWords) mask weights2 =
      poly897_2.coeffEval mask := by
...
end WeightedDenomCubeDU9IQDirectBridgeGeneratedIdx23Smoke
