...
namespace Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000011_000000012
...
private theorem rank_000000011_goodCoverage
    (hlt : 11 < numPairWords) (mask : SignMask)
    : TranslationGoodCaseKilled
      (⟨11, hlt⟩ : Fin numPairWords) mask := by
  intro hgood hM hbad
  fin_cases mask
...
theorem rowRelationClassifierGoodCoverage :
    TranslationGoodCoverageOnRange 11 12 := by
  intro r hlo hhi hlt mask
  interval_cases r
  · exact rank_000000011_goodCoverage hlt mask

end Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000011_000000012
