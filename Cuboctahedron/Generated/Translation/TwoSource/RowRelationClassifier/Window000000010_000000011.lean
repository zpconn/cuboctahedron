...
namespace Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000010_000000011
...
private theorem rank_000000010_goodCoverage
    (hlt : 10 < numPairWords) (mask : SignMask)
    : TranslationGoodCaseKilled
      (⟨10, hlt⟩ : Fin numPairWords) mask := by
  exact goodCaseKilled_of_nonidentity (rank_000000010_nonidentity_linear_ne_atRank hlt)

set_option maxHeartbeats 4000000 in
theorem rowRelationClassifierGoodCoverage :
    TranslationGoodCoverageOnRange 10 11 := by
  intro r hlo hhi hlt mask
  interval_cases r
  · exact rank_000000010_goodCoverage hlt mask

end Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000010_000000011
