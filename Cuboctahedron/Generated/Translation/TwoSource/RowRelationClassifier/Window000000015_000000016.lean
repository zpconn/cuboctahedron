...
namespace Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000015_000000016
...
private theorem rank_000000015_goodCoverage
    (hlt : 15 < numPairWords) (mask : SignMask)
    : TranslationGoodCaseKilled
      (⟨15, hlt⟩ : Fin numPairWords) mask := by
  exact goodCaseKilled_of_nonidentity (rank_000000015_nonidentity_linear_ne_atRank hlt)

set_option maxHeartbeats 4000000 in
theorem rowRelationClassifierGoodCoverage :
    TranslationGoodCoverageOnRange 15 16 := by
  intro r hlo hhi hlt mask
  interval_cases r
  · exact rank_000000015_goodCoverage hlt mask

end Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000015_000000016
