...
namespace Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000000_000000001
...
private theorem case_000011_shape :
    OppMinusOneVarSecond case_000011_support case_000011_rank.val case_000011_mask := by
  intro hlt
...
private theorem case_000011_checkedAtRank :
  ...
  oppMinusOneVarSecond_checkedOn case_000011_support case_000011_rank.val case_000011_rank.isLt
...
private theorem case_000012_shape :
    OppMinusOneVarSecond case_000012_support case_000012_rank.val case_000012_mask := by
  intro hlt
...
private theorem case_000012_checkedAtRank :
  ...
  oppMinusOneVarSecond_checkedOn case_000012_support case_000012_rank.val case_000012_rank.isLt
...
private theorem rank_000000000_goodCoverage
    (hlt : 0 < numPairWords) (mask : SignMask)
    : TranslationGoodCaseKilled
      (⟨0, hlt⟩ : Fin numPairWords) mask := by
  intro hgood hM hbad
  fin_cases mask
...
theorem rowRelationClassifierGoodCoverage :
    TranslationGoodCoverageOnRange 0 1 := by
  intro r hlo hhi hlt mask
  interval_cases r
  · exact rank_000000000_goodCoverage hlt mask

end Cuboctahedron.Generated.Translation.TwoSource.RowRelationClassifier.Window000000000_000000001
