...
Now, with the advent of AI formal methods, it is possible to undertake the vast task of formalizing a complete, exhaustive proof, and this repo is an example of applying this new technique in mathematics to the problem space of understanding omnihedral orbits inside 3D polyhedra.
